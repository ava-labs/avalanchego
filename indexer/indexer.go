...
// initializeIndexes selects which index should be created (stand-alone vs VM-backed)
// and checks that all conditions are there for creation.
// Assumes [engine]'s context lock is held
