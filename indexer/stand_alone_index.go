...
// Close this index
func (i *standAloneIndex) Close() error {
	errs := wrappers.Errs{}
	errs.Add(
...
func (i *standAloneIndex) Accept(ctx *snow.ConsensusContext, containerID ids.ID, containerBytes []byte) error {
	i.lock.Lock()
	defer i.lock.Unlock()
...
func (i *standAloneIndex) GetContainerByIndex(index uint64) (Container, error) {
	i.lock.RLock()
...
// Assumes [i.lock] is held
func (i *standAloneIndex) getContainerByIndexBytes(indexBytes []byte) (Container, error) {
...
func (i *standAloneIndex) GetContainerRange(startIndex, numToFetch uint64) ([]Container, error) {
...
func (i *standAloneIndex) GetIndex(containerID ids.ID) (uint64, error) {
	i.lock.RLock()
	defer i.lock.RUnlock()
...
func (i *standAloneIndex) GetContainerByID(containerID ids.ID) (Container, error) {
	i.lock.RLock()
	defer i.lock.RUnlock()
...
func (i *standAloneIndex) GetLastAccepted() (Container, error) {
	i.lock.RLock()
	defer i.lock.RUnlock()
...
func (i *standAloneIndex) lastAcceptedIndex() (uint64, bool) {
