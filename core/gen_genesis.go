...
import (
	...
	params0 "github.com/ava-labs/subnet-evm/params"
)
...
func (g Genesis) MarshalJSON() ([]byte, error) {
	type Genesis struct {
		...
		Alloc         map[common.UnprefixedAddress]types0.Account `json:"alloc"      gencodec:"required"`
	...
	if g.Alloc != nil {
		enc.Alloc = make(map[common.UnprefixedAddress]types0.Account, len(g.Alloc))
...
func (g *Genesis) UnmarshalJSON(input []byte) error {
	...
	g.Alloc = make(types0.GenesisAlloc, len(dec.Alloc))
