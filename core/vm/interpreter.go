...
func (in *EVMInterpreter) Run(contract *Contract, input []byte, readOnly bool) (ret []byte, err error) {
	// Deprecate special handling of [BuiltinAddr] as of SubnetEVM.
	// In SubnetEVM, the contract deployed in the genesis is overridden by a deprecated precompiled
	// contract which will return an error immediately if its ever called. Therefore, this function should
	// never be called after SubnetEVM with [BuiltinAddr] as the contract address.
	if !in.evm.chainRules.IsSubnetEVM && contract.Address() == BuiltinAddr {
