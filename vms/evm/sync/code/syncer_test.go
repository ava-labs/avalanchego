...
func testCodeSyncer(t *testing.T, test syncerTest) {
	// Set up serverDB
	...
	// Set up mockClient
	codeRequestHandler := handlers.NewCodeRequestHandler(serverDB, message.Codec, stats.NewNoopHandlerStats())
