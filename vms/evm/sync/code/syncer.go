...
import (
	...
	syncpkg "github.com/ava-labs/avalanchego/vms/evm/sync"
...
var _ syncpkg.StateSyncer = (*Syncer)(nil)
...
type Syncer struct {
	db     ethdb.Database
	client statesyncclient.SyncClient
...
// SyncerOption configures CodeSyncer at construction time.
type SyncerOption = options.Option[codeSyncerConfig]
...
func NewSyncer(client statesyncclient.SyncClient, db ethdb.Database, codeHashes <-chan common.Hash, opts ...SyncerOption) (*Syncer, error) {
