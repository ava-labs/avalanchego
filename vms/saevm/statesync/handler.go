...
type Config struct {
	// SummaryInterval is the number of blocks between heights at which state
	// summaries are served. It MUST be non-zero and MUST match the interval at
	// which the trie database commits settled state.
