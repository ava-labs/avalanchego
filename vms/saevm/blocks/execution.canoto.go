...
const (
	canotoNumber_executionResults__byGas         = 1
	canotoNumber_executionResults__baseFee       = 2
	canotoNumber_executionResults__receiptRoot   = 3
	canotoNumber_executionResults__stateRootPost = 4

	canotoTag_executionResults__byGas         = "\x0a" // canoto.Tag(canotoNumber_executionResults__byGas, canoto.Len)
	canotoTag_executionResults__baseFee       = "\x12" // canoto.Tag(canotoNumber_executionResults__baseFee, canoto.Len)
	canotoTag_executionResults__receiptRoot   = "\x1a" // canoto.Tag(canotoNumber_executionResults__receiptRoot, canoto.Len)
	canotoTag_executionResults__stateRootPost = "\x22" // canoto.Tag(canotoNumber_executionResults__stateRootPost, canoto.Len)
)
	...
	s := &canoto.Spec{
		...
		Fields: []canoto.FieldType{
			canoto.FieldTypeFromField(
				...
				/*FieldNumber:   */ canotoNumber_executionResults__byGas,
				/*Name:          */ "byGas",
				/*FixedLength:   */ 0,
				/*Repeated:      */ false,
				/*OneOf:         */ "",
			...
			{
				FieldNumber: canotoNumber_executionResults__baseFee,
				Name:        "baseFee",
			...
			{
				FieldNumber:    canotoNumber_executionResults__receiptRoot,
				Name:           "receiptRoot",
				OneOf:          "",
				TypeFixedBytes: uint64(len(zero.receiptRoot)),
			},
			{
				FieldNumber:    canotoNumber_executionResults__stateRootPost,
				Name:           "stateRootPost",
				OneOf:          "",
...
func (c *executionResults) UnmarshalCanotoFrom(r canoto.Reader) error {
	...
	*c = executionResults{}
	...
	for canoto.HasNext(&r) {
		...
		switch field {
		case canotoNumber_executionResults__byGas:
			...
			r.B = remainingBytes
		case canotoNumber_executionResults__baseFee:
			if wireType != canoto.Len {
				return canoto.ErrUnexpectedWireType
			}
		...
		case canotoNumber_executionResults__receiptRoot:
			if wireType != canoto.Len {
				return canoto.ErrUnexpectedWireType
			}
		...
		case canotoNumber_executionResults__stateRootPost:
			if wireType != canoto.Len {
				return canoto.ErrUnexpectedWireType
			}
...
func (c *executionResults) CalculateCanotoCache() {
	...
	if fieldSize := (&c.byGas).CachedCanotoSize(); fieldSize != 0 {
		size += uint64(len(canotoTag_executionResults__byGas)) + canoto.SizeUint(fieldSize) + fieldSize
	}
	if !canoto.IsZero(c.baseFee) {
		...
		size += uint64(len(canotoTag_executionResults__baseFee)) + canoto.SizeUint(fieldSize) + fieldSize
		atomic.StoreUint64(&c.canotoData.baseFeeSize, fieldSize)
	}
	if !canoto.IsZero(c.receiptRoot) {
		size += uint64(len(canotoTag_executionResults__receiptRoot)) + canoto.SizeBytes((&c.receiptRoot)[:])
	}
	if !canoto.IsZero(c.stateRootPost) {
		size += uint64(len(canotoTag_executionResults__stateRootPost)) + canoto.SizeBytes((&c.stateRootPost)[:])
	}
...
func (c *executionResults) MarshalCanotoInto(w canoto.Writer) canoto.Writer {
	if fieldSize := (&c.byGas).CachedCanotoSize(); fieldSize != 0 {
		canoto.Append(&w, canotoTag_executionResults__byGas)
		canoto.AppendUint(&w, fieldSize)
		w = (&c.byGas).MarshalCanotoInto(w)
	}
	if !canoto.IsZero(c.baseFee) {
		canoto.Append(&w, canotoTag_executionResults__baseFee)
	...
	if !canoto.IsZero(c.receiptRoot) {
		canoto.Append(&w, canotoTag_executionResults__receiptRoot)
		canoto.AppendBytes(&w, (&c.receiptRoot)[:])
	}
	if !canoto.IsZero(c.stateRootPost) {
		canoto.Append(&w, canotoTag_executionResults__stateRootPost)
