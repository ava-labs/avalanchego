...
//
// It releases proposalsLock before FFI calls. Propose returns an error if
// Commit drops the parent first.
...
//
// TODO(JonathanOppenheimer): Add a proof reader for eth_getProof.
