...
var targetTowardCases = []towardCase[TargetExponent]{
	...
	{name: "no_change", current: 0, desired: new(TargetExponent), want: 0},
	...
	{name: "decrease_at_cap", current: 1 << 15, desired: new(TargetExponent), want: 0},
	{name: "increase_capped", current: 0, desired: new(TargetExponent((1 << 15) + 1)), want: 1 << 15},
	{name: "decrease_capped", current: 1_000_000, desired: new(TargetExponent), want: 1_000_000 - (1 << 15)},
}
