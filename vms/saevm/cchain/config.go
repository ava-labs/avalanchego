...
type config struct {
	...
	// WarpHelperAddresses are the contracts whose warp messages export AVAX
	// to the P-chain and authorize imports from it on behalf of the caller.
	WarpHelperAddresses []common.Address `json:"warp-helper-addresses"`
