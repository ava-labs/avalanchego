...
type config struct {
	...
	MapPendingStateToLatest bool   `json:"api-map-pending-state-to-latest"`
...
func defaultConfig() config {
	return config{
		...
		MapPendingStateToLatest: true, // support Foundry's cast and geth/libevm's bound contracts
	}
}
...
func (c config) saeConfig(now func() time.Time) sae.Config {
	...
	return sae.Config{
		...
		RPCConfig: rpc.Config{
			...
			MapPendingStateToLatest: c.MapPendingStateToLatest,
		},
		Now: now,
	}
}
