...
func (m *SelfSubscriber) SetAbsorbedMsgAndHeight(arg0 common.Message) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetAbsorbedMsgAndHeight", arg0)
}

// SetAbsorbedMsgAndHeight indicates an expected call of SetAbsorbedMsgAndHeight.
func (mr *SelfSubscriberMockRecorder) SetAbsorbedMsgAndHeight(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetAbsorbedMsgAndHeight", reflect.TypeOf((*SelfSubscriber)(nil).SetAbsorbedMsgAndHeight), arg0)
}
