...
func validCreateAssetTx(t *testing.T) (*CreateAssetTx, codec.Codec, *snow.Context) {
	...
	ctx := NewContext(t)
	if err := tx.SyntacticVerify(ctx, c, asset, 0, 0, 1); err != nil {
...
func TestCreateAssetTxSyntacticVerifyInitialStates(t *testing.T) {
	...
	if err := tx.SyntacticVerify(ctx, c, asset, 0, 0, 3); err == nil {
...
func TestCreateAssetTxSyntacticVerifyBaseTx(t *testing.T) {
	...
	var baseTx BaseTx
	tx.BaseTx = baseTx
	if err := tx.SyntacticVerify(ctx, c, asset, 0, 0, 2); err == nil {
