...
func (service *Service) IssueTx(r *http.Request, args *apiargs.FormattedTx, reply *apiargs.JSONTxID) error {
...
func (service *Service) GetTxStatus(r *http.Request, args *apiargs.JSONTxID, reply *vmargs.GetTxStatusReply) error {
...
func (service *Service) GetTx(r *http.Request, args *apiargs.GetTxArgs, reply *apiargs.FormattedTx) error {
...
func (service *Service) GetUTXOs(r *http.Request, args *vmargs.GetUTXOsArgs, reply *vmargs.GetUTXOsReply) error {
...
func (service *Service) GetAssetDescription(_ *http.Request, args *vmargs.GetAssetDescriptionArgs, reply *vmargs.GetAssetDescriptionReply) error {
...
func (service *Service) GetBalance(r *http.Request, args *vmargs.GetBalanceArgs, reply *vmargs.GetBalanceReply) error {
...
func (service *Service) GetAllBalances(r *http.Request, args *apiargs.JSONAddress, reply *vmargs.GetAllBalancesReply) error {
	...
	reply.Balances = make([]vmargs.Balance, assetIDs.Len())
	i := 0
	for assetID := range assetIDs {
		if alias, err := service.vm.PrimaryAlias(assetID); err == nil {
			reply.Balances[i] = vmargs.Balance{
				AssetID: alias,
...
func (service *Service) CreateAsset(r *http.Request, args *vmargs.CreateAssetArgs, reply *vmargs.AssetIDChangeAddr) error {
...
func (service *Service) CreateFixedCapAsset(r *http.Request, args *vmargs.CreateAssetArgs, reply *vmargs.AssetIDChangeAddr) error {
...
func (service *Service) CreateVariableCapAsset(r *http.Request, args *vmargs.CreateAssetArgs, reply *vmargs.AssetIDChangeAddr) error {
...
func (service *Service) CreateNFTAsset(r *http.Request, args *vmargs.CreateNFTAssetArgs, reply *vmargs.AssetIDChangeAddr) error {
...
func (service *Service) CreateAddress(r *http.Request, args *apiargs.UserPass, reply *apiargs.JSONAddress) error {
...
func (service *Service) ExportKey(r *http.Request, args *vmargs.ExportKeyArgs, reply *vmargs.ExportKeyReply) error {
...
func (service *Service) ImportKey(r *http.Request, args *vmargs.ImportKeyArgs, reply *apiargs.JSONAddress) error {
...
func (service *Service) Send(r *http.Request, args *vmargs.SendArgs, reply *apiargs.JSONTxIDChangeAddr) error {
	return service.SendMultiple(r, &vmargs.SendMultipleArgs{
		JSONSpendHeader: args.JSONSpendHeader,
		Outputs:         []vmargs.SendOutput{args.SendOutput},
		From:            args.From,
		Memo:            args.Memo,
	}, reply)
}
...
func (service *Service) SendMultiple(r *http.Request, args *vmargs.SendMultipleArgs, reply *apiargs.JSONTxIDChangeAddr) error {
...
func (service *Service) Mint(r *http.Request, args *vmargs.MintArgs, reply *apiargs.JSONTxIDChangeAddr) error {
...
func (service *Service) SendNFT(r *http.Request, args *vmargs.SendNFTArgs, reply *apiargs.JSONTxIDChangeAddr) error {
...
func (service *Service) MintNFT(r *http.Request, args *vmargs.MintNFTArgs, reply *apiargs.JSONTxIDChangeAddr) error {
...
func (service *Service) ImportAVAX(_ *http.Request, args *vmargs.ImportArgs, reply *apiargs.JSONTxID) error {
...
func (service *Service) Import(_ *http.Request, args *vmargs.ImportArgs, reply *apiargs.JSONTxID) error {
...
// Returns the ID of the newly created atomic transaction
func (service *Service) ExportAVAX(_ *http.Request, args *vmargs.ExportAVAXArgs, reply *apiargs.JSONTxIDChangeAddr) error {
	return service.Export(nil, &vmargs.ExportArgs{
		ExportAVAXArgs: *args,
...
// After this tx is accepted, the AVAX must be imported to the P/C-chain with an importTx.
// Returns the ID of the newly created atomic transaction
func (service *Service) Export(_ *http.Request, args *vmargs.ExportArgs, reply *apiargs.JSONTxIDChangeAddr) error {
