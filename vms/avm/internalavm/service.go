...
// NewService Creates a new instance of the VM service
...
func (service *Service) CreateFixedCapAsset(r *http.Request, args *vmargs.CreateFixedCapAssetArgs, reply *vmargs.AssetIDChangeAddr) error {
...
func (service *Service) CreateVariableCapAsset(r *http.Request, args *vmargs.CreateVariableCapAssetArgs, reply *vmargs.AssetIDChangeAddr) error {
