...
func (w *WalletService) IssueTx(r *http.Request, args *apiargs.FormattedTx, reply *apiargs.JSONTxID) error {
...
func (w *WalletService) Send(r *http.Request, args *vmargs.SendArgs, reply *apiargs.JSONTxIDChangeAddr) error {
	return w.SendMultiple(r, &vmargs.SendMultipleArgs{
...
func (w *WalletService) SendMultiple(r *http.Request, args *vmargs.SendMultipleArgs, reply *apiargs.JSONTxIDChangeAddr) error {
