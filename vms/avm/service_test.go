	...
	tests := []test{
		{
			...
			serviceAndExpectedBlockFunc: func(*testing.T, *gomock.Controller) (*Service, any) {
				return &Service{
					vm: &VM{
						ctx: &snow.Context{
							Log: logging.NoLog{},
		...
		},
		{
			...
			serviceAndExpectedBlockFunc: func(_ *testing.T, ctrl *gomock.Controller) (*Service, any) {
