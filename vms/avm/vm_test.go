...
func TestVMLinearizeStateMigration(t *testing.T) {
	...
	require.NoError(vm.Linearize(t.Context(), ids.Empty))
	...
	wantBlkIDs.Put(blkID, 1)

	// TODO issue atomic txs and verify that the state root is changing each time
