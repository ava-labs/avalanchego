...
func (vm *VMClient) CrossChainAppRequest(_ context.Context, chainID ids.ID, requestID uint32, deadline time.Time, request []byte) error {
...
func (vm *VMClient) CrossChainAppRequestFailed(_ context.Context, chainID ids.ID, requestID uint32) error {
...
func (vm *VMClient) CrossChainAppResponse(_ context.Context, chainID ids.ID, requestID uint32, response []byte) error {
