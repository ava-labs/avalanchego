...
func init() {
	...
	proto.RegisterType((*InitializeResponse)(nil), "proto.InitializeResponse")
	...
	proto.RegisterType((*CreateHandlersRequest)(nil), "proto.CreateHandlersRequest")
	proto.RegisterType((*CreateHandlersResponse)(nil), "proto.CreateHandlersResponse")
	proto.RegisterType((*Handler)(nil), "proto.Handler")
	proto.RegisterType((*BuildBlockRequest)(nil), "proto.BuildBlockRequest")
	proto.RegisterType((*BuildBlockResponse)(nil), "proto.BuildBlockResponse")
	proto.RegisterType((*ParseBlockRequest)(nil), "proto.ParseBlockRequest")
	proto.RegisterType((*ParseBlockResponse)(nil), "proto.ParseBlockResponse")
	proto.RegisterType((*GetBlockRequest)(nil), "proto.GetBlockRequest")
	proto.RegisterType((*GetBlockResponse)(nil), "proto.GetBlockResponse")
	proto.RegisterType((*SetPreferenceRequest)(nil), "proto.SetPreferenceRequest")
	proto.RegisterType((*SetPreferenceResponse)(nil), "proto.SetPreferenceResponse")
	proto.RegisterType((*LastAcceptedRequest)(nil), "proto.LastAcceptedRequest")
	proto.RegisterType((*LastAcceptedResponse)(nil), "proto.LastAcceptedResponse")
	proto.RegisterType((*BlockVerifyRequest)(nil), "proto.BlockVerifyRequest")
	proto.RegisterType((*BlockVerifyResponse)(nil), "proto.BlockVerifyResponse")
	proto.RegisterType((*BlockAcceptRequest)(nil), "proto.BlockAcceptRequest")
	proto.RegisterType((*BlockAcceptResponse)(nil), "proto.BlockAcceptResponse")
	proto.RegisterType((*BlockRejectRequest)(nil), "proto.BlockRejectRequest")
	proto.RegisterType((*BlockRejectResponse)(nil), "proto.BlockRejectResponse")
}
...
var fileDescriptor_cab246c8c7c5372d = []byte{
	...
	,
}
...
func (c *vMClient) Initialize(ctx context.Context, in *InitializeRequest, opts ...grpc.CallOption) (*InitializeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/Initialize", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMClient) Shutdown(ctx context.Context, in *ShutdownRequest, opts ...grpc.CallOption) (*ShutdownResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/Shutdown", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMClient) CreateHandlers(ctx context.Context, in *CreateHandlersRequest, opts ...grpc.CallOption) (*CreateHandlersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/CreateHandlers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMClient) BuildBlock(ctx context.Context, in *BuildBlockRequest, opts ...grpc.CallOption) (*BuildBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/BuildBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMClient) ParseBlock(ctx context.Context, in *ParseBlockRequest, opts ...grpc.CallOption) (*ParseBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/ParseBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMClient) GetBlock(ctx context.Context, in *GetBlockRequest, opts ...grpc.CallOption) (*GetBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/GetBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMClient) SetPreference(ctx context.Context, in *SetPreferenceRequest, opts ...grpc.CallOption) (*SetPreferenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/SetPreference", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMClient) LastAccepted(ctx context.Context, in *LastAcceptedRequest, opts ...grpc.CallOption) (*LastAcceptedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/LastAccepted", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMClient) BlockVerify(ctx context.Context, in *BlockVerifyRequest, opts ...grpc.CallOption) (*BlockVerifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/BlockVerify", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMClient) BlockAccept(ctx context.Context, in *BlockAcceptRequest, opts ...grpc.CallOption) (*BlockAcceptResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/BlockAccept", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vMClient) BlockReject(ctx context.Context, in *BlockRejectRequest, opts ...grpc.CallOption) (*BlockRejectResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.VM/BlockReject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _VM_Initialize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VM/Initialize",
	}
...
func _VM_CreateHandlers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VM/CreateHandlers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VM_BuildBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VM/BuildBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VM_ParseBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VM/ParseBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VM_SetPreference_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VM/SetPreference",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VM_LastAccepted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VM/LastAccepted",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VM_BlockVerify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VM/BlockVerify",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VM_BlockAccept_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VM/BlockAccept",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VM_BlockReject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VM/BlockReject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
