...
func NewClient(client messengerpb.MessengerClient, log logging.Logger, getMessage func(ctx context.Context, pChainHeight uint64) (messengerpb.Message, uint64)) *Client {
