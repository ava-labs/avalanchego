...
func (x *InitializeResponse) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *InitializeResponse) GetParentID() []byte {
	if x != nil {
		return x.ParentID
	}
	return nil
...
var file_vm_proto_rawDesc = []byte{
	...
	0x45, 0x70, 0x6f, 0x63, 0x68, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x86, 0x01,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x49, 0x44,
