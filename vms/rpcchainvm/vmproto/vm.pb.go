...
var file_vm_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x62, 0x6c, 0x6b, 0x49, 0x44, 0x22, 0x5c, 0x0a, 0x0e, 0x47,
	0x61, 0x74, 0x68, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4a, 0x0a,
	0x0e, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x46, 0x61, 0x6d, 0x69, 0x6c, 0x69, 0x65, 0x73, 0x18,
	...
	0x63, 0x46, 0x61, 0x6d, 0x69, 0x6c, 0x69, 0x65, 0x73, 0x32, 0xd4, 0x0d, 0x0a, 0x02, 0x56, 0x4d,
...
var file_vm_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_vm_proto_goTypes = []interface{}{
	...
	(*GetBlockIDByHeightRequest)(nil),    // 28: vmproto.GetBlockIDByHeightRequest
	(*GetBlockIDByHeightResponse)(nil),   // 29: vmproto.GetBlockIDByHeightResponse
...
var file_vm_proto_depIdxs = []int32{
	...
	31, // 4: vmproto.GatherResponse.metricFamilies:type_name -> io.prometheus.client.MetricFamily
	0,  // 5: vmproto.VM.Initialize:input_type -> vmproto.InitializeRequest
	32, // 6: vmproto.VM.Bootstrapping:input_type -> google.protobuf.Empty
	32, // 7: vmproto.VM.Bootstrapped:input_type -> google.protobuf.Empty
	...
	28, // 29: vmproto.VM.GetBlockIDByHeight:input_type -> vmproto.GetBlockIDByHeightRequest
	1,  // 30: vmproto.VM.Initialize:output_type -> vmproto.InitializeResponse
	32, // 31: vmproto.VM.Bootstrapping:output_type -> google.protobuf.Empty
	32, // 32: vmproto.VM.Bootstrapped:output_type -> google.protobuf.Empty
	32, // 33: vmproto.VM.Shutdown:output_type -> google.protobuf.Empty
	3,  // 34: vmproto.VM.CreateHandlers:output_type -> vmproto.CreateHandlersResponse
	4,  // 35: vmproto.VM.CreateStaticHandlers:output_type -> vmproto.CreateStaticHandlersResponse
	32, // 36: vmproto.VM.Connected:output_type -> google.protobuf.Empty
	32, // 37: vmproto.VM.Disconnected:output_type -> google.protobuf.Empty
	6,  // 38: vmproto.VM.BuildBlock:output_type -> vmproto.BuildBlockResponse
	8,  // 39: vmproto.VM.ParseBlock:output_type -> vmproto.ParseBlockResponse
	10, // 40: vmproto.VM.GetBlock:output_type -> vmproto.GetBlockResponse
	32, // 41: vmproto.VM.SetPreference:output_type -> google.protobuf.Empty
	16, // 42: vmproto.VM.Health:output_type -> vmproto.HealthResponse
	17, // 43: vmproto.VM.Version:output_type -> vmproto.VersionResponse
	32, // 44: vmproto.VM.AppRequest:output_type -> google.protobuf.Empty
	32, // 45: vmproto.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	32, // 46: vmproto.VM.AppResponse:output_type -> google.protobuf.Empty
	32, // 47: vmproto.VM.AppGossip:output_type -> google.protobuf.Empty
	30, // 48: vmproto.VM.Gather:output_type -> vmproto.GatherResponse
	13, // 49: vmproto.VM.BlockVerify:output_type -> vmproto.BlockVerifyResponse
	32, // 50: vmproto.VM.BlockAccept:output_type -> google.protobuf.Empty
	32, // 51: vmproto.VM.BlockReject:output_type -> google.protobuf.Empty
	...
	29, // 54: vmproto.VM.GetBlockIDByHeight:output_type -> vmproto.GetBlockIDByHeightResponse
