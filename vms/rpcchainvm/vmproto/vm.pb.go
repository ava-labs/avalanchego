...
var file_vm_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x8b, 0x0a, 0x0a, 0x02, 0x56, 0x4d, 0x12, 0x45, 0x0a,
...
var file_vm_proto_depIdxs = []int32{
	...
	22, // 4: vmproto.VM.Bootstrapping:input_type -> google.protobuf.Empty
	22, // 5: vmproto.VM.Bootstrapped:input_type -> google.protobuf.Empty
	22, // 6: vmproto.VM.Shutdown:input_type -> google.protobuf.Empty
	22, // 7: vmproto.VM.CreateHandlers:input_type -> google.protobuf.Empty
	22, // 8: vmproto.VM.CreateStaticHandlers:input_type -> google.protobuf.Empty
	22, // 9: vmproto.VM.BuildBlock:input_type -> google.protobuf.Empty
	7,  // 10: vmproto.VM.ParseBlock:input_type -> vmproto.ParseBlockRequest
	9,  // 11: vmproto.VM.GetBlock:input_type -> vmproto.GetBlockRequest
	11, // 12: vmproto.VM.SetPreference:input_type -> vmproto.SetPreferenceRequest
	22, // 13: vmproto.VM.Health:input_type -> google.protobuf.Empty
	22, // 14: vmproto.VM.Version:input_type -> google.protobuf.Empty
	...
	12, // 19: vmproto.VM.BlockVerify:input_type -> vmproto.BlockVerifyRequest
	...
	22, // 23: vmproto.VM.Bootstrapping:output_type -> google.protobuf.Empty
	22, // 24: vmproto.VM.Bootstrapped:output_type -> google.protobuf.Empty
	22, // 25: vmproto.VM.Shutdown:output_type -> google.protobuf.Empty
	3,  // 26: vmproto.VM.CreateHandlers:output_type -> vmproto.CreateHandlersResponse
	4,  // 27: vmproto.VM.CreateStaticHandlers:output_type -> vmproto.CreateStaticHandlersResponse
	6,  // 28: vmproto.VM.BuildBlock:output_type -> vmproto.BuildBlockResponse
	8,  // 29: vmproto.VM.ParseBlock:output_type -> vmproto.ParseBlockResponse
	10, // 30: vmproto.VM.GetBlock:output_type -> vmproto.GetBlockResponse
	22, // 31: vmproto.VM.SetPreference:output_type -> google.protobuf.Empty
	16, // 32: vmproto.VM.Health:output_type -> vmproto.HealthResponse
	17, // 33: vmproto.VM.Version:output_type -> vmproto.VersionResponse
	22, // 34: vmproto.VM.AppRequest:output_type -> google.protobuf.Empty
	22, // 35: vmproto.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	22, // 36: vmproto.VM.AppResponse:output_type -> google.protobuf.Empty
	22, // 37: vmproto.VM.AppGossip:output_type -> google.protobuf.Empty
	13, // 38: vmproto.VM.BlockVerify:output_type -> vmproto.BlockVerifyResponse
	22, // 39: vmproto.VM.BlockAccept:output_type -> google.protobuf.Empty
	22, // 40: vmproto.VM.BlockReject:output_type -> google.protobuf.Empty
