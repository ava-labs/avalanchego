	...
	t.Run("all values extracted from json", func(t *testing.T) {
		...
		b := []byte(`{
			"network": {
				...
				"push-gossip-first-num-validators": 3,
				"push-gossip-first-num-peers": 4,
				"push-gossip-followup-num-validators": 5,
				"push-gossip-followup-num-peers": 6,
		...
		expected := &ExecutionConfig{
			Network: network.Config{
				...
				TargetGossipSize:                            2,
				PushGossipFirstNumValidators:                3,
				PushGossipFirstNumPeers:                     4,
				PushGossipFollowupNumValidators:             5,
				PushGossipFollowupNumPeers:                  6,
	...
	t.Run("default values applied correctly", func(t *testing.T) {
		...
		expected := &ExecutionConfig{
			Network: network.Config{
				MaxValidatorSetStaleness:                    1,
				TargetGossipSize:                            2,
				PushGossipFirstNumValidators:                DefaultExecutionConfig.Network.PushGossipFirstNumValidators,
				PushGossipFirstNumPeers:                     DefaultExecutionConfig.Network.PushGossipFirstNumPeers,
				PushGossipFollowupNumValidators:             DefaultExecutionConfig.Network.PushGossipFollowupNumValidators,
				PushGossipFollowupNumPeers:                  DefaultExecutionConfig.Network.PushGossipFollowupNumPeers,
