...
type Client interface {
	...
	ExportKey(ctx context.Context, user api.UserPass, address ids.ShortID, options ...rpc.Option) (ids.PrivateKey, error)
...
func (c *client) ExportKey(ctx context.Context, user api.UserPass, address ids.ShortID, options ...rpc.Option) (ids.PrivateKey, error) {
	res := &ExportKeyReply{}
