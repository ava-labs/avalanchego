...
// Source: github.com/ava-labs/avalanchego/vms/platformvm/blocks/stateless (interfaces: Block)

// Package stateless is a generated GoMock package.
package stateless
...
// BlockTxs mocks base method
func (m *MockBlock) BlockTxs() []*txs.Tx {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlockTxs")
	ret0, _ := ret[0].([]*txs.Tx)
	return ret0
}

// BlockTxs indicates an expected call of BlockTxs
func (mr *MockBlockMockRecorder) BlockTxs() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockTxs", reflect.TypeOf((*MockBlock)(nil).BlockTxs))
}
