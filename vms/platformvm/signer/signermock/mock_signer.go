...
//
//	mockgen -source=vms/platformvm/signer/signer.go -destination=vms/platformvm/signer/signermock/mock_signer.go -package=signermock -exclude_interfaces= -mock_names=Signer=Signer
//
