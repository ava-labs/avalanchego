...
func TestDiffStakersGetStakerIterator(t *testing.T) {
	...
	// require.NoError(v.UpdateValidator(updatedStaker, updatedStaker))
...
func TestDiffStakersWeightDiff(t *testing.T) {
...

	{
		...
		// added at all, instead of as a deletion.
		require.Equal(unmodified, gotStatus)
		require.Nil(gotValidator)
	}
