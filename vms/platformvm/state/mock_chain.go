...
func (m *MockChain) ResetContinuousValidatorCycle(subnetID ids.ID, nodeID ids.NodeID, startTime time.Time, weight, potentialReward, totalAccruedRewards, totalAccruedDelegateeRewards uint64) error {
	m.ctrl.T.Helper()
...
func (mr *MockChainMockRecorder) ResetContinuousValidatorCycle(subnetID, nodeID, startTime, weight, potentialReward, totalAccruedRewards, totalAccruedDelegateeRewards any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResetContinuousValidatorCycle", reflect.TypeOf((*MockChain)(nil).ResetContinuousValidatorCycle), subnetID, nodeID, startTime, weight, potentialReward, totalAccruedRewards, totalAccruedDelegateeRewards)
}
...
func (m *MockChain) StopContinuousValidator(subnetID ids.ID, nodeID ids.NodeID) error {
	m.ctrl.T.Helper()
...
func (mr *MockChainMockRecorder) StopContinuousValidator(subnetID, nodeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StopContinuousValidator", reflect.TypeOf((*MockChain)(nil).StopContinuousValidator), subnetID, nodeID)
}
