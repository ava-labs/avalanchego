...
func (s *state) write(updateValidators bool, height uint64) error {
	modifiedCurrentStakers, diffs, err := s.processCurrentStakers()
	if err != nil {
		return err
	}
	...
	return utils.Err(
		err,
		s.writeBlocks(),
		s.writeCurrentStakers(modifiedCurrentStakers, codecVersion),
...
func (s *state) writeCurrentStakers(modifiedStakers []stakerStatusPair, codecVersion uint16) error {
