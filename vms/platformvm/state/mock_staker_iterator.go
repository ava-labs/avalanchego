...
// Source: vms/platformvm/state/staker.go
//
// Generated by this command:
//
//	mockgen -source=vms/platformvm/state/staker.go -destination=vms/platformvm/state/mock_staker_iterator.go -package=state -exclude_interfaces= -mock_names=MockStakerIterator=MockStakerIterator
//
