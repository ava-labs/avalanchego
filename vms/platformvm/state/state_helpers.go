...
func writeChains(subnetID ids.ID, chainTx *txs.Tx, batchOps *[]database.BatchOp) {
...
func writeDelegateeRewards(subnetID ids.ID, nodeID ids.NodeID, amount uint64, batchOps *[]database.BatchOp) {
