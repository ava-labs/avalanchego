...
func (m *MockDiff) StopContinuousValidator(subnetID ids.ID, nodeID ids.NodeID) error {
	m.ctrl.T.Helper()
...
func (mr *MockDiffMockRecorder) StopContinuousValidator(subnetID, nodeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StopContinuousValidator", reflect.TypeOf((*MockDiff)(nil).StopContinuousValidator), subnetID, nodeID)
}
