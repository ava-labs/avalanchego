...
//
//	mockgen -source=vms/platformvm/state/diff.go -destination=vms/platformvm/state/mock_diff.go -package=state -imports feecomponent=github.com/ava-labs/avalanchego/vms/components/fee -exclude_interfaces=
//
...
func (m *MockDiff) SetFeeState(f fee.State) {
	m.ctrl.T.Helper()
