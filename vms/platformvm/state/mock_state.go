...
func (m *MockState) MerkleView() (merkledb.TrieView, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) MerkleView() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MerkleView", reflect.TypeOf((*MockState)(nil).MerkleView))
}
