...
func (m *txMetrics) RewardContinuousValidatorTx(*txs.RewardContinuousValidatorTx) error {
	m.numTxs.With(prometheus.Labels{
...
func (m *txMetrics) SetAutoRestakeConfigTx(*txs.SetAutoRestakeConfigTx) error {
	m.numTxs.With(prometheus.Labels{
