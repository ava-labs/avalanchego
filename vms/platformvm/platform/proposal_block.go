...
type BanffProposalBlock struct {
	...
	Transactions         []*Tx  `serialize:"true" json:"txs"`
...
func (b *BanffProposalBlock) Txs() []*Tx {
...
func (b *BanffProposalBlock) Visit(v BlockVisitor) error {
...
func (b *ApricotProposalBlock) Txs() []*Tx {
	return []*Tx{b.Tx}
}

func (b *ApricotProposalBlock) Visit(v BlockVisitor) error {
