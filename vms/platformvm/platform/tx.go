...
// P-Chain genesis txs whose length exceed the max length of Codec.
func ParseTx(c codec.Manager, signedBytes []byte) (*Tx, error) {
	tx := &Tx{}
...
// genesis txs whose length exceed the max length of Codec.
