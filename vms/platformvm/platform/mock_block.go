...
// Source: github.com/ava-labs/avalanchego/vms/platformvm/platform (interfaces: Block)
//
// Generated by this command:
//
//	mockgen -package=platform -destination=mock_block.go . Block
//
...
func (m *MockBlock) Visit(visitor BlockVisitor) error {
	m.ctrl.T.Helper()
