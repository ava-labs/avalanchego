...
//
//	mockgen -source=vms/platformvm/block/executor/manager.go -destination=vms/platformvm/block/executor/mock_manager.go -package=executor -exclude_interfaces= -write_generate_directive=false -write_package_comment=false
package executor
