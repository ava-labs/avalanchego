...
//
//	mockgen -source=vms/platformvm/txs/unsigned_tx.go -destination=vms/platformvm/txs/mock_unsigned_tx.go -package=txs -exclude_interfaces= -write_generate_directive=false -write_package_comment=false
package txs
