...
func (w *WalletFactory) NewWallet(keys ...*secp256k1.PrivateKey) (builder.Builder, signer.Signer, *fee.Calculator) {
	var (
	...
	return builder.New(addrs, context, backend), signer.New(kc, backend), w.feeCalculator()
}
