...
//go:embed disable_subnet_validator_tx_test.json
var disableSubnetValidatorTxJSON []byte

func TestDisableSubnetValidatorTxSerialization(t *testing.T) {
	...
	var unsignedTx UnsignedTx = &DisableSubnetValidatorTx{
		BaseTx: BaseTx{
			BaseTx: avax.BaseTx{
	...
	expectedBytes := []byte{
		// Codec version
		0x00, 0x00,
		// DisableSubnetValidatorTx Type ID
		0x00, 0x00, 0x00, 0x27,
		// Network ID
		0x00, 0x00, 0x00, 0x0a,
	...
	require.Equal(
		...
		strings.ReplaceAll(string(disableSubnetValidatorTxJSON), "\r\n", "\n"),
		string(txJSON),
	)
}

func TestDisableSubnetValidatorTxSyntacticVerify(t *testing.T) {
	var (
