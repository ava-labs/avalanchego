...
func (*atomicTxExecutor) RewardContinuousValidatorTx(*txs.RewardContinuousValidatorTx) error {
	return ErrWrongTxType
}
...
func (*atomicTxExecutor) SetAutoRestakeConfigTx(*txs.SetAutoRestakeConfigTx) error {
	return ErrWrongTxType
}
