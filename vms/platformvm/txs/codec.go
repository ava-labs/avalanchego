...
const (
	Version                  = 0
	ContinuousStakingVersion = 1

	PreContinuousStakingTag = "precontinuous"
	ContinuousStakingTag    = "continuous"
)
...
func init() {
	...
	errs := wrappers.Errs{}
	for _, c := range []linearcodec.Codec{lc, contLc, gc, contGc} {
