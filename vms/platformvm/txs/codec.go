...
func init() {
	...
	c1 := linearcodec.New([]string{"serialize", TagV1}, linearcodec.DefaultMaxSliceLength)
	Codec = codec.NewDefaultManager()

	gC0 := linearcodec.New([]string{"serialize"}, math.MaxInt32)
	gC1 := linearcodec.New([]string{"serialize", TagV1}, math.MaxInt32)
	GenesisCodec = codec.NewManager(math.MaxInt32)

	errs := wrappers.Errs{}
	for _, c := range []linearcodec.Codec{
		c0,
		c1,
		gC0,
		gC1,
