...
func (m *MockInternalState) AddStatelessBlock(block stateless.CommonBlockIntf, status choices.Status) {
	m.ctrl.T.Helper()
...
func (m *MockInternalState) GetStatelessBlock(blockID ids.ID) (stateless.CommonBlockIntf, choices.Status, error) {
	m.ctrl.T.Helper()
