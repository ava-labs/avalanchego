...
//
//	mockgen -package=p -destination=wallet/chain/p/mock_builderbackend.go github.com/ava-labs/avalanchego/wallet/chain/p BuilderBackend
//
...
func (m *MockBuilderBackend) GetTx(arg0 ctx.Context, arg1 ids.ID) (*txs.Tx, error) {
	m.ctrl.T.Helper()
...
func (m *MockBuilderBackend) UTXOs(arg0 ctx.Context, arg1 ids.ID) ([]*avax.UTXO, error) {
	m.ctrl.T.Helper()
