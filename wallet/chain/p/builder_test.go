...
func TestBaseTx(t *testing.T) {
	...
	{ // Post E-Upgrade
		feeCalc := fees.NewDynamicCalculator(testStaticConfig, logging.NoLog{}, time.Time{}, commonfees.NewManager(testFeeRates), testBlockMaxComplexity, nil)
		...
		fc := fees.NewDynamicCalculator(testStaticConfig, logging.NoLog{}, time.Time{}, commonfees.NewManager(testFeeRates), testBlockMaxComplexity, tx.Creds)
	...
	{ // Pre E-Upgrade
		feeCalc := fees.NewStaticCalculator(testStaticConfig, time.Time{}, nil)
		utx, err := builder.NewBaseTx(
			outputsToMove,
			feeCalc,
		)
		...
		fc := fees.NewStaticCalculator(testStaticConfig, time.Time{}, nil)
		require.NoError(utx.Visit(fc))
