...
func (w *withOptions) NewIncreaseBalanceTx(
	validationID ids.ID,
	balance uint64,
	options ...common.Option,
) (*txs.IncreaseBalanceTx, error) {
	return w.builder.NewIncreaseBalanceTx(
		validationID,
		balance,
		common.UnionOptions(w.options, options)...,
	)
...
func (w *withOptions) NewDisableSubnetValidatorTx(
	validationID ids.ID,
	options ...common.Option,
) (*txs.DisableSubnetValidatorTx, error) {
	return w.builder.NewDisableSubnetValidatorTx(
		validationID,
		common.UnionOptions(w.options, options)...,
	)
}
