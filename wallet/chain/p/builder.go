...
func (b *builder) NewBaseTx(
	...
	return &unsigned.CreateSubnetTx{
...
func (b *builder) NewAddValidatorTx(
	...
	return &unsigned.AddValidatorTx{
		BaseTx: unsigned.BaseTx{BaseTx: avax.BaseTx{
			NetworkID:    b.backend.NetworkID(),
			BlockchainID: constants.PlatformChainID,
			Ins:          inputs,
...
func (b *builder) NewAddSubnetValidatorTx(
	...
	return &unsigned.AddSubnetValidatorTx{
		BaseTx: unsigned.BaseTx{BaseTx: avax.BaseTx{
			NetworkID:    b.backend.NetworkID(),
			BlockchainID: constants.PlatformChainID,
			Ins:          inputs,
...
func (b *builder) NewAddDelegatorTx(
	...
	ids.SortShortIDs(rewardsOwner.Addrs)
	return &unsigned.AddDelegatorTx{
		BaseTx: unsigned.BaseTx{BaseTx: avax.BaseTx{
			NetworkID:    b.backend.NetworkID(),
			BlockchainID: constants.PlatformChainID,
			Ins:          inputs,
