...
func (b *builder) NewBaseTx(
	...
	avax.SortTransferableOutputs(outputs, stateless.Codec) // sort the outputs
...
func (b *builder) NewExportTx(
	...
	avax.SortTransferableOutputs(outputs, stateless.Codec) // sort exported outputs
	return &txs.ExportTx{
		BaseTx: txs.BaseTx{BaseTx: avax.BaseTx{
			NetworkID:    b.backend.NetworkID(),
			BlockchainID: constants.PlatformChainID,
...
func (b *builder) spend(
	...
	avax.SortTransferableOutputs(changeOutputs, stateless.Codec) // sort the change outputs
	avax.SortTransferableOutputs(stakeOutputs, stateless.Codec)  // sort stake outputs
