...
func (m *MockOutboundMsgBuilder) Ping(arg0 []*p2p.SubnetUptime) (OutboundMessage, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOutboundMsgBuilderMockRecorder) Ping(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
