...
func main() {
	...
	externalIPUpdater := dynamicip.NewExternalIPUpdater(Config.DynamicConsensusIP, Config.DynamicUpdateDuration, log, &Config.StakingIP, Config.DynamicConsensusResolver)
