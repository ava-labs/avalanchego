...
const (
	...
	networkGossipPeerListSizeKey            = "network-gossip-peer-list-size"
	networkGossipPeerListToKey              = "network-gossip-peer-list-to"
	networkGossipPeerListFreqKey            = "network-gossip-peer-list-frequency"
