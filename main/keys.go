...
const (
	...
	networkHealthMinPeers                = "network-health-min-conn-peers"
	networkHealthMaxTimeSinceMsgReceived = "network-health-max-time-since-msg-received"
	networkHealthMaxTimeSinceMsgSent     = "network-health-max-time-since-msg-sent"
	networkHealthMaxPctSendQueueFill     = "network-health-max-percent-send-queue-full"
