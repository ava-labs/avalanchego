...
// with [keySet].
func (s *state) appendTraitKeys(keys *[][]byte, keySet *ids.Set[ids.ID], limit *int, trait, startKey []byte) ([]byte, error) {
	lastKey := startKey
