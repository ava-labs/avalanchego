...
TESTING_CONTROLLER_IMAGE="$DOCKER_REPO/avalanche-testing_controller:manhattan-v0.9.4"
BYZANTINE_IMAGE="$DOCKER_REPO/avalanche-byzantine:manhattan-dev.1"
