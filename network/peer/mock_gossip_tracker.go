...
func (m *MockGossipTracker) AddValidator(arg0 GossipValidator) bool {
	m.ctrl.T.Helper()
...
func (m *MockGossipTracker) GetUnknown(arg0 ids.NodeID, arg1 int) ([]GossipValidator, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUnknown", arg0, arg1)
	ret0, _ := ret[0].([]GossipValidator)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
