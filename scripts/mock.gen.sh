...
generated_files=( $(grep -Rl 'Code generated by MockGen. DO NOT EDIT.') )

# Exclude helpers files
outputted_files+=('.github/workflows/ci.yml')
outputted_files+=('scripts/mock.gen.sh')

diff_files=(`echo ${generated_files[@]} ${outputted_files[@]} | tr ' ' '\n' | sort | uniq -u`)
