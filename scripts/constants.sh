...
CORETH_VER="v0.5.2-rc.1" # Current version of Coreth to use
PREUPGRADE_AVALANCHEGO_VER="v1.4.3" # Release of AvalancheGo compatible with previous database version
