...
--network-runner-caminogo-path=/tmp/caminogo-v${VERSION}/caminogo \
--network-runner-caminogo-path-to-upgrade=${NEW_BINARY} \
--network-runner-caminogo-log-level="WARN" || EXIT_CODE=$?
