...
#   CONFIG (optional): Configuration name (defaults to "default").
...
#   METRICS_SERVER_PORT (optional): Port for the metrics server (defaults to "0").
...
echo "=== C-Chain Re-execution Benchmark Environment Variables ==="
