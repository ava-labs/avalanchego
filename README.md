...
### Minimum Hardware Requirements (Mainnet)
- CPU: Equivalent of 8 AWS vCPU
- RAM: 16 GiB
- Storage: 1 TiB SSD (NVMe SSD recommended for better performance)
- Network: Reliable IPv4 or IPv6 connection with at least 1 Gbps bandwidth
- Ports: 9650 and 9651 must be open for inbound TCP traffic

### Development Requirements
- [Go](https://golang.org/doc/install) version >= 1.22.8
- [gcc](https://gcc.gnu.org/) version 7 or higher
- g++ version 7 or higher
- Git

### Recommended OS
- Ubuntu 20.04/22.04 LTS (Tier 1 Support)
- macOS >= 12 (Tier 2 Support)
- Other Linux distributions with systemd
- Windows (Tier 3 Support - Experimental)
