...
- Removed static fee config options
...
- [tmpnet] Update monitoring urls from _-experimental to _-poc by @marun in https://github.com/ava-labs/avalanchego/pull/3306
