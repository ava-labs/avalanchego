...
- Added SAE execution-pressure metrics:
  ...
  - `avalanche_evm_sae_execute_block_duration_seconds` (histogram): wall-clock time to execute a single block, including the state commit and post-execution work.
  - `avalanche_evm_sae_execution_queue_blocks` (gauge): number of accepted blocks that have not yet completed execution.
  - `avalanche_evm_sae_execution_queue_gas_limit` (gauge): worst-case gas of accepted blocks that have not yet completed execution, being their transaction gas limits plus end-of-block operation gas.
  ...
  - `avalanche_evm_sae_executed_gas_limit_total` (counter): cumulative worst-case gas of executed blocks.
...
- Added `avalanche_evm_sae_accepted_gas_limit_total` (counter): cumulative worst-case gas of blocks accepted into the execution queue; the acceptance-side counterpart of `executed_gas_limit_total`.
- Added SAE gas-time and pricing metrics:
  ...
  - `avalanche_evm_sae_worst_case_base_fee` (gauge): worst-case base fee admitted by consensus for the latest executed block.
  - `avalanche_evm_sae_executed_base_fee` (gauge): base fee realized by execution of the latest executed block.
  - `avalanche_evm_sae_worst_case_gas_excess` (gauge): worst-case gas excess simulated for the latest executed block.
  - `avalanche_evm_sae_executed_gas_excess` (gauge): gas excess realized by execution of the latest executed block.
  - `avalanche_evm_sae_gas_target` (gauge): ACP-176 gas target in force as of the latest executed block.
...
- `api-resolve-pending-to-last-executed` for SAE named-block resolution, optionally mapping "pending" to the last-executed instead of last-accepted block.
