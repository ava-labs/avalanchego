...
This checklist ists all the required steps when adding a new network upgrade/fork to AvalancheGo. Note that this list is not exhaustive nor future-proof.
