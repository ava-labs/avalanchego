...
func newDatabase(
	...
	trieDB := &merkleDB{
		...
		intermediateNodeDB:   newIntermediateNodeDB(db, bufferPool, metrics, int(config.IntermediateNodeCacheSize), int(config.EvictionBatchSize), bfToSize[config.BranchFactor]),
		...
		tokenSize:            bfToSize[config.BranchFactor],
	}
