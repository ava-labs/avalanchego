...
func Test_History_Simple(t *testing.T) {
	...
	require.NoError(err)
	batch := db.NewBatch()
	err = batch.Put(context.Background(), []byte("key"), []byte("value"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	...
	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("key"), []byte("value0"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	...
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key8"), []byte("value8"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	newProof, err = db.GetRangeProofAtRoot(context.Background(), origRootID, []byte("k"), []byte("key3"), 10)
	...
	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("k"), []byte("v"))
	require.NoError(err)
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	...
	batch = db.NewBatch()
	err = batch.Delete(context.Background(), []byte("k"))
	require.NoError(err)
	err = batch.Delete(context.Background(), []byte("ke"))
	require.NoError(err)
	err = batch.Delete(context.Background(), []byte("key"))
	require.NoError(err)
	err = batch.Delete(context.Background(), []byte("key1"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key2"), []byte("value2"))
	require.NoError(err)
	err = batch.Delete(context.Background(), []byte("key3"))
	require.NoError(err)
	err = batch.Delete(context.Background(), []byte("key4"))
	require.NoError(err)
	err = batch.Delete(context.Background(), []byte("key5"))
	require.NoError(err)
	err = batch.Delete(context.Background(), []byte("key8"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	newProof, err = db.GetRangeProofAtRoot(context.Background(), origRootID, []byte("k"), []byte("key3"), 10)
...
func Test_History_Bad_GetValueChanges_Input(t *testing.T) {
	...
	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("key1"), []byte("value0"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	...
	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("key2"), []byte("value3"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	...
	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("key2"), []byte("value4"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
...
func Test_History_RepeatedRoot(t *testing.T) {
	...
	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("key1"), []byte("other"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key2"), []byte("other"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key3"), []byte("other"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	newProof, err := db.GetRangeProofAtRoot(context.Background(), origRootID, []byte("k"), []byte("key3"), 10)
...
func Test_History_ExcessDeletes(t *testing.T) {
	...
	err = batch.Delete(context.Background(), []byte("key1"))
	require.NoError(err)
	err = batch.Delete(context.Background(), []byte("key2"))
	require.NoError(err)
	err = batch.Delete(context.Background(), []byte("key3"))
	require.NoError(err)
	err = batch.Delete(context.Background(), []byte("key4"))
...
func Test_History_DontIncludeAllNodes(t *testing.T) {
	...
	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("z"), []byte("z"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	newProof, err := db.GetRangeProofAtRoot(context.Background(), origRootID, []byte("k"), []byte("key3"), 10)
...
func Test_History_Branching3Nodes(t *testing.T) {
	...
	require.NoError(err)
	batch := db.NewBatch()
	err = batch.Put(context.Background(), []byte("key123"), []byte("value123"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	...
	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("key321"), []byte("value321"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	newProof, err := db.GetRangeProofAtRoot(context.Background(), origRootID, []byte("k"), []byte("key3"), 10)
...
func Test_History_MaxLength(t *testing.T) {
	...
	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("k1"), []byte("v2"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
...
func Test_Change_List(t *testing.T) {
	...
	require.NoError(err)
	batch := db.NewBatch()
	err = batch.Put(context.Background(), []byte("key20"), []byte("value20"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key21"), []byte("value21"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key22"), []byte("value22"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key23"), []byte("value23"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key24"), []byte("value24"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)
	...
	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("key25"), []byte("value25"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key26"), []byte("value26"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key27"), []byte("value27"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key28"), []byte("value28"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key29"), []byte("value29"))
	require.NoError(err)
	err = batch.Write()
	require.NoError(err)

	batch = db.NewBatch()
	err = batch.Put(context.Background(), []byte("key30"), []byte("value30"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key31"), []byte("value31"))
	require.NoError(err)
	err = batch.Put(context.Background(), []byte("key32"), []byte("value32"))
	require.NoError(err)
