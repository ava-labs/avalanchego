...
//
//	mockgen -source=x/merkledb/db.go -destination=x/merkledb/mock_db.go -package=merkledb -exclude_interfaces=ChangeProofer -write_generate_directive=false -write_package_comment=false
package merkledb
