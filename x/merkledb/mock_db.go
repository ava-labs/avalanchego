...
//
//	mockgen -source=x/merkledb/db.go -destination=x/merkledb/mock_db.go -package=merkledb -exclude_interfaces= -write_generate_directive=false -write_package_comment=false
package merkledb
...
// MockChangeProofer is a mock of ChangeProofer interface.
type MockChangeProofer struct {
	ctrl     *gomock.Controller
	recorder *MockChangeProoferMockRecorder
}

// MockChangeProoferMockRecorder is the mock recorder for MockChangeProofer.
type MockChangeProoferMockRecorder struct {
	mock *MockChangeProofer
}

// NewMockChangeProofer creates a new mock instance.
func NewMockChangeProofer(ctrl *gomock.Controller) *MockChangeProofer {
	mock := &MockChangeProofer{ctrl: ctrl}
	mock.recorder = &MockChangeProoferMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockChangeProofer) EXPECT() *MockChangeProoferMockRecorder {
	return m.recorder
}

// CommitChangeProof mocks base method.
func (m *MockChangeProofer) CommitChangeProof(ctx context.Context, proof *ChangeProof) error {
	m.ctrl.T.Helper()
...
func (mr *MockChangeProoferMockRecorder) CommitChangeProof(ctx, proof any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CommitChangeProof", reflect.TypeOf((*MockChangeProofer)(nil).CommitChangeProof), ctx, proof)
}

// GetChangeProof mocks base method.
func (m *MockChangeProofer) GetChangeProof(ctx context.Context, startRootID, endRootID ids.ID, start, end maybe.Maybe[[]byte], maxLength int) (*ChangeProof, error) {
	m.ctrl.T.Helper()
...
func (mr *MockChangeProoferMockRecorder) GetChangeProof(ctx, startRootID, endRootID, start, end, maxLength any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetChangeProof", reflect.TypeOf((*MockChangeProofer)(nil).GetChangeProof), ctx, startRootID, endRootID, start, end, maxLength)
}

// VerifyChangeProof mocks base method.
func (m *MockChangeProofer) VerifyChangeProof(ctx context.Context, proof *ChangeProof, start, end maybe.Maybe[[]byte], expectedEndRootID ids.ID) error {
	m.ctrl.T.Helper()
...
func (mr *MockChangeProoferMockRecorder) VerifyChangeProof(ctx, proof, start, end, expectedEndRootID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VerifyChangeProof", reflect.TypeOf((*MockChangeProofer)(nil).VerifyChangeProof), ctx, proof, start, end, expectedEndRootID)
}

// MockRangeProofer is a mock of RangeProofer interface.
type MockRangeProofer struct {
	ctrl     *gomock.Controller
	recorder *MockRangeProoferMockRecorder
}

// MockRangeProoferMockRecorder is the mock recorder for MockRangeProofer.
type MockRangeProoferMockRecorder struct {
	mock *MockRangeProofer
}

// NewMockRangeProofer creates a new mock instance.
func NewMockRangeProofer(ctrl *gomock.Controller) *MockRangeProofer {
	mock := &MockRangeProofer{ctrl: ctrl}
	mock.recorder = &MockRangeProoferMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockRangeProofer) EXPECT() *MockRangeProoferMockRecorder {
	return m.recorder
}

// CommitRangeProof mocks base method.
func (m *MockRangeProofer) CommitRangeProof(ctx context.Context, start, end maybe.Maybe[[]byte], proof *RangeProof) error {
	m.ctrl.T.Helper()
...
func (mr *MockRangeProoferMockRecorder) CommitRangeProof(ctx, start, end, proof any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CommitRangeProof", reflect.TypeOf((*MockRangeProofer)(nil).CommitRangeProof), ctx, start, end, proof)
}

// GetRangeProofAtRoot mocks base method.
func (m *MockRangeProofer) GetRangeProofAtRoot(ctx context.Context, rootID ids.ID, start, end maybe.Maybe[[]byte], maxLength int) (*RangeProof, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRangeProoferMockRecorder) GetRangeProofAtRoot(ctx, rootID, start, end, maxLength any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRangeProofAtRoot", reflect.TypeOf((*MockRangeProofer)(nil).GetRangeProofAtRoot), ctx, rootID, start, end, maxLength)
}
...
func (m *MockClearer) Clear() error {
	m.ctrl.T.Helper()
...
func (mr *MockClearerMockRecorder) Clear() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Clear", reflect.TypeOf((*MockClearer)(nil).Clear))
}
...
func (m *MockPrefetcher) PrefetchPath(key []byte) error {
	m.ctrl.T.Helper()
...
func (mr *MockPrefetcherMockRecorder) PrefetchPath(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PrefetchPath", reflect.TypeOf((*MockPrefetcher)(nil).PrefetchPath), key)
}

// PrefetchPaths mocks base method.
func (m *MockPrefetcher) PrefetchPaths(keys [][]byte) error {
	m.ctrl.T.Helper()
...
func (mr *MockPrefetcherMockRecorder) PrefetchPaths(keys any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PrefetchPaths", reflect.TypeOf((*MockPrefetcher)(nil).PrefetchPaths), keys)
}
