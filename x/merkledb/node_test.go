...
func Test_Node_Marshal(t *testing.T) {
	...
	rootIndex := getSingleChildKey(BranchFactor16TokenConfig, root).Token(0, BranchFactor16TokenConfig.tokenBitSize)
	parsedIndex := getSingleChildKey(BranchFactor16TokenConfig, rootParsed).Token(0, BranchFactor16TokenConfig.tokenBitSize)
