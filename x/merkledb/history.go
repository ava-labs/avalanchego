...
func newTrieHistory(maxHistoryLookback int, convertToKey func([]byte) Key) *trieHistory {
	return &trieHistory{
...
func (th *trieHistory) getValueChanges(
	...
	var (
		...
		startKey = maybe.Bind(start, th.convertToKey)
		endKey   = maybe.Bind(end, th.convertToKey)
