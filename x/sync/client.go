...
type Client interface {
	...
	GetChangeProof(ctx context.Context, request *syncpb.ChangeProofRequest, verificationDB merkledb.SyncableDB) (*merkledb.ChangeProof, error)
}
...
func (c *client) GetChangeProof(ctx context.Context, req *syncpb.ChangeProofRequest, db merkledb.SyncableDB) (*merkledb.ChangeProof, error) {
