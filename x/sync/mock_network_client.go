...
//
//	mockgen -source=x/sync/network_client.go -destination=x/sync/mock_network_client.go -package=sync -exclude_interfaces= -write_generate_directive=false -write_package_comment=false
package sync
...
func (mr *MockNetworkClientMockRecorder) Request(ctx, nodeID, request any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
