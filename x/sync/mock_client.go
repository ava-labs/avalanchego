...
func (m *MockClient) GetChangeProof(arg0 context.Context, arg1 *sync.GetChangeProofRequest, arg2 SyncableDB) (*merkledb.ChangeProof, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetRangeProof(arg0 context.Context, arg1 *sync.GetRangeProofRequest) (*merkledb.RangeProof, error) {
	m.ctrl.T.Helper()
