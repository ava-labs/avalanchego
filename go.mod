...
require github.com/ava-labs/avalanchego/graft/evm-shared v0.0.0-00010101000000-000000000000 // indirect
...
replace github.com/ava-labs/avalanchego/graft/evm-shared => ./graft/evm-shared
