...
require (
	...
	github.com/ava-labs/coreth v0.12.7-0.20231024005555-174a43252adb
...
replace github.com/ethereum/go-ethereum => github.com/marun/go-ethereum v0.0.0-20231024004541-d9e201fd4832
