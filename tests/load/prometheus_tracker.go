...
func NewPrometheusTracker[T comparable](reg *prometheus.Registry, logger logging.Logger) (*PrometheusTracker[T], error) {
...
func (t *PrometheusTracker[T]) LogPeriodically(ctx context.Context) {
