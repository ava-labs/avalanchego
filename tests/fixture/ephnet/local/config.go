...
const (
	...
	NetworkDirEnvName      = "EPHNET_NETWORK_DIR"
	RootDirEnvName         = "EPHNET_ROOT_DIR"
...
func LocalFlags() ephnet.FlagsMap {
	...
	return ephnet.FlagsMap{
		...
		config.MinStakeDurationKey:          ephnet.DefaultMinStakeDuration.String(),
	}
}

// C-Chain config for local testing.
func LocalCChainConfig() ephnet.FlagsMap {
