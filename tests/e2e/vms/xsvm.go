...
var _ = ginkgo.Describe("[XSVM]", ginkgo.Label("xsvm"), func() {
	...
	ginkgo.It("should support transfers between subnets", func() {
		...
		sourceValidators := tmpnet.NodesForIDs(network.Nodes, sourceSubnet.ValidatorIDs)
		...
		destinationValidators := tmpnet.NodesForIDs(network.Nodes, destinationSubnet.ValidatorIDs)
