...
func (m *MockBlock) VerifyProposer(arg0 context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockBlockMockRecorder) VerifyProposer(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VerifyProposer", reflect.TypeOf((*MockBlock)(nil).VerifyProposer), arg0)
}
