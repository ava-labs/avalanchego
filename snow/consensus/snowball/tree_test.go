...
func TestSnowballSingleton(t *testing.T) {
	...
	tree := NewTree(FactoryInstance, params, Red)
...
func TestSnowballLastBinary(t *testing.T) {
	...
	tree := NewTree(FactoryInstance, params, zero)
	tree.Add(one)
...
func TestSnowballTrinary(t *testing.T) {
	...
	tree := NewTree(FactoryInstance, params, Green)
	tree.Add(Red)
	tree.Add(Blue)
...
func TestSnowballCloseTrinary(t *testing.T) {
	...
	tree := NewTree(FactoryInstance, params, yellow)
	tree.Add(cyan)
	tree.Add(magenta)
...
func TestSnowballResetChild(t *testing.T) {
	...
	tree := NewTree(FactoryInstance, params, c0000)
	tree.Add(c0100)
	tree.Add(c1000)
...
func TestSnowball5Colors(t *testing.T) {
	...
	tree0 := NewTree(FactoryInstance, params, colors[4])
	...
	tree1 := NewTree(FactoryInstance, params, colors[3])
...
func TestSnowballConsistent(t *testing.T) {
	...
	n := NewNetwork(FactoryInstance, params, numColors, source)
