...
// AcceptedStateSummary provides a mock function with given fields: validatorID, requestID, keys
func (_m *Engine) AcceptedStateSummary(validatorID ids.ShortID, requestID uint32, keys [][]byte) error {
