...
// AppGossip provides a mock function with given fields: nodeID, chainID, msg
func (_m *Engine) AppGossip(nodeID ids.NodeID, chainID ids.ID, msg []byte) error {
	ret := _m.Called(nodeID, chainID, msg)

	var r0 error
	if rf, ok := ret.Get(0).(func(ids.NodeID, ids.ID, []byte) error); ok {
		r0 = rf(nodeID, chainID, msg)
	} else {
		r0 = ret.Error(0)
	}
