...
func (m *LinearizableVM) NewHTTPHandler(arg0 context.Context) (http.Handler, error) {
	m.ctrl.T.Helper()
...
func (mr *LinearizableVMMockRecorder) NewHTTPHandler(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewHTTPHandler", reflect.TypeOf((*LinearizableVM)(nil).NewHTTPHandler), arg0)
}
