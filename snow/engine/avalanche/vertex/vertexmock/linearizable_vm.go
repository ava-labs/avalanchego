...
func (m *LinearizableVM) SubscribeToEvents(arg0 context.Context) common.Message {
	m.ctrl.T.Helper()
...
func (mr *LinearizableVMMockRecorder) SubscribeToEvents(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubscribeToEvents", reflect.TypeOf((*LinearizableVM)(nil).SubscribeToEvents), arg0)
}
