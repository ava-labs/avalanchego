...
// Initialize provides a mock function with given fields: config, getAcceptedF, acceptedF, getAcceptedFailedF, getAcceptedFrontierF, acceptedFrontierF, getAcceptedFrontierFailedF, multiPutF, getAncestorsFailedF, contextF, timeoutF, haltF, connectedF, disconnectedF
func (_m *Engine) Initialize(config snowman.Config, getAcceptedF func(ids.ShortID, uint32, []ids.ID) error, acceptedF func(ids.ShortID, uint32, []ids.ID) error, getAcceptedFailedF func(ids.ShortID, uint32) error, getAcceptedFrontierF func(ids.ShortID, uint32) error, acceptedFrontierF func(ids.ShortID, uint32, []ids.ID) error, getAcceptedFrontierFailedF func(ids.ShortID, uint32) error, multiPutF func(ids.ShortID, uint32, [][]byte) error, getAncestorsFailedF func(ids.ShortID, uint32) error, contextF func() *snow.Context, timeoutF func() error, haltF func(), connectedF func(ids.ShortID) error, disconnectedF func(ids.ShortID) error) (func() error, error) {
	ret := _m.Called(config, getAcceptedF, acceptedF, getAcceptedFailedF, getAcceptedFrontierF, acceptedFrontierF, getAcceptedFrontierFailedF, multiPutF, getAncestorsFailedF, contextF, timeoutF, haltF, connectedF, disconnectedF)

	var r0 func() error
	if rf, ok := ret.Get(0).(func(snowman.Config, func(ids.ShortID, uint32, []ids.ID) error, func(ids.ShortID, uint32, []ids.ID) error, func(ids.ShortID, uint32) error, func(ids.ShortID, uint32) error, func(ids.ShortID, uint32, []ids.ID) error, func(ids.ShortID, uint32) error, func(ids.ShortID, uint32, [][]byte) error, func(ids.ShortID, uint32) error, func() *snow.Context, func() error, func(), func(ids.ShortID) error, func(ids.ShortID) error) func() error); ok {
		r0 = rf(config, getAcceptedF, acceptedF, getAcceptedFailedF, getAcceptedFrontierF, acceptedFrontierF, getAcceptedFrontierFailedF, multiPutF, getAncestorsFailedF, contextF, timeoutF, haltF, connectedF, disconnectedF)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(snowman.Config, func(ids.ShortID, uint32, []ids.ID) error, func(ids.ShortID, uint32, []ids.ID) error, func(ids.ShortID, uint32) error, func(ids.ShortID, uint32) error, func(ids.ShortID, uint32, []ids.ID) error, func(ids.ShortID, uint32) error, func(ids.ShortID, uint32, [][]byte) error, func(ids.ShortID, uint32) error, func() *snow.Context, func() error, func(), func(ids.ShortID) error, func(ids.ShortID) error) error); ok {
		r1 = rf(config, getAcceptedF, acceptedF, getAcceptedFailedF, getAcceptedFrontierF, acceptedFrontierF, getAcceptedFrontierFailedF, multiPutF, getAncestorsFailedF, contextF, timeoutF, haltF, connectedF, disconnectedF)
	} else {
		r1 = ret.Error(1)
	}
