...
func (_m *Engine) Initialize(config snowman.Config) (func() error, error) {
	ret := _m.Called(config)

	var r0 func() error
	if rf, ok := ret.Get(0).(func(snowman.Config) func() error); ok {
		r0 = rf(config)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(snowman.Config) error); ok {
		r1 = rf(config)
	} else {
		r1 = ret.Error(1)
	}
