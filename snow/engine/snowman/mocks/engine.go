...
// Initialize provides a mock function with given fields: config, ctx, sender, requestID, _a4
func (_m *Engine) Initialize(config snowman.Config, ctx *snow.Context, sender common.Sender, requestID *uint32, _a4 validators.Set) (func() error, error) {
	ret := _m.Called(config, ctx, sender, requestID, _a4)

	var r0 func() error
	if rf, ok := ret.Get(0).(func(snowman.Config, *snow.Context, common.Sender, *uint32, validators.Set) func() error); ok {
		r0 = rf(config, ctx, sender, requestID, _a4)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(snowman.Config, *snow.Context, common.Sender, *uint32, validators.Set) error); ok {
		r1 = rf(config, ctx, sender, requestID, _a4)
	} else {
		r1 = ret.Error(1)
	}
