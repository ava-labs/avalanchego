...
// Initialize provides a mock function with given fields: config, theOneCommonBootstrapper
func (_m *Engine) Initialize(config snowman.Config, theOneCommonBootstrapper *common.Bootstrapper) (func() error, error) {
	ret := _m.Called(config, theOneCommonBootstrapper)

	var r0 func() error
	if rf, ok := ret.Get(0).(func(snowman.Config, *common.Bootstrapper) func() error); ok {
		r0 = rf(config, theOneCommonBootstrapper)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(snowman.Config, *common.Bootstrapper) error); ok {
		r1 = rf(config, theOneCommonBootstrapper)
	} else {
		r1 = ret.Error(1)
	}
