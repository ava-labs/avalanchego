...
// 		}
// 	}
// 	sender.ChitsF = func(ids.ShortID, uint32, []ids.ID) {}
// 	sender.GetF = func(vdr ids.ShortID, requestID uint32, vtxID ids.ID) {}

// 	if err := te.PushQuery(vdr, 0, validBlk.ID(), validBlk.Bytes()); err != nil {
// 		t.Error(err)
// 	}

// 	sender.PushQueryF = nil

// 	if err := te.PushQuery(vdr, 1, invalidBlk.ID(), invalidBlk.Bytes()); err != nil {
// 		t.Error(err)
// 	}
