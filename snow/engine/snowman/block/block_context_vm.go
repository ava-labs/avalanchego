...
type Context struct {
	...
	// RandomnessSeed is a random seed, generated by the proposer VM in a trust-worthy
	// way that ensures true fairness and randomness while removing bias. The VM has the
	// ability to leverage the randomness during the block execution.
	RandomnessSeed [hashing.HashLen]byte
}
