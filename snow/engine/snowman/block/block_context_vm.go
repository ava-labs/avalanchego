...
type Context struct {
	...
	// RandomnessSeed is a random seed, generated by the proposer VM is a trust-worthy
	// way that ensure true fairness and randomness while removing bias. The VM has the
