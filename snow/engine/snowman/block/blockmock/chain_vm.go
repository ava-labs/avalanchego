...
func (m *ChainVM) CreateHTTP2Handler(arg0 context.Context) (http.Handler, error) {
	m.ctrl.T.Helper()
...
func (mr *ChainVMMockRecorder) CreateHTTP2Handler(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateHTTP2Handler", reflect.TypeOf((*ChainVM)(nil).CreateHTTP2Handler), arg0)
}
