...
type TestVM struct {
	...
	AppRequestFailedF           func(ctx context.Context, nodeID ids.NodeID, requestID uint32, err *AppError) error
	...
	CrossChainAppRequestFailedF func(ctx context.Context, chainID ids.ID, requestID uint32, err *AppError) error
}
