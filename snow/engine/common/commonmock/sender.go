...
//
//	mockgen -package=commonmock -source=sender.go -destination=commonmock/sender.go -mock_names=Sender=Sender -exclude_interfaces=StateSummarySender,AcceptedStateSummarySender,FrontierSender,AcceptedSender,FetchSender,AppSender,QuerySender,Gossiper
//
