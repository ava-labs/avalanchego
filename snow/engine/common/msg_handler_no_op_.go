...
// FastSyncHandler interface
func (nop MsgHandlerNoOps) GetStateSummaryFrontier(validatorID ids.ShortID, requestID uint32) error {
	nop.ctx.Log.Debug("GetStateSummaryFrontier(%s, %d) unhandled by this gear. Dropped.", validatorID, requestID)
	return nil
}
...
func (nop MsgHandlerNoOps) GetAcceptedStateSummaryFailed(validatorID ids.ShortID, requestID uint32) error {
	nop.ctx.Log.Debug("GetAcceptedStateSummaryFailed(%s, %d) unhandled by this gear. Dropped.", validatorID, requestID)
	return nil
}

func (nop MsgHandlerNoOps) GetStateSummaryFrontierFailed(validatorID ids.ShortID, requestID uint32) error {
	nop.ctx.Log.Debug("GetStateSummaryFrontierFailed(%s, %d) unhandled by this gear. Dropped.", validatorID, requestID)
	return nil
}
