...
func EngineFromEngines(ctx *snow.ConsensusContext, engineFactory engineFactory, vm common.VM) (*Engine, error) {
...
func (n noOpEngine) Start(_ context.Context, _ uint32) error {
	return nil
}

func (n noOpEngine) HealthCheck(_ context.Context) (interface{}, error) {
	return nil, nil
}

func (n noOpEngine) IsEnabled(_ context.Context) (bool, error) {
	return false, nil
}
...
func (n noopBootstrapper) Clear(ctx context.Context) error {
	return nil
}
...
func (e *Engine) HealthCheck(ctx context.Context) (interface{}, error) {
	...
	default:
		panic(fmt.Errorf("invalid state: %s", state.State))
		return e.noopSnowmanEngine.HealthCheck(ctx)
	}
}
...
func (e *Engine) startAvalancheBootstrapper(ctx context.Context, startReqID uint32) error {
	e.Log.Error(">>>>> STARTING AVALANCHE BOOTSTRAPPER")
