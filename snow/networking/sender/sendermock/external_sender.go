...
// Source: external_sender.go
//
// Generated by this command:
//
//	mockgen -package=sendermock -source=external_sender.go -destination=sendermock/external_sender.go -mock_names=ExternalSender=ExternalSender
//
