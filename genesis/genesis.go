...
func FromConfig(config *Config) ([]byte, ids.ID, error) {
	...
	platformvmArgs := p_api.BuildGenesisArgs{
	...
	platformvmArgs.Chains = []p_api.Chain{
		{
	...
	platformvmReply := p_api.BuildGenesisReply{}
