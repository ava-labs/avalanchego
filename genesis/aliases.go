...
import (
	...
	pchainapi "github.com/ava-labs/avalanchego/vms/platformvm/genesis"
)
...
func Aliases(genesisBytes []byte) (map[string][]string, map[ids.ID][]string, error) {
	...
	genesis, err := pchainapi.New(genesisBytes) // TODO let's not re-create genesis to do aliasing
	if err != nil {
		return nil, nil, err
	}
