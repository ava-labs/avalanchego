...
//go:generate go tool -modfile=../../../../../tools/external/go.mod gencodec -type HeaderSerializable -field-override headerMarshaling -out gen_header_serializable_json.go
