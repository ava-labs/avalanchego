...
require (
	...
	github.com/ava-labs/avalanchego v1.15.0-fuji-rc.2
	github.com/ava-labs/avalanchego/graft/evm v1.15.0-fuji-rc.2
...
require (
	...
	github.com/ava-labs/avalanchego/graft/coreth v1.15.0-fuji-rc.2 // indirect
