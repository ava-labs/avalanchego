...
require (
	...
	github.com/ava-labs/avalanchego v1.15.0-rc.0
	github.com/ava-labs/avalanchego/graft/evm v1.15.0-rc.0
...
require (
	...
	github.com/ava-labs/avalanchego/graft/coreth v1.15.0-rc.0 // indirect
