...
require (
	...
	github.com/ava-labs/avalanchego v1.15.0-fuji-rc.5
	github.com/ava-labs/avalanchego/graft/evm v1.15.0-fuji-rc.5
...
require (
	...
	github.com/ava-labs/avalanchego/graft/coreth v1.15.0-fuji-rc.5 // indirect
