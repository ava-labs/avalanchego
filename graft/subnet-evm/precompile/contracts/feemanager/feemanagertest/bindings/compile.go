...
//go:generate sh -c "solc -o ../.. --overwrite --abi --base-path ../../../../.. --pretty-json ../../IFeeManager.sol"
// Step 2: Compile test contracts to generate ABI and bin files
//go:generate solc -o artifacts --overwrite --abi --bin --base-path ../../../../.. --metadata-hash none FeeManagerTest.sol
...
//go:generate sh -c "sed -i.bak -e 's|github.com/ava-labs/libevm/accounts/abi/bind|github.com/ava-labs/avalanchego/graft/subnet-evm/accounts/abi/bind|g' gen_ifeemanager_binding.go gen_feemanagertest_binding.go && rm -f gen_ifeemanager_binding.go.bak gen_feemanagertest_binding.go.bak"
