...
// Config specifies when the ACP-224 fee manager precompile is activated (via
// Upgrade), who may call it (via AllowListConfig), and an optional initial fee
// config to write to contract storage on activation.
type Config struct {
