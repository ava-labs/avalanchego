...
//go:generate go run github.com/MetalBlockchain/libevm/cmd/abigen --pkg bindings --type WarpTest --abi artifacts/WarpTest.abi --bin artifacts/WarpTest.bin --out gen_warptest_binding.go
...
//go:generate sh -c "sed -i.bak -e 's|github.com/MetalBlockchain/libevm/accounts/abi/bind|github.com/MetalBlockchain/metalgo/graft/subnet-evm/accounts/abi/bind|g' gen_warptest_binding.go && rm -f gen_warptest_binding.go.bak"
