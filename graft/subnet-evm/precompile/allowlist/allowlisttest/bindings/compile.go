...
//go:generate sh -c "solc -o ../.. --overwrite --abi --pretty-json ../../IAllowList.sol"
// Step 2: Compile test contracts to generate ABI and bin files
//go:generate solc -o artifacts --overwrite --abi --bin --base-path . --metadata-hash none precompile/=../../../ AllowListTest.sol
...
//go:generate sh -c "sed -i.bak -e 's|github.com/ava-labs/libevm/accounts/abi/bind|github.com/ava-labs/avalanchego/graft/subnet-evm/accounts/abi/bind|g' gen_allowlist_binding.go gen_allowlisttest_binding.go && rm -f gen_allowlist_binding.go.bak gen_allowlisttest_binding.go.bak"
