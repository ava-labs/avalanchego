...
import (
	...
	handlers2 "github.com/ava-labs/avalanchego/graft/evm/sync/handlers"
...
type TestClient struct {
	codec          codec.Manager
	leafsHandler   handlers2.LeafRequestHandler
	leavesReceived int32
	codesHandler   *handlers2.CodeRequestHandler
	codeReceived   int32
	blocksHandler  *handlers2.BlockRequestHandler
...
func NewTestClient(
	codec codec.Manager,
	leafHandler handlers2.LeafRequestHandler,
	codesHandler *handlers2.CodeRequestHandler,
	blocksHandler *handlers2.BlockRequestHandler,
) *TestClient {
	return &TestClient{
...
// TestBlockParser is a simple block parser for testing.
type TestBlockParser struct{}

// NewTestBlockParser creates a new TestBlockParser.
