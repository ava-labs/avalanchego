...
type network struct {
	...
	timeUntilDeadline          metrics.Timer                      // tracks time until deadline for incoming requests
	droppedRequests            metrics.Counter                    // tracks requests dropped due to expired deadline
