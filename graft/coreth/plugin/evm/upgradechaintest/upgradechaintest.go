...
// transition.
//
// The fixture is generated by TestFixtureUpToDate: a full coreth VM starts
// with no upgrades scheduled, activates each at a distinct timestamp, and
// accepts at least one block per era exercising an observable change of that
// era. The generator then dumps every accepted block and the VM's entire
// database.
//
