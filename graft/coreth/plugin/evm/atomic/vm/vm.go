...
import (
	...
	"github.com/MetalBlockchain/metalgo/graft/coreth/plugin/evm/atomic/txpool"
	...
	"github.com/MetalBlockchain/metalgo/graft/coreth/plugin/evm/upgrade/ap5"
	...
	"github.com/MetalBlockchain/metalgo/graft/evm/utils/rpc"
	...
	atomicstate "github.com/MetalBlockchain/metalgo/graft/coreth/plugin/evm/atomic/state"
	atomicsync "github.com/MetalBlockchain/metalgo/graft/coreth/plugin/evm/atomic/sync"
...
func (vm *VM) Initialize(
	...
	// Set the chain config for mainnet/tahoe chain IDs
