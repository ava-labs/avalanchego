...
func VerifyMinDelayExcess(
	...
	remoteDelayExcess := (*acp226.DelayExcess)(customtypes.GetHeaderExtra(header).MinDelayExcess)
...
func minDelayExcess(
	...
	if config.IsGranite(parent.Time) {
		...
		parentMinDelayExcess := (*acp226.DelayExcess)(customtypes.GetHeaderExtra(parent).MinDelayExcess)
