...
import (
	...
	_ "github.com/MetalBlockchain/metalgo/graft/coreth/precompile/registry"
	...
	"github.com/MetalBlockchain/metalgo/database/merkle/firewood/syncer"
	"github.com/MetalBlockchain/metalgo/database/versiondb"
	"github.com/MetalBlockchain/metalgo/graft/coreth/consensus/dummy"
	"github.com/MetalBlockchain/metalgo/graft/coreth/core"
	"github.com/MetalBlockchain/metalgo/graft/coreth/core/txpool"
	"github.com/MetalBlockchain/metalgo/graft/coreth/eth"
	"github.com/MetalBlockchain/metalgo/graft/coreth/eth/ethconfig"
	"github.com/MetalBlockchain/metalgo/graft/coreth/miner"
	"github.com/MetalBlockchain/metalgo/graft/coreth/network"
	"github.com/MetalBlockchain/metalgo/graft/coreth/node"
	"github.com/MetalBlockchain/metalgo/graft/coreth/params"
	"github.com/MetalBlockchain/metalgo/graft/coreth/params/extras"
	"github.com/MetalBlockchain/metalgo/graft/coreth/plugin/evm/config"
	"github.com/MetalBlockchain/metalgo/graft/coreth/plugin/evm/extension"
	"github.com/MetalBlockchain/metalgo/graft/coreth/plugin/evm/vmerrors"
	"github.com/MetalBlockchain/metalgo/graft/coreth/precompile/precompileconfig"
	"github.com/MetalBlockchain/metalgo/graft/coreth/warp"
	"github.com/MetalBlockchain/metalgo/graft/evm/constants"
	"github.com/MetalBlockchain/metalgo/graft/evm/firewood"
	"github.com/MetalBlockchain/metalgo/graft/evm/message"
	"github.com/MetalBlockchain/metalgo/graft/evm/rpc"
	"github.com/MetalBlockchain/metalgo/graft/evm/sync/client"
	"github.com/MetalBlockchain/metalgo/graft/evm/sync/client/stats"
	"github.com/MetalBlockchain/metalgo/graft/evm/sync/engine"
	...
	"github.com/MetalBlockchain/metalgo/vms/evm/acp226"
	"github.com/MetalBlockchain/metalgo/vms/evm/sync/customrawdb"

	corethlog "github.com/MetalBlockchain/metalgo/graft/coreth/plugin/evm/log"
	warpcontract "github.com/MetalBlockchain/metalgo/graft/coreth/precompile/contracts/warp"
	handlerstats "github.com/MetalBlockchain/metalgo/graft/evm/sync/handlers/stats"
	utilsrpc "github.com/MetalBlockchain/metalgo/graft/evm/utils/rpc"
