...
// with the registry.
import (
	_ "github.com/MetalBlockchain/metalgo/graft/coreth/precompile/contracts/warp"
	// ADD PRECOMPILES BELOW
	// _ "github.com/MetalBlockchain/metalgo/graft/coreth/precompile/contracts/newprecompile"
)
