...
// the given function to perform log.Record formatting.
...
// TerminalFormat formats log log.Records optimized for human readability on
...
// LogfmtFormat prints log.Records in logfmt format, an easy machine-parseable but human-readable
...
// JSONFormat formats log log.Records as JSON objects separated by newlines.
// It is the equivalent of JSONFormatEx(false, true).
func JSONFormat() Format {
	return JSONFormatEx(false, true)
}

// JSONFormatOrderedEx formats log log.Records as JSON arrays. If pretty is true,
// log.Records will be pretty-printed. If lineSeparated is true, log.Records
// will be logged with a new line between each log.Record.
...
// JSONFormatEx formats log log.Records as JSON objects. If pretty is true,
// log.Records will be pretty-printed. If lineSeparated is true, log.Records
// will be logged with a new line between each log.Record.
