...
func (x *EventRequest) GetStart() bool {
	if x, ok := x.GetEvent().(*EventRequest_Start); ok {
		return x.Start
	}
	return false
}

func (x *EventRequest) GetStop() bool {
	if x, ok := x.GetEvent().(*EventRequest_Stop); ok {
		return x.Stop
	}
	return false
}

func (x *EventRequest) GetPChainHeight() uint64 {
	if x != nil {
...
type EventRequest_Start struct {
	Start bool `protobuf:"varint,1,opt,name=start,proto3,oneof"`
}

type EventRequest_Stop struct {
	Stop bool `protobuf:"varint,2,opt,name=stop,proto3,oneof"`
}

func (*EventRequest_Start) isEventRequest_Event() {}

func (*EventRequest_Stop) isEventRequest_Event() {}
...
var file_messenger_messenger_proto_rawDesc = []byte{
	...
	,
	...
	0x4e, 0x49, 0x53, 0x48, 0x45, 0x44, 0x10, 0x02, 0x32, 0x44, 0x0a, 0x09, 0x4d, 0x65, 0x73, 0x73,
	0x65, 0x6e, 0x67, 0x65, 0x72, 0x12, 0x37, 0x0a, 0x06, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12,
	0x10, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x65, 0x6e, 0x67, 0x65, 0x72, 0x2e, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x1a, 0x17, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x65, 0x6e, 0x67, 0x65, 0x72, 0x2e, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x28, 0x01, 0x30, 0x01, 0x42, 0x34,
	...
	0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x62, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x65,
...
var file_messenger_messenger_proto_goTypes = []any{
	...
	(*EventRequest)(nil), // 1: messenger.EventRequest
	(*Event)(nil),        // 2: messenger.Event
}
var file_messenger_messenger_proto_depIdxs = []int32{
	0, // 0: messenger.Event.message:type_name -> messenger.Message
	2, // 1: messenger.Messenger.Notify:input_type -> messenger.Event
	1, // 2: messenger.Messenger.Notify:output_type -> messenger.EventRequest
...
func file_messenger_messenger_proto_init() {
	...
	file_messenger_messenger_proto_msgTypes[0].OneofWrappers = []any{
		(*EventRequest_Start)(nil),
		(*EventRequest_Stop)(nil),
	}
	type x struct{}
