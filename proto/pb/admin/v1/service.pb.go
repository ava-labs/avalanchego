...
type LoadVMsReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NewVms        map[string]*VMAliases  `protobuf:"bytes,1,rep,name=new_vms,json=newVms,proto3" json:"new_vms,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	FailedVms     map[string]string      `protobuf:"bytes,2,rep,name=failed_vms,json=failedVms,proto3" json:"failed_vms,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
