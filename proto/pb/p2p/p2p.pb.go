...
func (x *Message) GetAppRequestFailed() *AppRequestFailed {
	if x, ok := x.GetMessage().(*Message_AppRequestFailed); ok {
		return x.AppRequestFailed
	}
	return nil
}
...
type Message_AppRequestFailed struct {
	AppRequestFailed *AppRequestFailed `protobuf:"bytes,34,opt,name=app_request_failed,json=appRequestFailed,proto3,oneof"`
}
...
func (*Message_AppRequestFailed) isMessage_Message() {}
...
func (x *AppRequestFailed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AppRequestFailed) ProtoMessage() {}

func (x *AppRequestFailed) ProtoReflect() protoreflect.Message {
	mi := &file_p2p_p2p_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AppRequestFailed.ProtoReflect.Descriptor instead.
func (*AppRequestFailed) Descriptor() ([]byte, []int) {
	return file_p2p_p2p_proto_rawDescGZIP(), []int{26}
}

func (x *AppRequestFailed) GetChainId() []byte {
	if x != nil {
		return x.ChainId
	}
	return nil
...
func (x *AppRequestFailed) GetRequestId() uint32 {
	if x != nil {
		return x.RequestId
	}
	return 0
...
func (x *AppRequestFailed) GetErrorCode() uint32 {
	if x != nil {
		return x.ErrorCode
	}
	return 0
...
func (x *AppRequestFailed) GetErrorMessage() string {
	if x != nil {
...
var file_p2p_p2p_proto_rawDesc = []byte{
	...
	0x03, 0x70, 0x32, 0x70, 0x22, 0xa5, 0x0b, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	,
	...
	0x0c, 0x52, 0x08, 0x61, 0x70, 0x70, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0x90, 0x01, 0x0a, 0x10,
	...
	0x72, 0x6f, 0x72, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09,
...
var file_p2p_p2p_proto_goTypes = []interface{}{
	...
	(*AppRequestFailed)(nil),        // 27: p2p.AppRequestFailed
...
var file_p2p_p2p_proto_depIdxs = []int32{
	...
	27, // 23: p2p.Message.app_request_failed:type_name -> p2p.AppRequestFailed
	3,  // 24: p2p.Ping.subnet_uptimes:type_name -> p2p.SubnetUptime
	3,  // 25: p2p.Pong.subnet_uptimes:type_name -> p2p.SubnetUptime
	6,  // 26: p2p.PeerList.claimed_ip_ports:type_name -> p2p.ClaimedIpPort
	8,  // 27: p2p.PeerListAck.peer_acks:type_name -> p2p.PeerAck
