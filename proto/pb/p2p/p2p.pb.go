...
func (x *Message) GetSimplexMessage() *SimplexMessage {
	if x, ok := x.GetMessage().(*Message_SimplexMessage); ok {
		return x.SimplexMessage
	}
	return nil
}
...
type Message_SimplexMessage struct {
	// Simplex messages:
	SimplexMessage *SimplexMessage `protobuf:"bytes,36,opt,name=simplex_message,json=simplexMessage,proto3,oneof"`
}
...
func (*Message_SimplexMessage) isMessage_Message() {}
...
func (x *SimplexMessage) GetChainId() []byte {
	if x != nil {
		return x.ChainId
	}
	return nil
...
func (m *SimplexMessage) GetMessage() isSimplexMessage_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *SimplexMessage) GetBlock() *Block {
	if x, ok := x.GetMessage().(*SimplexMessage_Block); ok {
		return x.Block
	}
	return nil
}

func (x *SimplexMessage) GetVote() *Vote {
	if x, ok := x.GetMessage().(*SimplexMessage_Vote); ok {
		return x.Vote
	}
	return nil
}

func (x *SimplexMessage) GetEmptyVote() *EmptyVote {
	if x, ok := x.GetMessage().(*SimplexMessage_EmptyVote); ok {
		return x.EmptyVote
	}
	return nil
}
...
func (x *SimplexMessage) GetFinalization() *Finalization {
	if x, ok := x.GetMessage().(*SimplexMessage_Finalization); ok {
...
func (x *SimplexMessage) GetNotarization() *Notarization {
	if x, ok := x.GetMessage().(*SimplexMessage_Notarization); ok {
...
func (x *SimplexMessage) GetEmptyNotarization() *EmptyNotarization {
	if x, ok := x.GetMessage().(*SimplexMessage_EmptyNotarization); ok {
		return x.EmptyNotarization
	}
	return nil
}

func (x *SimplexMessage) GetFinalizationCertificate() *FinalizationCertificate {
	if x, ok := x.GetMessage().(*SimplexMessage_FinalizationCertificate); ok {
		return x.FinalizationCertificate
	}
	return nil
}

func (x *SimplexMessage) GetReplicationResponse() *ReplicationResponse {
	if x, ok := x.GetMessage().(*SimplexMessage_ReplicationResponse); ok {
...
func (x *SimplexMessage) GetReplicationRequest() *ReplicationRequest {
	if x, ok := x.GetMessage().(*SimplexMessage_ReplicationRequest); ok {
		return x.ReplicationRequest
	}
	return nil
}

type isSimplexMessage_Message interface {
	isSimplexMessage_Message()
}

type SimplexMessage_Block struct {
	Block *Block `protobuf:"bytes,2,opt,name=block,proto3,oneof"`
}

type SimplexMessage_Vote struct {
	Vote *Vote `protobuf:"bytes,3,opt,name=vote,proto3,oneof"`
}

type SimplexMessage_EmptyVote struct {
...
type SimplexMessage_Finalization struct {
	Finalization *Finalization `protobuf:"bytes,5,opt,name=finalization,proto3,oneof"`
}

type SimplexMessage_Notarization struct {
	Notarization *Notarization `protobuf:"bytes,6,opt,name=notarization,proto3,oneof"`
}
...
type SimplexMessage_FinalizationCertificate struct {
	FinalizationCertificate *FinalizationCertificate `protobuf:"bytes,8,opt,name=finalization_certificate,json=finalizationCertificate,proto3,oneof"`
}
...
type SimplexMessage_ReplicationRequest struct {
	ReplicationRequest *ReplicationRequest `protobuf:"bytes,10,opt,name=replication_request,json=replicationRequest,proto3,oneof"`
}

func (*SimplexMessage_Block) isSimplexMessage_Message() {}

func (*SimplexMessage_Vote) isSimplexMessage_Message() {}

func (*SimplexMessage_EmptyVote) isSimplexMessage_Message() {}

func (*SimplexMessage_Finalization) isSimplexMessage_Message() {}

func (*SimplexMessage_Notarization) isSimplexMessage_Message() {}

func (*SimplexMessage_EmptyNotarization) isSimplexMessage_Message() {}

func (*SimplexMessage_FinalizationCertificate) isSimplexMessage_Message() {}

func (*SimplexMessage_ReplicationResponse) isSimplexMessage_Message() {}

func (*SimplexMessage_ReplicationRequest) isSimplexMessage_Message() {}
...
func (x *Vote) GetVote() *BlockHeader {
	if x != nil {
		return x.Vote
	}
	return nil
...
type EmptyVote struct {
	...
	Vote      *ProtocolMetadata `protobuf:"bytes,1,opt,name=vote,proto3" json:"vote,omitempty"`
	Signature *Signature        `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"`
}
...
func (x *Finalization) GetVote() *BlockHeader {
	if x != nil {
		return x.Vote
	}
	return nil
...
func (x *Finalization) GetSignature() *Signature {
	if x != nil {
		return x.Signature
	}
	return nil
...
type FinalizationCertificate struct {
	...
	Finalization      *Finalization `protobuf:"bytes,1,opt,name=finalization,proto3" json:"finalization,omitempty"`
...
func (x *FinalizationCertificate) Reset() {
	*x = FinalizationCertificate{}
	mi := &file_p2p_p2p_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FinalizationCertificate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FinalizationCertificate) ProtoMessage() {}

func (x *FinalizationCertificate) ProtoReflect() protoreflect.Message {
	mi := &file_p2p_p2p_proto_msgTypes[36]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FinalizationCertificate.ProtoReflect.Descriptor instead.
func (*FinalizationCertificate) Descriptor() ([]byte, []int) {
	return file_p2p_p2p_proto_rawDescGZIP(), []int{36}
}

func (x *FinalizationCertificate) GetFinalization() *Finalization {
	if x != nil {
		return x.Finalization
	}
	return nil
...
func (x *FinalizationCertificate) GetQuorumCertificate() []byte {
	if x != nil {
...
func (x *Notarization) GetVote() *BlockHeader {
	if x != nil {
		return x.Vote
	}
	return nil
...
func (x *Notarization) GetQuorumCertificate() []byte {
	if x != nil {
		return x.QuorumCertificate
	}
	return nil
...
type EmptyNotarization struct {
	...
	EmptyVote         *BlockHeader `protobuf:"bytes,1,opt,name=empty_vote,json=emptyVote,proto3" json:"empty_vote,omitempty"`
	QuorumCertificate []byte       `protobuf:"bytes,2,opt,name=quorum_certificate,json=quorumCertificate,proto3" json:"quorum_certificate,omitempty"`
}
...
func (x *EmptyNotarization) GetEmptyVote() *BlockHeader {
	if x != nil {
		return x.EmptyVote
	}
	return nil
...
type ReplicationRequest struct {
	...
	Seqs        []uint64 `protobuf:"varint,1,rep,packed,name=seqs,proto3" json:"seqs,omitempty"`                           // array of seqs being requested
	LatestRound uint64   `protobuf:"varint,2,opt,name=latest_round,json=latestRound,proto3" json:"latest_round,omitempty"` // latest round, our node has
}
...
type ReplicationResponse struct {
	...
	LatestRound *QuorumRound   `protobuf:"bytes,2,opt,name=latest_round,json=latestRound,proto3" json:"latest_round,omitempty"`
}
...
type QuorumRound struct {
	...
	Notarization      *Notarization            `protobuf:"bytes,2,opt,name=notarization,proto3" json:"notarization,omitempty"`
	...
	Finalization      *FinalizationCertificate `protobuf:"bytes,4,opt,name=finalization,proto3" json:"finalization,omitempty"`
}

func (x *QuorumRound) Reset() {
	*x = QuorumRound{}
	mi := &file_p2p_p2p_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*QuorumRound) Descriptor() ([]byte, []int) {
	return file_p2p_p2p_proto_rawDescGZIP(), []int{41}
}

func (x *QuorumRound) GetBlock() *Block {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *QuorumRound) GetFinalization() *FinalizationCertificate {
	if x != nil {
		return x.Finalization
	}
	return nil
...
var file_p2p_p2p_proto_rawDesc = []byte{
	...
	0x03, 0x70, 0x32, 0x70, 0x22, 0xb3, 0x0b, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	,
	...
	0x52, 0x04, 0x74, 0x78, 0x49, 0x64, 0x22, 0x61, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x50, 0x65, 0x65,
	0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x31, 0x0a, 0x0b, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x5f, 0x70,
	0x65, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x32, 0x70,
	0x2e, 0x42, 0x6c, 0x6f, 0x6f, 0x6d, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x0a, 0x6b, 0x6e,
	0x6f, 0x77, 0x6e, 0x50, 0x65, 0x65, 0x72, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x6c, 0x6c, 0x5f,
	0x73, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x61,
	0x6c, 0x6c, 0x53, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x73, 0x22, 0x48, 0x0a, 0x08, 0x50, 0x65, 0x65,
	...
	0x22, 0x89, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64,
	...
	0x6e, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x73, 0x18, 0x04, 0x20,
	0x03, 0x28, 0x04, 0x52, 0x07, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x73, 0x22, 0x71, 0x0a, 0x14,
	...
	0x0a, 0x0b, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x0c, 0x52, 0x0a, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x49, 0x64, 0x73, 0x22,
	0x71, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x46, 0x72,
	...
	,
	...
	0x52, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x73, 0x4a, 0x04,
	0x08, 0x05, 0x10, 0x06, 0x22, 0x69, 0x0a, 0x08, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64,
	...
	0x0a, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0x65, 0x0a, 0x09, 0x41,
	...
	0x72, 0x73, 0x22, 0x84, 0x01, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x63, 0x68,
	...
	,
	...
	0x65, 0x69, 0x67, 0x68, 0x74, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0xb5, 0x01, 0x0a, 0x09,
	0x50, 0x75, 0x6c, 0x6c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x19, 0x0a, 0x08, 0x63, 0x68, 0x61,
	...
	0x05, 0x10, 0x06, 0x22, 0xe3, 0x01, 0x0a, 0x05, 0x43, 0x68, 0x69, 0x74, 0x73, 0x12, 0x19, 0x0a,
	...
	,
	...
	0x74, 0x65, 0x64, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x7f, 0x0a, 0x0a, 0x41, 0x70, 0x70,
	...
	0x22, 0xdd, 0x04, 0x0a, 0x0e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x78, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x22,
	0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e,
	0x70, 0x32, 0x70, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x00, 0x52, 0x05, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x12, 0x1f, 0x0a, 0x04, 0x76, 0x6f, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	0x22, 0x3c, 0x0a, 0x05, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x14, 0x0a, 0x05, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12,
	0x1d, 0x0a, 0x04, 0x76, 0x6f, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e,
	0x70, 0x32, 0x70, 0x2e, 0x56, 0x6f, 0x74, 0x65, 0x52, 0x04, 0x76, 0x6f, 0x74, 0x65, 0x22, 0x7e,
	...
	0x04, 0x52, 0x05, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x65, 0x71, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x73, 0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x72,
	0x65, 0x76, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x70, 0x72, 0x65, 0x76, 0x22, 0x58,
	0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x31, 0x0a,
	...
	,
	...
	,
	...
	0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x22, 0x63, 0x0a, 0x0c, 0x4e, 0x6f,
	0x74, 0x61, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x24, 0x0a, 0x04, 0x76, 0x6f,
	0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x32, 0x70, 0x2e, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x52, 0x04, 0x76, 0x6f, 0x74, 0x65,
	...
	,
...
var file_p2p_p2p_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_p2p_p2p_proto_goTypes = []any{
	...
	(*SimplexMessage)(nil),          // 29: p2p.SimplexMessage
	(*Block)(nil),                   // 30: p2p.Block
	...
	(*Finalization)(nil),            // 36: p2p.Finalization
	(*FinalizationCertificate)(nil), // 37: p2p.FinalizationCertificate
	(*Notarization)(nil),            // 38: p2p.Notarization
	(*EmptyNotarization)(nil),       // 39: p2p.EmptyNotarization
	(*ReplicationRequest)(nil),      // 40: p2p.ReplicationRequest
	(*ReplicationResponse)(nil),     // 41: p2p.ReplicationResponse
	(*QuorumRound)(nil),             // 42: p2p.QuorumRound
}
var file_p2p_p2p_proto_depIdxs = []int32{
	...
	29, // 24: p2p.Message.simplex_message:type_name -> p2p.SimplexMessage
	...
	30, // 30: p2p.SimplexMessage.block:type_name -> p2p.Block
	34, // 31: p2p.SimplexMessage.vote:type_name -> p2p.Vote
	35, // 32: p2p.SimplexMessage.empty_vote:type_name -> p2p.EmptyVote
	36, // 33: p2p.SimplexMessage.finalization:type_name -> p2p.Finalization
	38, // 34: p2p.SimplexMessage.notarization:type_name -> p2p.Notarization
	39, // 35: p2p.SimplexMessage.empty_notarization:type_name -> p2p.EmptyNotarization
	37, // 36: p2p.SimplexMessage.finalization_certificate:type_name -> p2p.FinalizationCertificate
	41, // 37: p2p.SimplexMessage.replication_response:type_name -> p2p.ReplicationResponse
	40, // 38: p2p.SimplexMessage.replication_request:type_name -> p2p.ReplicationRequest
	34, // 39: p2p.Block.vote:type_name -> p2p.Vote
	31, // 40: p2p.BlockHeader.metadata:type_name -> p2p.ProtocolMetadata
	32, // 41: p2p.Vote.vote:type_name -> p2p.BlockHeader
	33, // 42: p2p.Vote.signature:type_name -> p2p.Signature
	31, // 43: p2p.EmptyVote.vote:type_name -> p2p.ProtocolMetadata
	33, // 44: p2p.EmptyVote.signature:type_name -> p2p.Signature
	32, // 45: p2p.Finalization.vote:type_name -> p2p.BlockHeader
	33, // 46: p2p.Finalization.signature:type_name -> p2p.Signature
	36, // 47: p2p.FinalizationCertificate.finalization:type_name -> p2p.Finalization
	32, // 48: p2p.Notarization.vote:type_name -> p2p.BlockHeader
	32, // 49: p2p.EmptyNotarization.empty_vote:type_name -> p2p.BlockHeader
	42, // 50: p2p.ReplicationResponse.data:type_name -> p2p.QuorumRound
	42, // 51: p2p.ReplicationResponse.latest_round:type_name -> p2p.QuorumRound
	30, // 52: p2p.QuorumRound.block:type_name -> p2p.Block
	38, // 53: p2p.QuorumRound.notarization:type_name -> p2p.Notarization
	39, // 54: p2p.QuorumRound.empty_notarization:type_name -> p2p.EmptyNotarization
	37, // 55: p2p.QuorumRound.finalization:type_name -> p2p.FinalizationCertificate
