...
var file_sync_sync_proto_rawDesc = []byte{
	...
	0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0xcb, 0x01, 0x0a, 0x18, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79,
	0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x32, 0x87, 0x04, 0x0a, 0x0a, 0x53, 0x79, 0x6e, 0x63, 0x61, 0x62, 0x6c, 0x65, 0x44, 0x42, 0x12,
	...
	0x12, 0x40, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x72, 0x6f,
	...
	0x6f, 0x66, 0x12, 0x54, 0x0a, 0x11, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x43, 0x68, 0x61, 0x6e,
	...
	0x65, 0x72, 0x69, 0x66, 0x79, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4b, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x6d,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x48, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x52, 0x61, 0x6e, 0x67,
	...
	0x67, 0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x49, 0x0a, 0x10, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x72,
	...
	0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x62, 0x2f, 0x73, 0x79, 0x6e, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_sync_sync_proto_depIdxs = []int32{
	...
	20, // 5: sync.SyncGetChangeProofRequest.start_key:type_name -> sync.MaybeBytes
	20, // 6: sync.SyncGetChangeProofRequest.end_key:type_name -> sync.MaybeBytes
	15, // 7: sync.SyncGetChangeProofResponse.change_proof:type_name -> sync.ChangeProof
	16, // 8: sync.SyncGetChangeProofResponse.range_proof:type_name -> sync.RangeProof
	20, // 9: sync.GetChangeProofRequest.start_key:type_name -> sync.MaybeBytes
	20, // 10: sync.GetChangeProofRequest.end_key:type_name -> sync.MaybeBytes
	15, // 11: sync.VerifyChangeProofRequest.proof:type_name -> sync.ChangeProof
	20, // 12: sync.VerifyChangeProofRequest.start_key:type_name -> sync.MaybeBytes
	20, // 13: sync.VerifyChangeProofRequest.end_key:type_name -> sync.MaybeBytes
	15, // 14: sync.CommitChangeProofRequest.proof:type_name -> sync.ChangeProof
	20, // 15: sync.SyncGetRangeProofRequest.start_key:type_name -> sync.MaybeBytes
	20, // 16: sync.SyncGetRangeProofRequest.end_key:type_name -> sync.MaybeBytes
	20, // 17: sync.GetRangeProofRequest.start_key:type_name -> sync.MaybeBytes
	20, // 18: sync.GetRangeProofRequest.end_key:type_name -> sync.MaybeBytes
	16, // 19: sync.GetRangeProofResponse.proof:type_name -> sync.RangeProof
	16, // 20: sync.CommitRangeProofRequest.range_proof:type_name -> sync.RangeProof
	17, // 21: sync.ChangeProof.start_proof:type_name -> sync.ProofNode
	17, // 22: sync.ChangeProof.end_proof:type_name -> sync.ProofNode
	18, // 23: sync.ChangeProof.key_changes:type_name -> sync.KeyChange
	17, // 24: sync.RangeProof.start:type_name -> sync.ProofNode
	17, // 25: sync.RangeProof.end:type_name -> sync.ProofNode
	21, // 26: sync.RangeProof.key_values:type_name -> sync.KeyValue
	19, // 27: sync.ProofNode.key:type_name -> sync.SerializedPath
	20, // 28: sync.ProofNode.value_or_hash:type_name -> sync.MaybeBytes
	22, // 29: sync.ProofNode.children:type_name -> sync.ProofNode.ChildrenEntry
	20, // 30: sync.KeyChange.value:type_name -> sync.MaybeBytes
	23, // 31: sync.SyncableDB.GetMerkleRoot:input_type -> google.protobuf.Empty
	2,  // 32: sync.SyncableDB.GetProof:input_type -> sync.GetProofRequest
	7,  // 33: sync.SyncableDB.GetChangeProof:input_type -> sync.GetChangeProofRequest
	8,  // 34: sync.SyncableDB.VerifyChangeProof:input_type -> sync.VerifyChangeProofRequest
	10, // 35: sync.SyncableDB.CommitChangeProof:input_type -> sync.CommitChangeProofRequest
	12, // 36: sync.SyncableDB.GetRangeProof:input_type -> sync.GetRangeProofRequest
	14, // 37: sync.SyncableDB.CommitRangeProof:input_type -> sync.CommitRangeProofRequest
	1,  // 38: sync.SyncableDB.GetMerkleRoot:output_type -> sync.GetMerkleRootResponse
	3,  // 39: sync.SyncableDB.GetProof:output_type -> sync.GetProofResponse
	15, // 40: sync.SyncableDB.GetChangeProof:output_type -> sync.ChangeProof
	9,  // 41: sync.SyncableDB.VerifyChangeProof:output_type -> sync.VerifyChangeProofResponse
	23, // 42: sync.SyncableDB.CommitChangeProof:output_type -> google.protobuf.Empty
	13, // 43: sync.SyncableDB.GetRangeProof:output_type -> sync.GetRangeProofResponse
	23, // 44: sync.SyncableDB.CommitRangeProof:output_type -> google.protobuf.Empty
