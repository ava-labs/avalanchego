...
var file_sync_sync_proto_rawDesc = []byte{
	...
	0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x73,
	0x79, 0x6e, 0x63, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x52,
	0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0xbd, 0x01, 0x0a, 0x18, 0x53, 0x79, 0x6e, 0x63, 0x47,
	...
	0x01, 0x28, 0x0c, 0x52, 0x08, 0x73, 0x74, 0x61, 0x72, 0x74, 0x4b, 0x65, 0x79, 0x12, 0x29, 0x0a,
	...
	0x73, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x98, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x52, 0x61,
...
var file_sync_sync_proto_depIdxs = []int32{
	...
	21, // 16: sync.SyncGetRangeProofRequest.end_key:type_name -> sync.MaybeBytes
	21, // 17: sync.GetRangeProofRequest.end_key:type_name -> sync.MaybeBytes
	17, // 18: sync.GetRangeProofResponse.proof:type_name -> sync.RangeProof
	17, // 19: sync.CommitRangeProofRequest.range_proof:type_name -> sync.RangeProof
	18, // 20: sync.ChangeProof.start_proof:type_name -> sync.ProofNode
	18, // 21: sync.ChangeProof.end_proof:type_name -> sync.ProofNode
	19, // 22: sync.ChangeProof.key_changes:type_name -> sync.KeyChange
	18, // 23: sync.RangeProof.start:type_name -> sync.ProofNode
	18, // 24: sync.RangeProof.end:type_name -> sync.ProofNode
	22, // 25: sync.RangeProof.key_values:type_name -> sync.KeyValue
	20, // 26: sync.ProofNode.key:type_name -> sync.SerializedPath
	21, // 27: sync.ProofNode.value_or_hash:type_name -> sync.MaybeBytes
	23, // 28: sync.ProofNode.children:type_name -> sync.ProofNode.ChildrenEntry
	21, // 29: sync.KeyChange.value:type_name -> sync.MaybeBytes
	24, // 30: sync.DB.GetMerkleRoot:input_type -> google.protobuf.Empty
	2,  // 31: sync.DB.GetProof:input_type -> sync.GetProofRequest
	7,  // 32: sync.DB.GetChangeProof:input_type -> sync.GetChangeProofRequest
	9,  // 33: sync.DB.VerifyChangeProof:input_type -> sync.VerifyChangeProofRequest
	11, // 34: sync.DB.CommitChangeProof:input_type -> sync.CommitChangeProofRequest
	13, // 35: sync.DB.GetRangeProof:input_type -> sync.GetRangeProofRequest
	15, // 36: sync.DB.CommitRangeProof:input_type -> sync.CommitRangeProofRequest
	1,  // 37: sync.DB.GetMerkleRoot:output_type -> sync.GetMerkleRootResponse
	3,  // 38: sync.DB.GetProof:output_type -> sync.GetProofResponse
	8,  // 39: sync.DB.GetChangeProof:output_type -> sync.GetChangeProofResponse
	10, // 40: sync.DB.VerifyChangeProof:output_type -> sync.VerifyChangeProofResponse
	24, // 41: sync.DB.CommitChangeProof:output_type -> google.protobuf.Empty
	14, // 42: sync.DB.GetRangeProof:output_type -> sync.GetRangeProofResponse
	24, // 43: sync.DB.CommitRangeProof:output_type -> google.protobuf.Empty
