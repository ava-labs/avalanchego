...
type SyncGetChangeProofResponse struct {
	...
	ChangeProof *ChangeProof `protobuf:"bytes,1,opt,name=change_proof,json=changeProof,proto3" json:"change_proof,omitempty"`
}
...
var file_sync_sync_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x22, 0x52, 0x0a, 0x1a, 0x53, 0x79, 0x6e, 0x63, 0x47, 0x65, 0x74, 0x43, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x34, 0x0a, 0x0c, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x70, 0x72, 0x6f, 0x6f, 0x66,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x73, 0x79, 0x6e, 0x63, 0x2e, 0x43, 0x68,
	0x61, 0x6e, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x52, 0x0b, 0x63, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0xda, 0x01, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x43, 0x68,
	...
	0x0b, 0x65, 0x6e, 0x64, 0x52, 0x6f, 0x6f, 0x74, 0x48, 0x61, 0x73, 0x68, 0x12, 0x2d, 0x0a, 0x09,
	0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x6e, 0x64, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x73,
	...
	0x6d, 0x69, 0x74, 0x22, 0x88, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67,
	...
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x22, 0xd6, 0x01, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x6f, 0x66,
	0x4e, 0x6f, 0x64, 0x65, 0x12, 0x1b, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x09, 0x2e, 0x73, 0x79, 0x6e, 0x63, 0x2e, 0x4b, 0x65, 0x79, 0x52, 0x03, 0x6b, 0x65,
	...
	0x73, 0x79, 0x6e, 0x63, 0x2e, 0x4d, 0x61, 0x79, 0x62, 0x65, 0x42, 0x79, 0x74, 0x65, 0x73, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x33, 0x0a, 0x03, 0x4b, 0x65, 0x79, 0x12, 0x16, 0x0a,
	...
	0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x73, 0x4e, 0x6f, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x22, 0x32,
	...
	0x75, 0x65, 0x32, 0xae, 0x03, 0x0a, 0x02, 0x44, 0x42, 0x12, 0x44, 0x0a, 0x0d, 0x47, 0x65, 0x74,
	...
	0x37, 0x0a, 0x05, 0x43, 0x6c, 0x65, 0x61, 0x72, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
...
var file_sync_sync_proto_goTypes = []interface{}{
	...
	(*ChangeProof)(nil),                // 11: sync.ChangeProof
...
var file_sync_sync_proto_depIdxs = []int32{
	...
	15, // 1: sync.Proof.value:type_name -> sync.MaybeBytes
	12, // 2: sync.Proof.proof:type_name -> sync.ProofNode
	15, // 3: sync.SyncGetChangeProofRequest.start_key:type_name -> sync.MaybeBytes
	15, // 4: sync.SyncGetChangeProofRequest.end_key:type_name -> sync.MaybeBytes
	11, // 5: sync.SyncGetChangeProofResponse.change_proof:type_name -> sync.ChangeProof
	15, // 6: sync.GetChangeProofRequest.start_key:type_name -> sync.MaybeBytes
	15, // 7: sync.GetChangeProofRequest.end_key:type_name -> sync.MaybeBytes
	11, // 8: sync.GetChangeProofResponse.change_proof:type_name -> sync.ChangeProof
	11, // 9: sync.VerifyChangeProofRequest.proof:type_name -> sync.ChangeProof
	15, // 10: sync.VerifyChangeProofRequest.start_key:type_name -> sync.MaybeBytes
	15, // 11: sync.VerifyChangeProofRequest.end_key:type_name -> sync.MaybeBytes
	11, // 12: sync.CommitChangeProofRequest.proof:type_name -> sync.ChangeProof
	12, // 13: sync.ChangeProof.start_proof:type_name -> sync.ProofNode
	12, // 14: sync.ChangeProof.end_proof:type_name -> sync.ProofNode
	13, // 15: sync.ChangeProof.key_changes:type_name -> sync.KeyChange
	14, // 16: sync.ProofNode.key:type_name -> sync.Key
	15, // 17: sync.ProofNode.value_or_hash:type_name -> sync.MaybeBytes
	17, // 18: sync.ProofNode.children:type_name -> sync.ProofNode.ChildrenEntry
	15, // 19: sync.KeyChange.value:type_name -> sync.MaybeBytes
	18, // 20: sync.DB.GetMerkleRoot:input_type -> google.protobuf.Empty
	18, // 21: sync.DB.Clear:input_type -> google.protobuf.Empty
	1,  // 22: sync.DB.GetProof:input_type -> sync.GetProofRequest
	6,  // 23: sync.DB.GetChangeProof:input_type -> sync.GetChangeProofRequest
	...
	0,  // 26: sync.DB.GetMerkleRoot:output_type -> sync.GetMerkleRootResponse
	18, // 27: sync.DB.Clear:output_type -> google.protobuf.Empty
	2,  // 28: sync.DB.GetProof:output_type -> sync.GetProofResponse
	7,  // 29: sync.DB.GetChangeProof:output_type -> sync.GetChangeProofResponse
	9,  // 30: sync.DB.VerifyChangeProof:output_type -> sync.VerifyChangeProofResponse
	18, // 31: sync.DB.CommitChangeProof:output_type -> google.protobuf.Empty
