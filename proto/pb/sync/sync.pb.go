...
func (x *VerifyChangeProofRequest) GetMaxLength() int32 {
	if x != nil {
		return x.MaxLength
	}
	return 0
...
func (x *VerifyRangeProofRequest) GetMaxLength() int32 {
	if x != nil {
		return x.MaxLength
	}
	return 0
...
const file_sync_sync_proto_rawDesc = "" +
	...
	"\x12expected_root_hash\x18\x04 \x01(\fR\x10expectedRootHash\x12\x1d\n" +
	"\n" +
	"max_length\x18\x05 \x01(\x05R\tmaxLength\"1\n" +
	...
	"\bnext_key\x18\x01 \x01(\v2\x10.sync.MaybeBytesR\anextKey\"\xcf\x01\n" +
	...
	"\x05proof\x18\x01 \x01(\v2\x10.sync.RangeProofR\x05proof\"\xe8\x01\n" +
	...
	"\x12expected_root_hash\x18\x04 \x01(\fR\x10expectedRootHash\x12\x1d\n" +
	"\n" +
	"max_length\x18\x05 \x01(\x05R\tmaxLength\"0\n" +
	...
	"\x05value\x18\x02 \x01(\fR\x05value2\xa7\x05\n" +
	"\x02DB\x12D\n" +
...
var file_sync_sync_proto_goTypes = []any{
	...
	(*VerifyRangeProofRequest)(nil),    // 15: sync.VerifyRangeProofRequest
	(*VerifyRangeProofResponse)(nil),   // 16: sync.VerifyRangeProofResponse
...
var file_sync_sync_proto_depIdxs = []int32{
	...
	24, // 5: sync.GetChangeProofRequest.start_key:type_name -> sync.MaybeBytes
	24, // 6: sync.GetChangeProofRequest.end_key:type_name -> sync.MaybeBytes
	19, // 7: sync.GetChangeProofResponse.change_proof:type_name -> sync.ChangeProof
	19, // 8: sync.VerifyChangeProofRequest.proof:type_name -> sync.ChangeProof
	24, // 9: sync.VerifyChangeProofRequest.start_key:type_name -> sync.MaybeBytes
	24, // 10: sync.VerifyChangeProofRequest.end_key:type_name -> sync.MaybeBytes
	19, // 11: sync.CommitChangeProofRequest.proof:type_name -> sync.ChangeProof
	24, // 12: sync.CommitChangeProofRequest.end_key:type_name -> sync.MaybeBytes
	24, // 13: sync.CommitChangeProofResponse.next_key:type_name -> sync.MaybeBytes
	24, // 14: sync.SyncGetRangeProofRequest.start_key:type_name -> sync.MaybeBytes
	24, // 15: sync.SyncGetRangeProofRequest.end_key:type_name -> sync.MaybeBytes
	24, // 16: sync.GetRangeProofRequest.start_key:type_name -> sync.MaybeBytes
	24, // 17: sync.GetRangeProofRequest.end_key:type_name -> sync.MaybeBytes
	20, // 18: sync.GetRangeProofResponse.proof:type_name -> sync.RangeProof
	20, // 19: sync.VerifyRangeProofRequest.proof:type_name -> sync.RangeProof
	24, // 20: sync.VerifyRangeProofRequest.start_key:type_name -> sync.MaybeBytes
	24, // 21: sync.VerifyRangeProofRequest.end_key:type_name -> sync.MaybeBytes
	24, // 22: sync.CommitRangeProofRequest.start_key:type_name -> sync.MaybeBytes
	24, // 23: sync.CommitRangeProofRequest.end_key:type_name -> sync.MaybeBytes
	20, // 24: sync.CommitRangeProofRequest.range_proof:type_name -> sync.RangeProof
	24, // 25: sync.CommitRangeProofResponse.next_key:type_name -> sync.MaybeBytes
	21, // 26: sync.ChangeProof.start_proof:type_name -> sync.ProofNode
	21, // 27: sync.ChangeProof.end_proof:type_name -> sync.ProofNode
	22, // 28: sync.ChangeProof.key_changes:type_name -> sync.KeyChange
	21, // 29: sync.RangeProof.start_proof:type_name -> sync.ProofNode
	21, // 30: sync.RangeProof.end_proof:type_name -> sync.ProofNode
	25, // 31: sync.RangeProof.key_values:type_name -> sync.KeyValue
	23, // 32: sync.ProofNode.key:type_name -> sync.Key
	24, // 33: sync.ProofNode.value_or_hash:type_name -> sync.MaybeBytes
	26, // 34: sync.ProofNode.children:type_name -> sync.ProofNode.ChildrenEntry
	24, // 35: sync.KeyChange.value:type_name -> sync.MaybeBytes
	27, // 36: sync.DB.GetMerkleRoot:input_type -> google.protobuf.Empty
	27, // 37: sync.DB.Clear:input_type -> google.protobuf.Empty
	1,  // 38: sync.DB.GetProof:input_type -> sync.GetProofRequest
	6,  // 39: sync.DB.GetChangeProof:input_type -> sync.GetChangeProofRequest
	8,  // 40: sync.DB.VerifyChangeProof:input_type -> sync.VerifyChangeProofRequest
	10, // 41: sync.DB.CommitChangeProof:input_type -> sync.CommitChangeProofRequest
	13, // 42: sync.DB.GetRangeProof:input_type -> sync.GetRangeProofRequest
	15, // 43: sync.DB.VerifyRangeProof:input_type -> sync.VerifyRangeProofRequest
	17, // 44: sync.DB.CommitRangeProof:input_type -> sync.CommitRangeProofRequest
	0,  // 45: sync.DB.GetMerkleRoot:output_type -> sync.GetMerkleRootResponse
	27, // 46: sync.DB.Clear:output_type -> google.protobuf.Empty
	2,  // 47: sync.DB.GetProof:output_type -> sync.GetProofResponse
	...
	14, // 51: sync.DB.GetRangeProof:output_type -> sync.GetRangeProofResponse
	16, // 52: sync.DB.VerifyRangeProof:output_type -> sync.VerifyRangeProofResponse
