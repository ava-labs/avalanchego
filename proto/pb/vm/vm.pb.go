...
var file_vm_vm_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0xc2, 0x0c, 0x0a, 0x02, 0x56, 0x4d, 0x12, 0x3b, 0x0a, 0x0a, 0x49, 0x6e, 0x69, 0x74,
...
var file_vm_vm_proto_goTypes = []interface{}{
	...
	(*_go.MetricFamily)(nil),             // 36: io.prometheus.client.MetricFamily
	(*emptypb.Empty)(nil),                // 37: google.protobuf.Empty
}
var file_vm_vm_proto_depIdxs = []int32{
	3,  // 0: vm.InitializeRequest.db_servers:type_name -> vm.VersionedDBServer
	35, // 1: vm.InitializeResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	35, // 4: vm.BuildBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	35, // 5: vm.ParseBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	35, // 6: vm.GetBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	35, // 7: vm.BlockVerifyResponse.timestamp:type_name -> google.protobuf.Timestamp
	34, // 8: vm.HealthRequest.grpc_checks:type_name -> vm.HealthRequest.GrpcChecksEntry
	35, // 9: vm.AppRequestMsg.deadline:type_name -> google.protobuf.Timestamp
	9,  // 10: vm.BatchedParseBlockResponse.response:type_name -> vm.ParseBlockResponse
	36, // 11: vm.GatherResponse.metric_families:type_name -> io.prometheus.client.MetricFamily
	0,  // 12: vm.VM.Initialize:input_type -> vm.InitializeRequest
	1,  // 13: vm.VM.SetState:input_type -> vm.SetStateRequest
	37, // 14: vm.VM.Shutdown:input_type -> google.protobuf.Empty
	37, // 15: vm.VM.CreateHandlers:input_type -> google.protobuf.Empty
	37, // 16: vm.VM.CreateStaticHandlers:input_type -> google.protobuf.Empty
	24, // 17: vm.VM.Connected:input_type -> vm.ConnectedRequest
	25, // 18: vm.VM.Disconnected:input_type -> vm.DisconnectedRequest
	37, // 19: vm.VM.BuildBlock:input_type -> google.protobuf.Empty
	...
	37, // 24: vm.VM.Version:input_type -> google.protobuf.Empty
	...
	37, // 29: vm.VM.Gather:input_type -> google.protobuf.Empty
	13, // 30: vm.VM.BlockVerify:input_type -> vm.BlockVerifyRequest
	15, // 31: vm.VM.BlockAccept:input_type -> vm.BlockAcceptRequest
	16, // 32: vm.VM.BlockReject:input_type -> vm.BlockRejectRequest
	26, // 33: vm.VM.GetAncestors:input_type -> vm.GetAncestorsRequest
	28, // 34: vm.VM.BatchedParseBlock:input_type -> vm.BatchedParseBlockRequest
	37, // 35: vm.VM.VerifyHeightIndex:input_type -> google.protobuf.Empty
	31, // 36: vm.VM.GetBlockIDAtHeight:input_type -> vm.GetBlockIDAtHeightRequest
	2,  // 37: vm.VM.Initialize:output_type -> vm.InitializeResponse
	37, // 38: vm.VM.SetState:output_type -> google.protobuf.Empty
	37, // 39: vm.VM.Shutdown:output_type -> google.protobuf.Empty
	4,  // 40: vm.VM.CreateHandlers:output_type -> vm.CreateHandlersResponse
	5,  // 41: vm.VM.CreateStaticHandlers:output_type -> vm.CreateStaticHandlersResponse
	37, // 42: vm.VM.Connected:output_type -> google.protobuf.Empty
	37, // 43: vm.VM.Disconnected:output_type -> google.protobuf.Empty
	7,  // 44: vm.VM.BuildBlock:output_type -> vm.BuildBlockResponse
	9,  // 45: vm.VM.ParseBlock:output_type -> vm.ParseBlockResponse
	11, // 46: vm.VM.GetBlock:output_type -> vm.GetBlockResponse
	37, // 47: vm.VM.SetPreference:output_type -> google.protobuf.Empty
	18, // 48: vm.VM.Health:output_type -> vm.HealthResponse
	19, // 49: vm.VM.Version:output_type -> vm.VersionResponse
	37, // 50: vm.VM.AppRequest:output_type -> google.protobuf.Empty
	37, // 51: vm.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	37, // 52: vm.VM.AppResponse:output_type -> google.protobuf.Empty
	37, // 53: vm.VM.AppGossip:output_type -> google.protobuf.Empty
	33, // 54: vm.VM.Gather:output_type -> vm.GatherResponse
	14, // 55: vm.VM.BlockVerify:output_type -> vm.BlockVerifyResponse
	37, // 56: vm.VM.BlockAccept:output_type -> google.protobuf.Empty
	37, // 57: vm.VM.BlockReject:output_type -> google.protobuf.Empty
	27, // 58: vm.VM.GetAncestors:output_type -> vm.GetAncestorsResponse
	29, // 59: vm.VM.BatchedParseBlock:output_type -> vm.BatchedParseBlockResponse
	30, // 60: vm.VM.VerifyHeightIndex:output_type -> vm.VerifyHeightIndexResponse
	32, // 61: vm.VM.GetBlockIDAtHeight:output_type -> vm.GetBlockIDAtHeightResponse
