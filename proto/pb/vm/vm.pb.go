...
type BlockVerifyProposerRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BlockVerifyProposerRequest) Reset() {
	*x = BlockVerifyProposerRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *BlockVerifyProposerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlockVerifyProposerRequest) ProtoMessage() {}

func (x *BlockVerifyProposerRequest) ProtoReflect() protoreflect.Message {
	mi := &file_vm_vm_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlockVerifyProposerRequest.ProtoReflect.Descriptor instead.
func (*BlockVerifyProposerRequest) Descriptor() ([]byte, []int) {
	return file_vm_vm_proto_rawDescGZIP(), []int{14}
}

func (x *BlockVerifyProposerRequest) GetBytes() []byte {
	if x != nil {
		return x.Bytes
	}
	return nil
...
var file_vm_vm_proto_rawDesc = []byte{
	...
	0x0a, 0x1a, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x50, 0x72, 0x6f,
	0x70, 0x6f, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05,
	0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x62, 0x79, 0x74,
	0x65, 0x73, 0x22, 0x68, 0x0a, 0x12, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x56, 0x65, 0x72, 0x69, 0x66,
	...
	0x4e, 0x54, 0x45, 0x44, 0x10, 0x04, 0x32, 0xf3, 0x12, 0x0a, 0x02, 0x56, 0x4d, 0x12, 0x3b, 0x0a,
	...
	0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4d, 0x0a, 0x13, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65,
	0x72, 0x12, 0x1e, 0x2e, 0x76, 0x6d, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x56, 0x65, 0x72, 0x69,
	0x66, 0x79, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x3e, 0x0a, 0x0b, 0x42, 0x6c, 0x6f,
...
var file_vm_vm_proto_goTypes = []interface{}{
	...
	(*BlockVerifyProposerRequest)(nil),         // 18: vm.BlockVerifyProposerRequest
...
var file_vm_vm_proto_depIdxs = []int32{
	...
	53, // 36: vm.VM.Health:input_type -> google.protobuf.Empty
	53, // 37: vm.VM.Version:input_type -> google.protobuf.Empty
	25, // 38: vm.VM.AppRequest:input_type -> vm.AppRequestMsg
	26, // 39: vm.VM.AppRequestFailed:input_type -> vm.AppRequestFailedMsg
	27, // 40: vm.VM.AppResponse:input_type -> vm.AppResponseMsg
	28, // 41: vm.VM.AppGossip:input_type -> vm.AppGossipMsg
	53, // 42: vm.VM.Gather:input_type -> google.protobuf.Empty
	29, // 43: vm.VM.CrossChainAppRequest:input_type -> vm.CrossChainAppRequestMsg
	30, // 44: vm.VM.CrossChainAppRequestFailed:input_type -> vm.CrossChainAppRequestFailedMsg
	31, // 45: vm.VM.CrossChainAppResponse:input_type -> vm.CrossChainAppResponseMsg
	34, // 46: vm.VM.GetAncestors:input_type -> vm.GetAncestorsRequest
	36, // 47: vm.VM.BatchedParseBlock:input_type -> vm.BatchedParseBlockRequest
	53, // 48: vm.VM.VerifyHeightIndex:input_type -> google.protobuf.Empty
	39, // 49: vm.VM.GetBlockIDAtHeight:input_type -> vm.GetBlockIDAtHeightRequest
	53, // 50: vm.VM.StateSyncEnabled:input_type -> google.protobuf.Empty
	53, // 51: vm.VM.GetOngoingSyncStateSummary:input_type -> google.protobuf.Empty
	53, // 52: vm.VM.GetLastStateSummary:input_type -> google.protobuf.Empty
	45, // 53: vm.VM.ParseStateSummary:input_type -> vm.ParseStateSummaryRequest
	47, // 54: vm.VM.GetStateSummary:input_type -> vm.GetStateSummaryRequest
	18, // 55: vm.VM.BlockVerifyProposer:input_type -> vm.BlockVerifyProposerRequest
	...
	53, // 90: vm.VM.BlockVerifyProposer:output_type -> google.protobuf.Empty
...
func file_vm_vm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vm_vm_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BlockVerifyProposerRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
