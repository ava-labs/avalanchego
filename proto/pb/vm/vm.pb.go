...
const (
	...
	StateSummaryAcceptResponse_MODE_NOT_RUNNING  StateSummaryAcceptResponse_Mode = 1
	StateSummaryAcceptResponse_MODE_BLOCKING     StateSummaryAcceptResponse_Mode = 2
	StateSummaryAcceptResponse_MODE_NON_BLOCKING StateSummaryAcceptResponse_Mode = 3
)
...
var file_vm_vm_proto_rawDesc = []byte{
	...
	,
	...
	0x64, 0x6c, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x50, 0x0a,
	...
	0x76, 0x6d, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x48,
...
var file_vm_vm_proto_goTypes = []interface{}{
	(StateSummaryAcceptResponse_Mode)(0),       // 0: vm.StateSummaryAcceptResponse.Mode
	(*InitializeRequest)(nil),                  // 1: vm.InitializeRequest
	(*InitializeResponse)(nil),                 // 2: vm.InitializeResponse
	(*VersionedDBServer)(nil),                  // 3: vm.VersionedDBServer
	(*SetStateRequest)(nil),                    // 4: vm.SetStateRequest
	(*SetStateResponse)(nil),                   // 5: vm.SetStateResponse
	(*CreateHandlersResponse)(nil),             // 6: vm.CreateHandlersResponse
	(*CreateStaticHandlersResponse)(nil),       // 7: vm.CreateStaticHandlersResponse
	(*Handler)(nil),                            // 8: vm.Handler
	(*BuildBlockRequest)(nil),                  // 9: vm.BuildBlockRequest
	(*BuildBlockResponse)(nil),                 // 10: vm.BuildBlockResponse
	(*ParseBlockRequest)(nil),                  // 11: vm.ParseBlockRequest
	(*ParseBlockResponse)(nil),                 // 12: vm.ParseBlockResponse
	(*GetBlockRequest)(nil),                    // 13: vm.GetBlockRequest
	(*GetBlockResponse)(nil),                   // 14: vm.GetBlockResponse
	(*SetPreferenceRequest)(nil),               // 15: vm.SetPreferenceRequest
	(*BlockVerifyRequest)(nil),                 // 16: vm.BlockVerifyRequest
	(*BlockVerifyResponse)(nil),                // 17: vm.BlockVerifyResponse
	(*BlockAcceptRequest)(nil),                 // 18: vm.BlockAcceptRequest
	(*BlockRejectRequest)(nil),                 // 19: vm.BlockRejectRequest
	(*HealthResponse)(nil),                     // 20: vm.HealthResponse
	(*VersionResponse)(nil),                    // 21: vm.VersionResponse
	(*AppRequestMsg)(nil),                      // 22: vm.AppRequestMsg
	(*AppRequestFailedMsg)(nil),                // 23: vm.AppRequestFailedMsg
	(*AppResponseMsg)(nil),                     // 24: vm.AppResponseMsg
	(*AppGossipMsg)(nil),                       // 25: vm.AppGossipMsg
	(*CrossChainAppRequestMsg)(nil),            // 26: vm.CrossChainAppRequestMsg
	(*CrossChainAppRequestFailedMsg)(nil),      // 27: vm.CrossChainAppRequestFailedMsg
	(*CrossChainAppResponseMsg)(nil),           // 28: vm.CrossChainAppResponseMsg
	(*ConnectedRequest)(nil),                   // 29: vm.ConnectedRequest
	(*DisconnectedRequest)(nil),                // 30: vm.DisconnectedRequest
	(*GetAncestorsRequest)(nil),                // 31: vm.GetAncestorsRequest
	(*GetAncestorsResponse)(nil),               // 32: vm.GetAncestorsResponse
	(*BatchedParseBlockRequest)(nil),           // 33: vm.BatchedParseBlockRequest
	(*BatchedParseBlockResponse)(nil),          // 34: vm.BatchedParseBlockResponse
	(*VerifyHeightIndexResponse)(nil),          // 35: vm.VerifyHeightIndexResponse
...
var file_vm_vm_proto_depIdxs = []int32{
	...
	48, // 1: vm.InitializeResponse.timestamp:type_name -> google.protobuf.Timestamp
	48, // 2: vm.SetStateResponse.timestamp:type_name -> google.protobuf.Timestamp
	8,  // 3: vm.CreateHandlersResponse.handlers:type_name -> vm.Handler
	8,  // 4: vm.CreateStaticHandlersResponse.handlers:type_name -> vm.Handler
	48, // 5: vm.BuildBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	48, // 6: vm.ParseBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	48, // 7: vm.GetBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	48, // 8: vm.BlockVerifyResponse.timestamp:type_name -> google.protobuf.Timestamp
	48, // 9: vm.AppRequestMsg.deadline:type_name -> google.protobuf.Timestamp
	48, // 10: vm.CrossChainAppRequestMsg.deadline:type_name -> google.protobuf.Timestamp
	12, // 11: vm.BatchedParseBlockResponse.response:type_name -> vm.ParseBlockResponse
	49, // 12: vm.GatherResponse.metric_families:type_name -> io.prometheus.client.MetricFamily
	0,  // 13: vm.StateSummaryAcceptResponse.mode:type_name -> vm.StateSummaryAcceptResponse.Mode
	1,  // 14: vm.VM.Initialize:input_type -> vm.InitializeRequest
	4,  // 15: vm.VM.SetState:input_type -> vm.SetStateRequest
	50, // 16: vm.VM.Shutdown:input_type -> google.protobuf.Empty
	50, // 17: vm.VM.CreateHandlers:input_type -> google.protobuf.Empty
	50, // 18: vm.VM.CreateStaticHandlers:input_type -> google.protobuf.Empty
	29, // 19: vm.VM.Connected:input_type -> vm.ConnectedRequest
	30, // 20: vm.VM.Disconnected:input_type -> vm.DisconnectedRequest
	9,  // 21: vm.VM.BuildBlock:input_type -> vm.BuildBlockRequest
	11, // 22: vm.VM.ParseBlock:input_type -> vm.ParseBlockRequest
	13, // 23: vm.VM.GetBlock:input_type -> vm.GetBlockRequest
	15, // 24: vm.VM.SetPreference:input_type -> vm.SetPreferenceRequest
	50, // 25: vm.VM.Health:input_type -> google.protobuf.Empty
	50, // 26: vm.VM.Version:input_type -> google.protobuf.Empty
	22, // 27: vm.VM.AppRequest:input_type -> vm.AppRequestMsg
	23, // 28: vm.VM.AppRequestFailed:input_type -> vm.AppRequestFailedMsg
	24, // 29: vm.VM.AppResponse:input_type -> vm.AppResponseMsg
	25, // 30: vm.VM.AppGossip:input_type -> vm.AppGossipMsg
	50, // 31: vm.VM.Gather:input_type -> google.protobuf.Empty
	26, // 32: vm.VM.CrossChainAppRequest:input_type -> vm.CrossChainAppRequestMsg
	27, // 33: vm.VM.CrossChainAppRequestFailed:input_type -> vm.CrossChainAppRequestFailedMsg
	28, // 34: vm.VM.CrossChainAppResponse:input_type -> vm.CrossChainAppResponseMsg
	31, // 35: vm.VM.GetAncestors:input_type -> vm.GetAncestorsRequest
	33, // 36: vm.VM.BatchedParseBlock:input_type -> vm.BatchedParseBlockRequest
	50, // 37: vm.VM.VerifyHeightIndex:input_type -> google.protobuf.Empty
	36, // 38: vm.VM.GetBlockIDAtHeight:input_type -> vm.GetBlockIDAtHeightRequest
	50, // 39: vm.VM.StateSyncEnabled:input_type -> google.protobuf.Empty
	50, // 40: vm.VM.GetOngoingSyncStateSummary:input_type -> google.protobuf.Empty
	50, // 41: vm.VM.GetLastStateSummary:input_type -> google.protobuf.Empty
	42, // 42: vm.VM.ParseStateSummary:input_type -> vm.ParseStateSummaryRequest
	44, // 43: vm.VM.GetStateSummary:input_type -> vm.GetStateSummaryRequest
	16, // 44: vm.VM.BlockVerify:input_type -> vm.BlockVerifyRequest
	18, // 45: vm.VM.BlockAccept:input_type -> vm.BlockAcceptRequest
	19, // 46: vm.VM.BlockReject:input_type -> vm.BlockRejectRequest
	46, // 47: vm.VM.StateSummaryAccept:input_type -> vm.StateSummaryAcceptRequest
	2,  // 48: vm.VM.Initialize:output_type -> vm.InitializeResponse
	5,  // 49: vm.VM.SetState:output_type -> vm.SetStateResponse
	50, // 50: vm.VM.Shutdown:output_type -> google.protobuf.Empty
	6,  // 51: vm.VM.CreateHandlers:output_type -> vm.CreateHandlersResponse
	7,  // 52: vm.VM.CreateStaticHandlers:output_type -> vm.CreateStaticHandlersResponse
	50, // 53: vm.VM.Connected:output_type -> google.protobuf.Empty
	50, // 54: vm.VM.Disconnected:output_type -> google.protobuf.Empty
	10, // 55: vm.VM.BuildBlock:output_type -> vm.BuildBlockResponse
	12, // 56: vm.VM.ParseBlock:output_type -> vm.ParseBlockResponse
	14, // 57: vm.VM.GetBlock:output_type -> vm.GetBlockResponse
	50, // 58: vm.VM.SetPreference:output_type -> google.protobuf.Empty
	20, // 59: vm.VM.Health:output_type -> vm.HealthResponse
	21, // 60: vm.VM.Version:output_type -> vm.VersionResponse
	50, // 61: vm.VM.AppRequest:output_type -> google.protobuf.Empty
	50, // 62: vm.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	50, // 63: vm.VM.AppResponse:output_type -> google.protobuf.Empty
	50, // 64: vm.VM.AppGossip:output_type -> google.protobuf.Empty
	38, // 65: vm.VM.Gather:output_type -> vm.GatherResponse
	50, // 66: vm.VM.CrossChainAppRequest:output_type -> google.protobuf.Empty
	50, // 67: vm.VM.CrossChainAppRequestFailed:output_type -> google.protobuf.Empty
	50, // 68: vm.VM.CrossChainAppResponse:output_type -> google.protobuf.Empty
	32, // 69: vm.VM.GetAncestors:output_type -> vm.GetAncestorsResponse
	34, // 70: vm.VM.BatchedParseBlock:output_type -> vm.BatchedParseBlockResponse
	35, // 71: vm.VM.VerifyHeightIndex:output_type -> vm.VerifyHeightIndexResponse
	37, // 72: vm.VM.GetBlockIDAtHeight:output_type -> vm.GetBlockIDAtHeightResponse
	39, // 73: vm.VM.StateSyncEnabled:output_type -> vm.StateSyncEnabledResponse
	40, // 74: vm.VM.GetOngoingSyncStateSummary:output_type -> vm.GetOngoingSyncStateSummaryResponse
	41, // 75: vm.VM.GetLastStateSummary:output_type -> vm.GetLastStateSummaryResponse
	43, // 76: vm.VM.ParseStateSummary:output_type -> vm.ParseStateSummaryResponse
	45, // 77: vm.VM.GetStateSummary:output_type -> vm.GetStateSummaryResponse
	17, // 78: vm.VM.BlockVerify:output_type -> vm.BlockVerifyResponse
	50, // 79: vm.VM.BlockAccept:output_type -> google.protobuf.Empty
	50, // 80: vm.VM.BlockReject:output_type -> google.protobuf.Empty
	47, // 81: vm.VM.StateSummaryAccept:output_type -> vm.StateSummaryAcceptResponse
