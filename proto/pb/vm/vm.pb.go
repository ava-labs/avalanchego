...
var file_vm_vm_proto_rawDesc = []byte{
	...
	0x22, 0x5f, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x47, 0x52, 0x50, 0x43, 0x53, 0x65,
	...
	0x72, 0x22, 0x42, 0x0a, 0x07, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06,
	...
	0x45, 0x4e, 0x54, 0x45, 0x44, 0x10, 0x03, 0x32, 0xdd, 0x0f, 0x0a, 0x02, 0x56, 0x4d, 0x12, 0x3b,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4a, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x47, 0x52,
	0x50, 0x43, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74,
	0x79, 0x1a, 0x1d, 0x2e, 0x76, 0x6d, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x47, 0x52, 0x50,
	0x43, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x41, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x41, 0x6e, 0x63, 0x65, 0x73,
...
var file_vm_vm_proto_depIdxs = []int32{
	...
	46, // 13: vm.NetworkUpgrades.fortuna_time:type_name -> google.protobuf.Timestamp
	46, // 14: vm.NetworkUpgrades.granite_time:type_name -> google.protobuf.Timestamp
	46, // 15: vm.InitializeResponse.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 16: vm.SetStateRequest.state:type_name -> vm.State
	46, // 17: vm.SetStateResponse.timestamp:type_name -> google.protobuf.Timestamp
	10, // 18: vm.CreateHandlersResponse.handlers:type_name -> vm.Handler
	46, // 19: vm.BuildBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	46, // 20: vm.ParseBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	46, // 21: vm.GetBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	1,  // 22: vm.GetBlockResponse.err:type_name -> vm.Error
	46, // 23: vm.BlockVerifyResponse.timestamp:type_name -> google.protobuf.Timestamp
	46, // 24: vm.AppRequestMsg.deadline:type_name -> google.protobuf.Timestamp
	14, // 25: vm.BatchedParseBlockResponse.response:type_name -> vm.ParseBlockResponse
	1,  // 26: vm.GetBlockIDAtHeightResponse.err:type_name -> vm.Error
	47, // 27: vm.GatherResponse.metric_families:type_name -> io.prometheus.client.MetricFamily
	1,  // 28: vm.StateSyncEnabledResponse.err:type_name -> vm.Error
	1,  // 29: vm.GetOngoingSyncStateSummaryResponse.err:type_name -> vm.Error
	1,  // 30: vm.GetLastStateSummaryResponse.err:type_name -> vm.Error
	1,  // 31: vm.ParseStateSummaryResponse.err:type_name -> vm.Error
	1,  // 32: vm.GetStateSummaryResponse.err:type_name -> vm.Error
	2,  // 33: vm.StateSummaryAcceptResponse.mode:type_name -> vm.StateSummaryAcceptResponse.Mode
	1,  // 34: vm.StateSummaryAcceptResponse.err:type_name -> vm.Error
	3,  // 35: vm.VM.Initialize:input_type -> vm.InitializeRequest
	6,  // 36: vm.VM.SetState:input_type -> vm.SetStateRequest
	48, // 37: vm.VM.Shutdown:input_type -> google.protobuf.Empty
	48, // 38: vm.VM.CreateHandlers:input_type -> google.protobuf.Empty
	48, // 39: vm.VM.CreateGRPCService:input_type -> google.protobuf.Empty
	28, // 40: vm.VM.Connected:input_type -> vm.ConnectedRequest
	29, // 41: vm.VM.Disconnected:input_type -> vm.DisconnectedRequest
	11, // 42: vm.VM.BuildBlock:input_type -> vm.BuildBlockRequest
	13, // 43: vm.VM.ParseBlock:input_type -> vm.ParseBlockRequest
	15, // 44: vm.VM.GetBlock:input_type -> vm.GetBlockRequest
	17, // 45: vm.VM.SetPreference:input_type -> vm.SetPreferenceRequest
	48, // 46: vm.VM.Health:input_type -> google.protobuf.Empty
	48, // 47: vm.VM.Version:input_type -> google.protobuf.Empty
	24, // 48: vm.VM.AppRequest:input_type -> vm.AppRequestMsg
	25, // 49: vm.VM.AppRequestFailed:input_type -> vm.AppRequestFailedMsg
	26, // 50: vm.VM.AppResponse:input_type -> vm.AppResponseMsg
	27, // 51: vm.VM.AppGossip:input_type -> vm.AppGossipMsg
	48, // 52: vm.VM.Gather:input_type -> google.protobuf.Empty
	30, // 53: vm.VM.GetAncestors:input_type -> vm.GetAncestorsRequest
	32, // 54: vm.VM.BatchedParseBlock:input_type -> vm.BatchedParseBlockRequest
	34, // 55: vm.VM.GetBlockIDAtHeight:input_type -> vm.GetBlockIDAtHeightRequest
	48, // 56: vm.VM.StateSyncEnabled:input_type -> google.protobuf.Empty
	...
	40, // 59: vm.VM.ParseStateSummary:input_type -> vm.ParseStateSummaryRequest
	42, // 60: vm.VM.GetStateSummary:input_type -> vm.GetStateSummaryRequest
	18, // 61: vm.VM.BlockVerify:input_type -> vm.BlockVerifyRequest
	20, // 62: vm.VM.BlockAccept:input_type -> vm.BlockAcceptRequest
	21, // 63: vm.VM.BlockReject:input_type -> vm.BlockRejectRequest
	44, // 64: vm.VM.StateSummaryAccept:input_type -> vm.StateSummaryAcceptRequest
	5,  // 65: vm.VM.Initialize:output_type -> vm.InitializeResponse
	7,  // 66: vm.VM.SetState:output_type -> vm.SetStateResponse
	48, // 67: vm.VM.Shutdown:output_type -> google.protobuf.Empty
	8,  // 68: vm.VM.CreateHandlers:output_type -> vm.CreateHandlersResponse
	9,  // 69: vm.VM.CreateGRPCService:output_type -> vm.CreateGRPCServiceResponse
	48, // 70: vm.VM.Connected:output_type -> google.protobuf.Empty
	48, // 71: vm.VM.Disconnected:output_type -> google.protobuf.Empty
	12, // 72: vm.VM.BuildBlock:output_type -> vm.BuildBlockResponse
	14, // 73: vm.VM.ParseBlock:output_type -> vm.ParseBlockResponse
	16, // 74: vm.VM.GetBlock:output_type -> vm.GetBlockResponse
	48, // 75: vm.VM.SetPreference:output_type -> google.protobuf.Empty
	22, // 76: vm.VM.Health:output_type -> vm.HealthResponse
	23, // 77: vm.VM.Version:output_type -> vm.VersionResponse
	48, // 78: vm.VM.AppRequest:output_type -> google.protobuf.Empty
	48, // 79: vm.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	48, // 80: vm.VM.AppResponse:output_type -> google.protobuf.Empty
	48, // 81: vm.VM.AppGossip:output_type -> google.protobuf.Empty
	36, // 82: vm.VM.Gather:output_type -> vm.GatherResponse
	31, // 83: vm.VM.GetAncestors:output_type -> vm.GetAncestorsResponse
	33, // 84: vm.VM.BatchedParseBlock:output_type -> vm.BatchedParseBlockResponse
	35, // 85: vm.VM.GetBlockIDAtHeight:output_type -> vm.GetBlockIDAtHeightResponse
	37, // 86: vm.VM.StateSyncEnabled:output_type -> vm.StateSyncEnabledResponse
	38, // 87: vm.VM.GetOngoingSyncStateSummary:output_type -> vm.GetOngoingSyncStateSummaryResponse
	39, // 88: vm.VM.GetLastStateSummary:output_type -> vm.GetLastStateSummaryResponse
	41, // 89: vm.VM.ParseStateSummary:output_type -> vm.ParseStateSummaryResponse
	43, // 90: vm.VM.GetStateSummary:output_type -> vm.GetStateSummaryResponse
	19, // 91: vm.VM.BlockVerify:output_type -> vm.BlockVerifyResponse
	48, // 92: vm.VM.BlockAccept:output_type -> google.protobuf.Empty
	48, // 93: vm.VM.BlockReject:output_type -> google.protobuf.Empty
	45, // 94: vm.VM.StateSummaryAccept:output_type -> vm.StateSummaryAcceptResponse
