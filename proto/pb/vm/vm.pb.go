...
var file_vm_vm_proto_rawDesc = []byte{
	...
	0x6d, 0x73, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x81,
	...
	0x49, 0x4d, 0x50, 0x4c, 0x45, 0x4d, 0x45, 0x4e, 0x54, 0x45, 0x44, 0x10, 0x03, 0x32, 0x91, 0x0f,
...
var file_vm_vm_proto_depIdxs = []int32{
	44, // 0: vm.InitializeResponse.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 1: vm.SetStateRequest.state:type_name -> vm.State
	44, // 2: vm.SetStateResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	44, // 8: vm.BlockVerifyResponse.timestamp:type_name -> google.protobuf.Timestamp
	44, // 9: vm.AppRequestMsg.deadline:type_name -> google.protobuf.Timestamp
	12, // 10: vm.BatchedParseBlockResponse.response:type_name -> vm.ParseBlockResponse
	1,  // 11: vm.GetBlockIDAtHeightResponse.err:type_name -> vm.Error
	45, // 12: vm.GatherResponse.metric_families:type_name -> io.prometheus.client.MetricFamily
	1,  // 13: vm.StateSyncEnabledResponse.err:type_name -> vm.Error
	1,  // 14: vm.GetOngoingSyncStateSummaryResponse.err:type_name -> vm.Error
	1,  // 15: vm.GetLastStateSummaryResponse.err:type_name -> vm.Error
	1,  // 16: vm.ParseStateSummaryResponse.err:type_name -> vm.Error
	1,  // 17: vm.GetStateSummaryResponse.err:type_name -> vm.Error
	2,  // 18: vm.StateSummaryAcceptResponse.mode:type_name -> vm.StateSummaryAcceptResponse.Mode
	1,  // 19: vm.StateSummaryAcceptResponse.err:type_name -> vm.Error
	3,  // 20: vm.VM.Initialize:input_type -> vm.InitializeRequest
	5,  // 21: vm.VM.SetState:input_type -> vm.SetStateRequest
	46, // 22: vm.VM.Shutdown:input_type -> google.protobuf.Empty
	46, // 23: vm.VM.CreateHandlers:input_type -> google.protobuf.Empty
	26, // 24: vm.VM.Connected:input_type -> vm.ConnectedRequest
	27, // 25: vm.VM.Disconnected:input_type -> vm.DisconnectedRequest
	9,  // 26: vm.VM.BuildBlock:input_type -> vm.BuildBlockRequest
	11, // 27: vm.VM.ParseBlock:input_type -> vm.ParseBlockRequest
	13, // 28: vm.VM.GetBlock:input_type -> vm.GetBlockRequest
	15, // 29: vm.VM.SetPreference:input_type -> vm.SetPreferenceRequest
	46, // 30: vm.VM.Health:input_type -> google.protobuf.Empty
	46, // 31: vm.VM.Version:input_type -> google.protobuf.Empty
	22, // 32: vm.VM.AppRequest:input_type -> vm.AppRequestMsg
	23, // 33: vm.VM.AppRequestFailed:input_type -> vm.AppRequestFailedMsg
	24, // 34: vm.VM.AppResponse:input_type -> vm.AppResponseMsg
	25, // 35: vm.VM.AppGossip:input_type -> vm.AppGossipMsg
	46, // 36: vm.VM.Gather:input_type -> google.protobuf.Empty
	28, // 37: vm.VM.GetAncestors:input_type -> vm.GetAncestorsRequest
	30, // 38: vm.VM.BatchedParseBlock:input_type -> vm.BatchedParseBlockRequest
	32, // 39: vm.VM.GetBlockIDAtHeight:input_type -> vm.GetBlockIDAtHeightRequest
	46, // 40: vm.VM.StateSyncEnabled:input_type -> google.protobuf.Empty
	...
	38, // 43: vm.VM.ParseStateSummary:input_type -> vm.ParseStateSummaryRequest
	40, // 44: vm.VM.GetStateSummary:input_type -> vm.GetStateSummaryRequest
	16, // 45: vm.VM.BlockVerify:input_type -> vm.BlockVerifyRequest
	18, // 46: vm.VM.BlockAccept:input_type -> vm.BlockAcceptRequest
	19, // 47: vm.VM.BlockReject:input_type -> vm.BlockRejectRequest
	42, // 48: vm.VM.StateSummaryAccept:input_type -> vm.StateSummaryAcceptRequest
	4,  // 49: vm.VM.Initialize:output_type -> vm.InitializeResponse
	6,  // 50: vm.VM.SetState:output_type -> vm.SetStateResponse
	46, // 51: vm.VM.Shutdown:output_type -> google.protobuf.Empty
	7,  // 52: vm.VM.CreateHandlers:output_type -> vm.CreateHandlersResponse
	46, // 53: vm.VM.Connected:output_type -> google.protobuf.Empty
	...
	46, // 58: vm.VM.SetPreference:output_type -> google.protobuf.Empty
	20, // 59: vm.VM.Health:output_type -> vm.HealthResponse
	21, // 60: vm.VM.Version:output_type -> vm.VersionResponse
	46, // 61: vm.VM.AppRequest:output_type -> google.protobuf.Empty
	46, // 62: vm.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	46, // 63: vm.VM.AppResponse:output_type -> google.protobuf.Empty
	46, // 64: vm.VM.AppGossip:output_type -> google.protobuf.Empty
	34, // 65: vm.VM.Gather:output_type -> vm.GatherResponse
	29, // 66: vm.VM.GetAncestors:output_type -> vm.GetAncestorsResponse
	31, // 67: vm.VM.BatchedParseBlock:output_type -> vm.BatchedParseBlockResponse
	33, // 68: vm.VM.GetBlockIDAtHeight:output_type -> vm.GetBlockIDAtHeightResponse
	35, // 69: vm.VM.StateSyncEnabled:output_type -> vm.StateSyncEnabledResponse
	36, // 70: vm.VM.GetOngoingSyncStateSummary:output_type -> vm.GetOngoingSyncStateSummaryResponse
	37, // 71: vm.VM.GetLastStateSummary:output_type -> vm.GetLastStateSummaryResponse
	39, // 72: vm.VM.ParseStateSummary:output_type -> vm.ParseStateSummaryResponse
	41, // 73: vm.VM.GetStateSummary:output_type -> vm.GetStateSummaryResponse
	17, // 74: vm.VM.BlockVerify:output_type -> vm.BlockVerifyResponse
	46, // 75: vm.VM.BlockAccept:output_type -> google.protobuf.Empty
	46, // 76: vm.VM.BlockReject:output_type -> google.protobuf.Empty
	43, // 77: vm.VM.StateSummaryAccept:output_type -> vm.StateSummaryAcceptResponse
