...
var file_vm_vm_proto_rawDesc = []byte{
	...
	0x16, 0x4e, 0x65, 0x77, 0x48, 0x54, 0x54, 0x50, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x52,
	...
	0x79, 0x12, 0x44, 0x0a, 0x0e, 0x4e, 0x65, 0x77, 0x48, 0x54, 0x54, 0x50, 0x48, 0x61, 0x6e, 0x64,
	0x6c, 0x65, 0x72, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x1a, 0x2e, 0x76, 0x6d,
	0x2e, 0x4e, 0x65, 0x77, 0x48, 0x54, 0x54, 0x50, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x52,
...
var file_vm_vm_proto_goTypes = []any{
	...
	(*ConnectedRequest)(nil),                   // 26: vm.ConnectedRequest
	(*DisconnectedRequest)(nil),                // 27: vm.DisconnectedRequest
	(*GetAncestorsRequest)(nil),                // 28: vm.GetAncestorsRequest
	(*GetAncestorsResponse)(nil),               // 29: vm.GetAncestorsResponse
	(*BatchedParseBlockRequest)(nil),           // 30: vm.BatchedParseBlockRequest
	(*BatchedParseBlockResponse)(nil),          // 31: vm.BatchedParseBlockResponse
...
var file_vm_vm_proto_depIdxs = []int32{
	...
	44, // 1: vm.NetworkUpgrades.apricot_phase_1_time:type_name -> google.protobuf.Timestamp
	44, // 2: vm.NetworkUpgrades.apricot_phase_2_time:type_name -> google.protobuf.Timestamp
	44, // 3: vm.NetworkUpgrades.apricot_phase_3_time:type_name -> google.protobuf.Timestamp
	44, // 4: vm.NetworkUpgrades.apricot_phase_4_time:type_name -> google.protobuf.Timestamp
	44, // 5: vm.NetworkUpgrades.apricot_phase_5_time:type_name -> google.protobuf.Timestamp
	44, // 6: vm.NetworkUpgrades.apricot_phase_pre_6_time:type_name -> google.protobuf.Timestamp
	44, // 7: vm.NetworkUpgrades.apricot_phase_6_time:type_name -> google.protobuf.Timestamp
	44, // 8: vm.NetworkUpgrades.apricot_phase_post_6_time:type_name -> google.protobuf.Timestamp
	44, // 9: vm.NetworkUpgrades.banff_time:type_name -> google.protobuf.Timestamp
	44, // 10: vm.NetworkUpgrades.cortina_time:type_name -> google.protobuf.Timestamp
	44, // 11: vm.NetworkUpgrades.durango_time:type_name -> google.protobuf.Timestamp
	44, // 12: vm.NetworkUpgrades.etna_time:type_name -> google.protobuf.Timestamp
	44, // 13: vm.NetworkUpgrades.fortuna_time:type_name -> google.protobuf.Timestamp
	44, // 14: vm.NetworkUpgrades.granite_time:type_name -> google.protobuf.Timestamp
	44, // 15: vm.InitializeResponse.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 16: vm.SetStateRequest.state:type_name -> vm.State
	44, // 17: vm.SetStateResponse.timestamp:type_name -> google.protobuf.Timestamp
	44, // 18: vm.BuildBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	44, // 19: vm.ParseBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	44, // 20: vm.GetBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	1,  // 21: vm.GetBlockResponse.err:type_name -> vm.Error
	44, // 22: vm.BlockVerifyResponse.timestamp:type_name -> google.protobuf.Timestamp
	44, // 23: vm.AppRequestMsg.deadline:type_name -> google.protobuf.Timestamp
	12, // 24: vm.BatchedParseBlockResponse.response:type_name -> vm.ParseBlockResponse
	1,  // 25: vm.GetBlockIDAtHeightResponse.err:type_name -> vm.Error
	45, // 26: vm.GatherResponse.metric_families:type_name -> io.prometheus.client.MetricFamily
	...
	46, // 36: vm.VM.Shutdown:input_type -> google.protobuf.Empty
	46, // 37: vm.VM.NewHTTPHandler:input_type -> google.protobuf.Empty
	26, // 38: vm.VM.Connected:input_type -> vm.ConnectedRequest
	27, // 39: vm.VM.Disconnected:input_type -> vm.DisconnectedRequest
	9,  // 40: vm.VM.BuildBlock:input_type -> vm.BuildBlockRequest
	11, // 41: vm.VM.ParseBlock:input_type -> vm.ParseBlockRequest
	13, // 42: vm.VM.GetBlock:input_type -> vm.GetBlockRequest
	15, // 43: vm.VM.SetPreference:input_type -> vm.SetPreferenceRequest
	46, // 44: vm.VM.Health:input_type -> google.protobuf.Empty
	46, // 45: vm.VM.Version:input_type -> google.protobuf.Empty
	22, // 46: vm.VM.AppRequest:input_type -> vm.AppRequestMsg
	23, // 47: vm.VM.AppRequestFailed:input_type -> vm.AppRequestFailedMsg
	24, // 48: vm.VM.AppResponse:input_type -> vm.AppResponseMsg
	25, // 49: vm.VM.AppGossip:input_type -> vm.AppGossipMsg
	46, // 50: vm.VM.Gather:input_type -> google.protobuf.Empty
	28, // 51: vm.VM.GetAncestors:input_type -> vm.GetAncestorsRequest
	30, // 52: vm.VM.BatchedParseBlock:input_type -> vm.BatchedParseBlockRequest
	32, // 53: vm.VM.GetBlockIDAtHeight:input_type -> vm.GetBlockIDAtHeightRequest
	46, // 54: vm.VM.StateSyncEnabled:input_type -> google.protobuf.Empty
	...
	38, // 57: vm.VM.ParseStateSummary:input_type -> vm.ParseStateSummaryRequest
	40, // 58: vm.VM.GetStateSummary:input_type -> vm.GetStateSummaryRequest
	16, // 59: vm.VM.BlockVerify:input_type -> vm.BlockVerifyRequest
	18, // 60: vm.VM.BlockAccept:input_type -> vm.BlockAcceptRequest
	19, // 61: vm.VM.BlockReject:input_type -> vm.BlockRejectRequest
	42, // 62: vm.VM.StateSummaryAccept:input_type -> vm.StateSummaryAcceptRequest
	5,  // 63: vm.VM.Initialize:output_type -> vm.InitializeResponse
	7,  // 64: vm.VM.SetState:output_type -> vm.SetStateResponse
	46, // 65: vm.VM.Shutdown:output_type -> google.protobuf.Empty
	...
	10, // 69: vm.VM.BuildBlock:output_type -> vm.BuildBlockResponse
	12, // 70: vm.VM.ParseBlock:output_type -> vm.ParseBlockResponse
	14, // 71: vm.VM.GetBlock:output_type -> vm.GetBlockResponse
	46, // 72: vm.VM.SetPreference:output_type -> google.protobuf.Empty
	20, // 73: vm.VM.Health:output_type -> vm.HealthResponse
	21, // 74: vm.VM.Version:output_type -> vm.VersionResponse
	46, // 75: vm.VM.AppRequest:output_type -> google.protobuf.Empty
	46, // 76: vm.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	46, // 77: vm.VM.AppResponse:output_type -> google.protobuf.Empty
	46, // 78: vm.VM.AppGossip:output_type -> google.protobuf.Empty
	34, // 79: vm.VM.Gather:output_type -> vm.GatherResponse
	29, // 80: vm.VM.GetAncestors:output_type -> vm.GetAncestorsResponse
	31, // 81: vm.VM.BatchedParseBlock:output_type -> vm.BatchedParseBlockResponse
	33, // 82: vm.VM.GetBlockIDAtHeight:output_type -> vm.GetBlockIDAtHeightResponse
	35, // 83: vm.VM.StateSyncEnabled:output_type -> vm.StateSyncEnabledResponse
	36, // 84: vm.VM.GetOngoingSyncStateSummary:output_type -> vm.GetOngoingSyncStateSummaryResponse
	37, // 85: vm.VM.GetLastStateSummary:output_type -> vm.GetLastStateSummaryResponse
	39, // 86: vm.VM.ParseStateSummary:output_type -> vm.ParseStateSummaryResponse
	41, // 87: vm.VM.GetStateSummary:output_type -> vm.GetStateSummaryResponse
	17, // 88: vm.VM.BlockVerify:output_type -> vm.BlockVerifyResponse
	46, // 89: vm.VM.BlockAccept:output_type -> google.protobuf.Empty
	46, // 90: vm.VM.BlockReject:output_type -> google.protobuf.Empty
	43, // 91: vm.VM.StateSummaryAccept:output_type -> vm.StateSummaryAcceptResponse
