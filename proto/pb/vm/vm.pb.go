...
func (StateSummaryAcceptResponse_Mode) EnumDescriptor() ([]byte, []int) {
	return file_vm_vm_proto_rawDescGZIP(), []int{40, 0}
}
...
var file_vm_vm_proto_rawDesc = []byte{
	...
	0x5f, 0x41, 0x43, 0x43, 0x45, 0x50, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x6b, 0x0a, 0x05, 0x45,
	...
	0x4d, 0x45, 0x4e, 0x54, 0x45, 0x44, 0x10, 0x03, 0x32, 0x91, 0x0f, 0x0a, 0x02, 0x56, 0x4d, 0x12,
	...
	0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x53,
...
var file_vm_vm_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
...
var file_vm_vm_proto_depIdxs = []int32{
	45, // 0: vm.InitializeResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	45, // 4: vm.BuildBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	45, // 8: vm.GetBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	2,  // 9: vm.GetBlockResponse.err:type_name -> vm.Error
	45, // 10: vm.BlockVerifyResponse.timestamp:type_name -> google.protobuf.Timestamp
	45, // 11: vm.AppRequestMsg.deadline:type_name -> google.protobuf.Timestamp
	13, // 12: vm.BatchedParseBlockResponse.response:type_name -> vm.ParseBlockResponse
	2,  // 13: vm.GetBlockIDAtHeightResponse.err:type_name -> vm.Error
	46, // 14: vm.GatherResponse.metric_families:type_name -> io.prometheus.client.MetricFamily
	2,  // 15: vm.StateSyncEnabledResponse.err:type_name -> vm.Error
	2,  // 16: vm.GetOngoingSyncStateSummaryResponse.err:type_name -> vm.Error
	2,  // 17: vm.GetLastStateSummaryResponse.err:type_name -> vm.Error
	2,  // 18: vm.ParseStateSummaryResponse.err:type_name -> vm.Error
	2,  // 19: vm.GetStateSummaryResponse.err:type_name -> vm.Error
	3,  // 20: vm.StateSummaryAcceptResponse.mode:type_name -> vm.StateSummaryAcceptResponse.Mode
	2,  // 21: vm.StateSummaryAcceptResponse.err:type_name -> vm.Error
	4,  // 22: vm.VM.Initialize:input_type -> vm.InitializeRequest
	6,  // 23: vm.VM.SetState:input_type -> vm.SetStateRequest
	47, // 24: vm.VM.Shutdown:input_type -> google.protobuf.Empty
	47, // 25: vm.VM.CreateHandlers:input_type -> google.protobuf.Empty
	27, // 26: vm.VM.Connected:input_type -> vm.ConnectedRequest
	28, // 27: vm.VM.Disconnected:input_type -> vm.DisconnectedRequest
	10, // 28: vm.VM.BuildBlock:input_type -> vm.BuildBlockRequest
	12, // 29: vm.VM.ParseBlock:input_type -> vm.ParseBlockRequest
	14, // 30: vm.VM.GetBlock:input_type -> vm.GetBlockRequest
	16, // 31: vm.VM.SetPreference:input_type -> vm.SetPreferenceRequest
	47, // 32: vm.VM.Health:input_type -> google.protobuf.Empty
	47, // 33: vm.VM.Version:input_type -> google.protobuf.Empty
	23, // 34: vm.VM.AppRequest:input_type -> vm.AppRequestMsg
	24, // 35: vm.VM.AppRequestFailed:input_type -> vm.AppRequestFailedMsg
	25, // 36: vm.VM.AppResponse:input_type -> vm.AppResponseMsg
	26, // 37: vm.VM.AppGossip:input_type -> vm.AppGossipMsg
	47, // 38: vm.VM.Gather:input_type -> google.protobuf.Empty
	29, // 39: vm.VM.GetAncestors:input_type -> vm.GetAncestorsRequest
	31, // 40: vm.VM.BatchedParseBlock:input_type -> vm.BatchedParseBlockRequest
	33, // 41: vm.VM.GetBlockIDAtHeight:input_type -> vm.GetBlockIDAtHeightRequest
	47, // 42: vm.VM.StateSyncEnabled:input_type -> google.protobuf.Empty
	47, // 43: vm.VM.GetOngoingSyncStateSummary:input_type -> google.protobuf.Empty
	47, // 44: vm.VM.GetLastStateSummary:input_type -> google.protobuf.Empty
	39, // 45: vm.VM.ParseStateSummary:input_type -> vm.ParseStateSummaryRequest
	41, // 46: vm.VM.GetStateSummary:input_type -> vm.GetStateSummaryRequest
	17, // 47: vm.VM.BlockVerify:input_type -> vm.BlockVerifyRequest
	19, // 48: vm.VM.BlockAccept:input_type -> vm.BlockAcceptRequest
	20, // 49: vm.VM.BlockReject:input_type -> vm.BlockRejectRequest
	43, // 50: vm.VM.StateSummaryAccept:input_type -> vm.StateSummaryAcceptRequest
	5,  // 51: vm.VM.Initialize:output_type -> vm.InitializeResponse
	7,  // 52: vm.VM.SetState:output_type -> vm.SetStateResponse
	47, // 53: vm.VM.Shutdown:output_type -> google.protobuf.Empty
	8,  // 54: vm.VM.CreateHandlers:output_type -> vm.CreateHandlersResponse
	47, // 55: vm.VM.Connected:output_type -> google.protobuf.Empty
	47, // 56: vm.VM.Disconnected:output_type -> google.protobuf.Empty
	11, // 57: vm.VM.BuildBlock:output_type -> vm.BuildBlockResponse
	13, // 58: vm.VM.ParseBlock:output_type -> vm.ParseBlockResponse
	15, // 59: vm.VM.GetBlock:output_type -> vm.GetBlockResponse
	47, // 60: vm.VM.SetPreference:output_type -> google.protobuf.Empty
	21, // 61: vm.VM.Health:output_type -> vm.HealthResponse
	22, // 62: vm.VM.Version:output_type -> vm.VersionResponse
	47, // 63: vm.VM.AppRequest:output_type -> google.protobuf.Empty
	47, // 64: vm.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	47, // 65: vm.VM.AppResponse:output_type -> google.protobuf.Empty
	47, // 66: vm.VM.AppGossip:output_type -> google.protobuf.Empty
	35, // 67: vm.VM.Gather:output_type -> vm.GatherResponse
	...
	34, // 70: vm.VM.GetBlockIDAtHeight:output_type -> vm.GetBlockIDAtHeightResponse
	36, // 71: vm.VM.StateSyncEnabled:output_type -> vm.StateSyncEnabledResponse
	37, // 72: vm.VM.GetOngoingSyncStateSummary:output_type -> vm.GetOngoingSyncStateSummaryResponse
	38, // 73: vm.VM.GetLastStateSummary:output_type -> vm.GetLastStateSummaryResponse
	40, // 74: vm.VM.ParseStateSummary:output_type -> vm.ParseStateSummaryResponse
	42, // 75: vm.VM.GetStateSummary:output_type -> vm.GetStateSummaryResponse
	18, // 76: vm.VM.BlockVerify:output_type -> vm.BlockVerifyResponse
	47, // 77: vm.VM.BlockAccept:output_type -> google.protobuf.Empty
	47, // 78: vm.VM.BlockReject:output_type -> google.protobuf.Empty
	44, // 79: vm.VM.StateSummaryAccept:output_type -> vm.StateSummaryAcceptResponse
