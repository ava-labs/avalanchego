...
func (StateSummaryAcceptResponse_Mode) EnumDescriptor() ([]byte, []int) {
	return file_vm_vm_proto_rawDescGZIP(), []int{42, 0}
}
...
type CreateGRPCHandlerResponse struct {
	...
	// service_name is the service name of the gRPC service
...
var file_vm_vm_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x22, 0x88, 0x08, 0x0a, 0x0f, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x55, 0x70,
	...
	0x61, 0x6d, 0x70, 0x52, 0x08, 0x65, 0x74, 0x6e, 0x61, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xdd, 0x01,
	...
	0x09, 0x2e, 0x76, 0x6d, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74,
	0x65, 0x22, 0xdb, 0x01, 0x0a, 0x10, 0x53, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65,
	...
	0x64, 0x64, 0x72, 0x22, 0x42, 0x0a, 0x07, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12, 0x16,
	0x0a, 0x06, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x45, 0x4d, 0x45, 0x4e, 0x54, 0x45, 0x44, 0x10, 0x03, 0x32, 0xdd, 0x0f, 0x0a, 0x02, 0x56, 0x4d,
	...
	0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x53, 0x0a, 0x12, 0x47,
	...
	0x74, 0x6f, 0x2f, 0x70, 0x62, 0x2f, 0x76, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_vm_vm_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_vm_vm_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_vm_vm_proto_goTypes = []interface{}{
	(State)(0),                                 // 0: vm.State
	(Error)(0),                                 // 1: vm.Error
	(StateSummaryAcceptResponse_Mode)(0),       // 2: vm.StateSummaryAcceptResponse.Mode
	(*InitializeRequest)(nil),                  // 3: vm.InitializeRequest
	(*NetworkUpgrades)(nil),                    // 4: vm.NetworkUpgrades
	...
	(*GetBlockIDAtHeightRequest)(nil),          // 34: vm.GetBlockIDAtHeightRequest
	(*GetBlockIDAtHeightResponse)(nil),         // 35: vm.GetBlockIDAtHeightResponse
	(*GatherResponse)(nil),                     // 36: vm.GatherResponse
	(*StateSyncEnabledResponse)(nil),           // 37: vm.StateSyncEnabledResponse
	(*GetOngoingSyncStateSummaryResponse)(nil), // 38: vm.GetOngoingSyncStateSummaryResponse
	(*GetLastStateSummaryResponse)(nil),        // 39: vm.GetLastStateSummaryResponse
	(*ParseStateSummaryRequest)(nil),           // 40: vm.ParseStateSummaryRequest
	(*ParseStateSummaryResponse)(nil),          // 41: vm.ParseStateSummaryResponse
	(*GetStateSummaryRequest)(nil),             // 42: vm.GetStateSummaryRequest
	(*GetStateSummaryResponse)(nil),            // 43: vm.GetStateSummaryResponse
	(*StateSummaryAcceptRequest)(nil),          // 44: vm.StateSummaryAcceptRequest
	(*StateSummaryAcceptResponse)(nil),         // 45: vm.StateSummaryAcceptResponse
	(*timestamppb.Timestamp)(nil),              // 46: google.protobuf.Timestamp
	(*_go.MetricFamily)(nil),                   // 47: io.prometheus.client.MetricFamily
	(*emptypb.Empty)(nil),                      // 48: google.protobuf.Empty
}
var file_vm_vm_proto_depIdxs = []int32{
	4,  // 0: vm.InitializeRequest.network_upgrades:type_name -> vm.NetworkUpgrades
	46, // 1: vm.NetworkUpgrades.apricot_phase_1_time:type_name -> google.protobuf.Timestamp
	46, // 2: vm.NetworkUpgrades.apricot_phase_2_time:type_name -> google.protobuf.Timestamp
	46, // 3: vm.NetworkUpgrades.apricot_phase_3_time:type_name -> google.protobuf.Timestamp
	46, // 4: vm.NetworkUpgrades.apricot_phase_4_time:type_name -> google.protobuf.Timestamp
	46, // 5: vm.NetworkUpgrades.apricot_phase_5_time:type_name -> google.protobuf.Timestamp
	46, // 6: vm.NetworkUpgrades.apricot_phase_pre_6_time:type_name -> google.protobuf.Timestamp
	46, // 7: vm.NetworkUpgrades.apricot_phase_6_time:type_name -> google.protobuf.Timestamp
	46, // 8: vm.NetworkUpgrades.apricot_phase_post_6_time:type_name -> google.protobuf.Timestamp
	46, // 9: vm.NetworkUpgrades.banff_time:type_name -> google.protobuf.Timestamp
	46, // 10: vm.NetworkUpgrades.cortina_time:type_name -> google.protobuf.Timestamp
	46, // 11: vm.NetworkUpgrades.durango_time:type_name -> google.protobuf.Timestamp
	46, // 12: vm.NetworkUpgrades.etna_time:type_name -> google.protobuf.Timestamp
	46, // 13: vm.InitializeResponse.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 14: vm.SetStateRequest.state:type_name -> vm.State
	46, // 15: vm.SetStateResponse.timestamp:type_name -> google.protobuf.Timestamp
	10, // 16: vm.CreateHandlersResponse.handlers:type_name -> vm.Handler
	46, // 17: vm.BuildBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	46, // 18: vm.ParseBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	46, // 19: vm.GetBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	1,  // 20: vm.GetBlockResponse.err:type_name -> vm.Error
	46, // 21: vm.BlockVerifyResponse.timestamp:type_name -> google.protobuf.Timestamp
	46, // 22: vm.AppRequestMsg.deadline:type_name -> google.protobuf.Timestamp
	14, // 23: vm.BatchedParseBlockResponse.response:type_name -> vm.ParseBlockResponse
	1,  // 24: vm.GetBlockIDAtHeightResponse.err:type_name -> vm.Error
	47, // 25: vm.GatherResponse.metric_families:type_name -> io.prometheus.client.MetricFamily
	1,  // 26: vm.StateSyncEnabledResponse.err:type_name -> vm.Error
	1,  // 27: vm.GetOngoingSyncStateSummaryResponse.err:type_name -> vm.Error
	1,  // 28: vm.GetLastStateSummaryResponse.err:type_name -> vm.Error
	1,  // 29: vm.ParseStateSummaryResponse.err:type_name -> vm.Error
	1,  // 30: vm.GetStateSummaryResponse.err:type_name -> vm.Error
	2,  // 31: vm.StateSummaryAcceptResponse.mode:type_name -> vm.StateSummaryAcceptResponse.Mode
	1,  // 32: vm.StateSummaryAcceptResponse.err:type_name -> vm.Error
	3,  // 33: vm.VM.Initialize:input_type -> vm.InitializeRequest
	6,  // 34: vm.VM.SetState:input_type -> vm.SetStateRequest
	48, // 35: vm.VM.Shutdown:input_type -> google.protobuf.Empty
	48, // 36: vm.VM.CreateHandlers:input_type -> google.protobuf.Empty
	48, // 37: vm.VM.CreateGRPCService:input_type -> google.protobuf.Empty
	28, // 38: vm.VM.Connected:input_type -> vm.ConnectedRequest
	29, // 39: vm.VM.Disconnected:input_type -> vm.DisconnectedRequest
	11, // 40: vm.VM.BuildBlock:input_type -> vm.BuildBlockRequest
	13, // 41: vm.VM.ParseBlock:input_type -> vm.ParseBlockRequest
	15, // 42: vm.VM.GetBlock:input_type -> vm.GetBlockRequest
	17, // 43: vm.VM.SetPreference:input_type -> vm.SetPreferenceRequest
	48, // 44: vm.VM.Health:input_type -> google.protobuf.Empty
	48, // 45: vm.VM.Version:input_type -> google.protobuf.Empty
	24, // 46: vm.VM.AppRequest:input_type -> vm.AppRequestMsg
	25, // 47: vm.VM.AppRequestFailed:input_type -> vm.AppRequestFailedMsg
	26, // 48: vm.VM.AppResponse:input_type -> vm.AppResponseMsg
	27, // 49: vm.VM.AppGossip:input_type -> vm.AppGossipMsg
	48, // 50: vm.VM.Gather:input_type -> google.protobuf.Empty
	30, // 51: vm.VM.GetAncestors:input_type -> vm.GetAncestorsRequest
	32, // 52: vm.VM.BatchedParseBlock:input_type -> vm.BatchedParseBlockRequest
	34, // 53: vm.VM.GetBlockIDAtHeight:input_type -> vm.GetBlockIDAtHeightRequest
	48, // 54: vm.VM.StateSyncEnabled:input_type -> google.protobuf.Empty
	48, // 55: vm.VM.GetOngoingSyncStateSummary:input_type -> google.protobuf.Empty
	48, // 56: vm.VM.GetLastStateSummary:input_type -> google.protobuf.Empty
	40, // 57: vm.VM.ParseStateSummary:input_type -> vm.ParseStateSummaryRequest
	42, // 58: vm.VM.GetStateSummary:input_type -> vm.GetStateSummaryRequest
	18, // 59: vm.VM.BlockVerify:input_type -> vm.BlockVerifyRequest
	20, // 60: vm.VM.BlockAccept:input_type -> vm.BlockAcceptRequest
	21, // 61: vm.VM.BlockReject:input_type -> vm.BlockRejectRequest
	44, // 62: vm.VM.StateSummaryAccept:input_type -> vm.StateSummaryAcceptRequest
	5,  // 63: vm.VM.Initialize:output_type -> vm.InitializeResponse
	...
	14, // 71: vm.VM.ParseBlock:output_type -> vm.ParseBlockResponse
	16, // 72: vm.VM.GetBlock:output_type -> vm.GetBlockResponse
	48, // 73: vm.VM.SetPreference:output_type -> google.protobuf.Empty
	22, // 74: vm.VM.Health:output_type -> vm.HealthResponse
	23, // 75: vm.VM.Version:output_type -> vm.VersionResponse
	48, // 76: vm.VM.AppRequest:output_type -> google.protobuf.Empty
	48, // 77: vm.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	48, // 78: vm.VM.AppResponse:output_type -> google.protobuf.Empty
	48, // 79: vm.VM.AppGossip:output_type -> google.protobuf.Empty
	36, // 80: vm.VM.Gather:output_type -> vm.GatherResponse
	31, // 81: vm.VM.GetAncestors:output_type -> vm.GetAncestorsResponse
	33, // 82: vm.VM.BatchedParseBlock:output_type -> vm.BatchedParseBlockResponse
	35, // 83: vm.VM.GetBlockIDAtHeight:output_type -> vm.GetBlockIDAtHeightResponse
	37, // 84: vm.VM.StateSyncEnabled:output_type -> vm.StateSyncEnabledResponse
	38, // 85: vm.VM.GetOngoingSyncStateSummary:output_type -> vm.GetOngoingSyncStateSummaryResponse
	39, // 86: vm.VM.GetLastStateSummary:output_type -> vm.GetLastStateSummaryResponse
	41, // 87: vm.VM.ParseStateSummary:output_type -> vm.ParseStateSummaryResponse
	43, // 88: vm.VM.GetStateSummary:output_type -> vm.GetStateSummaryResponse
	19, // 89: vm.VM.BlockVerify:output_type -> vm.BlockVerifyResponse
	48, // 90: vm.VM.BlockAccept:output_type -> google.protobuf.Empty
	48, // 91: vm.VM.BlockReject:output_type -> google.protobuf.Empty
	45, // 92: vm.VM.StateSummaryAccept:output_type -> vm.StateSummaryAcceptResponse
