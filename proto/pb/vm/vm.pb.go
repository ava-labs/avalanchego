...
var file_vm_vm_proto_rawDesc = []byte{
	...
	0xd8, 0x11, 0x0a, 0x02, 0x56, 0x4d, 0x12, 0x3b, 0x0a, 0x0a, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61,
...
var file_vm_vm_proto_depIdxs = []int32{
	...
	49, // 5: vm.BuildBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	1,  // 6: vm.ParseBlockResponse.status:type_name -> vm.Status
	49, // 7: vm.ParseBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	1,  // 8: vm.GetBlockResponse.status:type_name -> vm.Status
	49, // 9: vm.GetBlockResponse.timestamp:type_name -> google.protobuf.Timestamp
	2,  // 10: vm.GetBlockResponse.err:type_name -> vm.Error
	49, // 11: vm.BlockVerifyResponse.timestamp:type_name -> google.protobuf.Timestamp
	49, // 12: vm.AppRequestMsg.deadline:type_name -> google.protobuf.Timestamp
	49, // 13: vm.CrossChainAppRequestMsg.deadline:type_name -> google.protobuf.Timestamp
	...
	51, // 28: vm.VM.CreateStaticHandlers:input_type -> google.protobuf.Empty
	31, // 29: vm.VM.Connected:input_type -> vm.ConnectedRequest
	32, // 30: vm.VM.Disconnected:input_type -> vm.DisconnectedRequest
	11, // 31: vm.VM.BuildBlock:input_type -> vm.BuildBlockRequest
	13, // 32: vm.VM.ParseBlock:input_type -> vm.ParseBlockRequest
	15, // 33: vm.VM.GetBlock:input_type -> vm.GetBlockRequest
	17, // 34: vm.VM.SetPreference:input_type -> vm.SetPreferenceRequest
	51, // 35: vm.VM.Health:input_type -> google.protobuf.Empty
	51, // 36: vm.VM.Version:input_type -> google.protobuf.Empty
	24, // 37: vm.VM.AppRequest:input_type -> vm.AppRequestMsg
	25, // 38: vm.VM.AppRequestFailed:input_type -> vm.AppRequestFailedMsg
	26, // 39: vm.VM.AppResponse:input_type -> vm.AppResponseMsg
	27, // 40: vm.VM.AppGossip:input_type -> vm.AppGossipMsg
	51, // 41: vm.VM.Gather:input_type -> google.protobuf.Empty
	28, // 42: vm.VM.CrossChainAppRequest:input_type -> vm.CrossChainAppRequestMsg
	29, // 43: vm.VM.CrossChainAppRequestFailed:input_type -> vm.CrossChainAppRequestFailedMsg
	30, // 44: vm.VM.CrossChainAppResponse:input_type -> vm.CrossChainAppResponseMsg
	33, // 45: vm.VM.GetAncestors:input_type -> vm.GetAncestorsRequest
	35, // 46: vm.VM.BatchedParseBlock:input_type -> vm.BatchedParseBlockRequest
	...
	18, // 53: vm.VM.BlockVerify:input_type -> vm.BlockVerifyRequest
	20, // 54: vm.VM.BlockAccept:input_type -> vm.BlockAcceptRequest
	21, // 55: vm.VM.BlockReject:input_type -> vm.BlockRejectRequest
	...
	9,  // 61: vm.VM.CreateStaticHandlers:output_type -> vm.CreateStaticHandlersResponse
	51, // 62: vm.VM.Connected:output_type -> google.protobuf.Empty
	51, // 63: vm.VM.Disconnected:output_type -> google.protobuf.Empty
	12, // 64: vm.VM.BuildBlock:output_type -> vm.BuildBlockResponse
	14, // 65: vm.VM.ParseBlock:output_type -> vm.ParseBlockResponse
	16, // 66: vm.VM.GetBlock:output_type -> vm.GetBlockResponse
	51, // 67: vm.VM.SetPreference:output_type -> google.protobuf.Empty
	22, // 68: vm.VM.Health:output_type -> vm.HealthResponse
	23, // 69: vm.VM.Version:output_type -> vm.VersionResponse
	51, // 70: vm.VM.AppRequest:output_type -> google.protobuf.Empty
	51, // 71: vm.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	51, // 72: vm.VM.AppResponse:output_type -> google.protobuf.Empty
	51, // 73: vm.VM.AppGossip:output_type -> google.protobuf.Empty
	39, // 74: vm.VM.Gather:output_type -> vm.GatherResponse
	51, // 75: vm.VM.CrossChainAppRequest:output_type -> google.protobuf.Empty
	51, // 76: vm.VM.CrossChainAppRequestFailed:output_type -> google.protobuf.Empty
	51, // 77: vm.VM.CrossChainAppResponse:output_type -> google.protobuf.Empty
	34, // 78: vm.VM.GetAncestors:output_type -> vm.GetAncestorsResponse
	36, // 79: vm.VM.BatchedParseBlock:output_type -> vm.BatchedParseBlockResponse
	...
	19, // 86: vm.VM.BlockVerify:output_type -> vm.BlockVerifyResponse
