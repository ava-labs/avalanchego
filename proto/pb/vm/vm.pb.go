...
var file_vm_vm_proto_rawDesc = []byte{
	...
	0x32, 0xc7, 0x0c, 0x0a, 0x02, 0x56, 0x4d, 0x12, 0x3b, 0x0a, 0x0a, 0x49, 0x6e, 0x69, 0x74, 0x69,
...
var file_vm_vm_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_vm_vm_proto_goTypes = []interface{}{
	...
	(*GatherResponse)(nil),               // 32: vm.GatherResponse
...
var file_vm_vm_proto_depIdxs = []int32{
	...
	33, // 4: vm.GatherResponse.metric_families:type_name -> io.prometheus.client.MetricFamily
	0,  // 5: vm.VM.Initialize:input_type -> vm.InitializeRequest
	1,  // 6: vm.VM.SetState:input_type -> vm.SetStateRequest
	34, // 7: vm.VM.Shutdown:input_type -> google.protobuf.Empty
	34, // 8: vm.VM.CreateHandlers:input_type -> google.protobuf.Empty
	34, // 9: vm.VM.CreateStaticHandlers:input_type -> google.protobuf.Empty
	23, // 10: vm.VM.Connected:input_type -> vm.ConnectedRequest
	24, // 11: vm.VM.Disconnected:input_type -> vm.DisconnectedRequest
	34, // 12: vm.VM.BuildBlock:input_type -> google.protobuf.Empty
	8,  // 13: vm.VM.ParseBlock:input_type -> vm.ParseBlockRequest
	10, // 14: vm.VM.GetBlock:input_type -> vm.GetBlockRequest
	12, // 15: vm.VM.SetPreference:input_type -> vm.SetPreferenceRequest
	34, // 16: vm.VM.Health:input_type -> google.protobuf.Empty
	34, // 17: vm.VM.Version:input_type -> google.protobuf.Empty
	19, // 18: vm.VM.AppRequest:input_type -> vm.AppRequestMsg
	20, // 19: vm.VM.AppRequestFailed:input_type -> vm.AppRequestFailedMsg
	21, // 20: vm.VM.AppResponse:input_type -> vm.AppResponseMsg
	22, // 21: vm.VM.AppGossip:input_type -> vm.AppGossipMsg
	34, // 22: vm.VM.Gather:input_type -> google.protobuf.Empty
	13, // 23: vm.VM.BlockVerify:input_type -> vm.BlockVerifyRequest
	15, // 24: vm.VM.BlockAccept:input_type -> vm.BlockAcceptRequest
	16, // 25: vm.VM.BlockReject:input_type -> vm.BlockRejectRequest
	25, // 26: vm.VM.GetAncestors:input_type -> vm.GetAncestorsRequest
	27, // 27: vm.VM.BatchedParseBlock:input_type -> vm.BatchedParseBlockRequest
	34, // 28: vm.VM.VerifyHeightIndex:input_type -> google.protobuf.Empty
	30, // 29: vm.VM.GetBlockIDAtHeight:input_type -> vm.GetBlockIDAtHeightRequest
	2,  // 30: vm.VM.Initialize:output_type -> vm.InitializeResponse
	34, // 31: vm.VM.SetState:output_type -> google.protobuf.Empty
	34, // 32: vm.VM.Shutdown:output_type -> google.protobuf.Empty
	4,  // 33: vm.VM.CreateHandlers:output_type -> vm.CreateHandlersResponse
	5,  // 34: vm.VM.CreateStaticHandlers:output_type -> vm.CreateStaticHandlersResponse
	34, // 35: vm.VM.Connected:output_type -> google.protobuf.Empty
	34, // 36: vm.VM.Disconnected:output_type -> google.protobuf.Empty
	7,  // 37: vm.VM.BuildBlock:output_type -> vm.BuildBlockResponse
	9,  // 38: vm.VM.ParseBlock:output_type -> vm.ParseBlockResponse
	11, // 39: vm.VM.GetBlock:output_type -> vm.GetBlockResponse
	34, // 40: vm.VM.SetPreference:output_type -> google.protobuf.Empty
	17, // 41: vm.VM.Health:output_type -> vm.HealthResponse
	18, // 42: vm.VM.Version:output_type -> vm.VersionResponse
	34, // 43: vm.VM.AppRequest:output_type -> google.protobuf.Empty
	34, // 44: vm.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	34, // 45: vm.VM.AppResponse:output_type -> google.protobuf.Empty
	34, // 46: vm.VM.AppGossip:output_type -> google.protobuf.Empty
	32, // 47: vm.VM.Gather:output_type -> vm.GatherResponse
	14, // 48: vm.VM.BlockVerify:output_type -> vm.BlockVerifyResponse
	34, // 49: vm.VM.BlockAccept:output_type -> google.protobuf.Empty
	34, // 50: vm.VM.BlockReject:output_type -> google.protobuf.Empty
	26, // 51: vm.VM.GetAncestors:output_type -> vm.GetAncestorsResponse
	28, // 52: vm.VM.BatchedParseBlock:output_type -> vm.BatchedParseBlockResponse
	29, // 53: vm.VM.VerifyHeightIndex:output_type -> vm.VerifyHeightIndexResponse
	31, // 54: vm.VM.GetBlockIDAtHeight:output_type -> vm.GetBlockIDAtHeightResponse
