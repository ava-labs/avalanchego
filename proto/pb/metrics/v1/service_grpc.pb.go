...
func (c *metricsServiceClient) GetMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsReply, error) {
...
func (UnimplementedMetricsServiceServer) GetMetrics(context.Context, *MetricsRequest) (*MetricsReply, error) {
