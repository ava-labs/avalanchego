...
type MetricsServiceClient interface {
	GetMetrics(context.Context, *connect.Request[v1.MetricsRequest]) (*connect.Response[v1.MetricsReply], error)
}
...
func NewMetricsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MetricsServiceClient {
	...
	return &metricsServiceClient{
		getMetrics: connect.NewClient[v1.MetricsRequest, v1.MetricsReply](
			httpClient,
...
type metricsServiceClient struct {
	getMetrics *connect.Client[v1.MetricsRequest, v1.MetricsReply]
}

// GetMetrics calls metrics.v1.MetricsService.GetMetrics.
func (c *metricsServiceClient) GetMetrics(ctx context.Context, req *connect.Request[v1.MetricsRequest]) (*connect.Response[v1.MetricsReply], error) {
...
func (UnimplementedMetricsServiceHandler) GetMetrics(context.Context, *connect.Request[v1.MetricsRequest]) (*connect.Response[v1.MetricsReply], error) {
