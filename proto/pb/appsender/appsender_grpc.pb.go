...
type AppSenderClient interface {
	...
	SendCrossChainAppGossip(ctx context.Context, in *SendCrossChainAppGossipMsg, opts ...grpc.CallOption) (*emptypb.Empty, error)
	SendCrossChainAppGossipSpecific(ctx context.Context, in *SendCrossChainAppGossipSpecificMsg, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *appSenderClient) SendCrossChainAppGossip(ctx context.Context, in *SendCrossChainAppGossipMsg, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/appsender.AppSender/SendCrossChainAppGossip", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appSenderClient) SendCrossChainAppGossipSpecific(ctx context.Context, in *SendCrossChainAppGossipSpecificMsg, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/appsender.AppSender/SendCrossChainAppGossipSpecific", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppSenderServer interface {
	...
	SendCrossChainAppGossip(context.Context, *SendCrossChainAppGossipMsg) (*emptypb.Empty, error)
	SendCrossChainAppGossipSpecific(context.Context, *SendCrossChainAppGossipSpecificMsg) (*emptypb.Empty, error)
...
func (UnimplementedAppSenderServer) SendCrossChainAppGossip(context.Context, *SendCrossChainAppGossipMsg) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendCrossChainAppGossip not implemented")
}
func (UnimplementedAppSenderServer) SendCrossChainAppGossipSpecific(context.Context, *SendCrossChainAppGossipSpecificMsg) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendCrossChainAppGossipSpecific not implemented")
}
...
func _AppSender_SendCrossChainAppGossip_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendCrossChainAppGossipMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppSenderServer).SendCrossChainAppGossip(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appsender.AppSender/SendCrossChainAppGossip",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppSenderServer).SendCrossChainAppGossip(ctx, req.(*SendCrossChainAppGossipMsg))
	}
	return interceptor(ctx, in, info, handler)
}

func _AppSender_SendCrossChainAppGossipSpecific_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendCrossChainAppGossipSpecificMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppSenderServer).SendCrossChainAppGossipSpecific(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appsender.AppSender/SendCrossChainAppGossipSpecific",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppSenderServer).SendCrossChainAppGossipSpecific(ctx, req.(*SendCrossChainAppGossipSpecificMsg))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AppSender_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SendCrossChainAppGossip",
			Handler:    _AppSender_SendCrossChainAppGossip_Handler,
		},
		{
			MethodName: "SendCrossChainAppGossipSpecific",
			Handler:    _AppSender_SendCrossChainAppGossipSpecific_Handler,
		},
	},
