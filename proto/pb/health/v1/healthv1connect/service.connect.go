...
type HealthServiceClient interface {
	Readiness(context.Context, *connect.Request[v1.ReadinessArgs]) (*connect.Response[v1.ReadinessReply], error)
	Liveness(context.Context, *connect.Request[v1.LivenessArgs]) (*connect.Response[v1.LivenessReply], error)
	Health(context.Context, *connect.Request[v1.HealthArgs]) (*connect.Response[v1.HealthReply], error)
}
...
type healthServiceClient struct {
	readiness *connect.Client[v1.ReadinessArgs, v1.ReadinessReply]
	liveness  *connect.Client[v1.LivenessArgs, v1.LivenessReply]
	health    *connect.Client[v1.HealthArgs, v1.HealthReply]
}

// Readiness calls health.v1.HealthService.Readiness.
func (c *healthServiceClient) Readiness(ctx context.Context, req *connect.Request[v1.ReadinessArgs]) (*connect.Response[v1.ReadinessReply], error) {
	return c.readiness.CallUnary(ctx, req)
}

// Liveness calls health.v1.HealthService.Liveness.
func (c *healthServiceClient) Liveness(ctx context.Context, req *connect.Request[v1.LivenessArgs]) (*connect.Response[v1.LivenessReply], error) {
	return c.liveness.CallUnary(ctx, req)
}

// Health calls health.v1.HealthService.Health.
func (c *healthServiceClient) Health(ctx context.Context, req *connect.Request[v1.HealthArgs]) (*connect.Response[v1.HealthReply], error) {
...
func (UnimplementedHealthServiceHandler) Readiness(context.Context, *connect.Request[v1.ReadinessArgs]) (*connect.Response[v1.ReadinessReply], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("health.v1.HealthService.Readiness is not implemented"))
}

func (UnimplementedHealthServiceHandler) Liveness(context.Context, *connect.Request[v1.LivenessArgs]) (*connect.Response[v1.LivenessReply], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("health.v1.HealthService.Liveness is not implemented"))
}

func (UnimplementedHealthServiceHandler) Health(context.Context, *connect.Request[v1.HealthArgs]) (*connect.Response[v1.HealthReply], error) {
