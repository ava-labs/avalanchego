...
type HealthServiceClient interface {
	Readiness(context.Context, *connect.Request[v1.APIArgs]) (*connect.Response[v1.APIReply], error)
	Liveness(context.Context, *connect.Request[v1.APIArgs]) (*connect.Response[v1.APIReply], error)
	Health(context.Context, *connect.Request[v1.APIArgs]) (*connect.Response[v1.APIReply], error)
}
...
type healthServiceClient struct {
	readiness *connect.Client[v1.APIArgs, v1.APIReply]
	liveness  *connect.Client[v1.APIArgs, v1.APIReply]
	health    *connect.Client[v1.APIArgs, v1.APIReply]
}

// Readiness calls health.v1.HealthService.Readiness.
func (c *healthServiceClient) Readiness(ctx context.Context, req *connect.Request[v1.APIArgs]) (*connect.Response[v1.APIReply], error) {
	return c.readiness.CallUnary(ctx, req)
}

// Liveness calls health.v1.HealthService.Liveness.
func (c *healthServiceClient) Liveness(ctx context.Context, req *connect.Request[v1.APIArgs]) (*connect.Response[v1.APIReply], error) {
	return c.liveness.CallUnary(ctx, req)
}

// Health calls health.v1.HealthService.Health.
func (c *healthServiceClient) Health(ctx context.Context, req *connect.Request[v1.APIArgs]) (*connect.Response[v1.APIReply], error) {
...
func (UnimplementedHealthServiceHandler) Readiness(context.Context, *connect.Request[v1.APIArgs]) (*connect.Response[v1.APIReply], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("health.v1.HealthService.Readiness is not implemented"))
}

func (UnimplementedHealthServiceHandler) Liveness(context.Context, *connect.Request[v1.APIArgs]) (*connect.Response[v1.APIReply], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("health.v1.HealthService.Liveness is not implemented"))
}

func (UnimplementedHealthServiceHandler) Health(context.Context, *connect.Request[v1.APIArgs]) (*connect.Response[v1.APIReply], error) {
