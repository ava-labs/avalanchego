...
Protobuf files are hosted at [https://buf.build/chain4travel/caminogo](https://buf.build/chain4travel/caminogo) and can be used as dependencies in other projects.
