...
func TestSet(t *testing.T) {
	...
	id0 := ids.GenericNodeIDFromBytes([]byte{0}).ToSize(ids.NodeIDLen)
	id1 := ids.GenericNodeIDFromBytes([]byte{1}).ToSize(ids.NodeIDLen)
	id2 := ids.GenericNodeIDFromBytes([]byte{2}).ToSize(ids.NodeIDLen)
