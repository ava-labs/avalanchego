...
type Client interface {
	...
	PublishBlockchain(ctx context.Context, chainID ids.ID, options ...rpc.Option) (*PublishBlockchainReply, error)
	// UnpublishBlockchain requests the node to stop publishing consensus and decision events
	UnpublishBlockchain(ctx context.Context, chainID ids.ID, options ...rpc.Option) (bool, error)
...
func (c *client) PublishBlockchain(ctx context.Context, blockchainID ids.ID, options ...rpc.Option) (*PublishBlockchainReply, error) {
...
func (c *client) UnpublishBlockchain(ctx context.Context, blockchainID ids.ID, options ...rpc.Option) (bool, error) {
