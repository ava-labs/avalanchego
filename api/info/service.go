...
func (service *Info) GetTxFee(_ *http.Request, args *struct{}, reply *GetTxFeeResponse) error {
	...
	reply.CreateSubnetTxFee = json.Uint64(service.PChainTxFees.Blueberry.CreateSubnet)
	reply.TransformSubnetTxFee = json.Uint64(service.PChainTxFees.Blueberry.TransformSubnet)
	reply.CreateBlockchainTxFee = json.Uint64(service.PChainTxFees.Blueberry.CreateChain)
	reply.AddPrimaryNetworkValidatorFee = json.Uint64(service.PChainTxFees.Blueberry.AddPrimaryNetworkValidator)
	reply.AddPrimaryNetworkDelegatorFee = json.Uint64(service.PChainTxFees.Blueberry.AddPrimaryNetworkDelegator)
	reply.AddSubnetValidatorFee = json.Uint64(service.PChainTxFees.Blueberry.AddPOSSubnetValidator)
	reply.AddSubnetDelegatorFee = json.Uint64(service.PChainTxFees.Blueberry.AddPOSSubnetDelegator)

	// P-chain fees
	reply.PChainAddPrimaryNetworkValidator = json.Uint64(service.PChainTxFees.Blueberry.AddPrimaryNetworkValidator)
	reply.PChainAddPrimaryNetworkDelegator = json.Uint64(service.PChainTxFees.Blueberry.AddPrimaryNetworkDelegator)
	reply.PChainAddPOASubnetValidator = json.Uint64(service.PChainTxFees.Blueberry.AddPOASubnetValidator)
	reply.PChainAddPOSSubnetValidator = json.Uint64(service.PChainTxFees.Blueberry.AddPOSSubnetValidator)
	reply.PChainAddPOSSubnetDelegator = json.Uint64(service.PChainTxFees.Blueberry.AddPOSSubnetDelegator)
	reply.PChainRemovePOASubnetValidator = json.Uint64(service.PChainTxFees.Blueberry.RemovePOASubnetValidator)
	reply.PChainCreateSubnet = json.Uint64(service.PChainTxFees.Blueberry.CreateSubnet)
	reply.PChainCreateChain = json.Uint64(service.PChainTxFees.Blueberry.CreateChain)
	reply.PChainTransformSubnet = json.Uint64(service.PChainTxFees.Blueberry.TransformSubnet)
	reply.PChainImport = json.Uint64(service.PChainTxFees.Blueberry.Import)
	reply.PChainExport = json.Uint64(service.PChainTxFees.Blueberry.Export)
