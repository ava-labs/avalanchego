...
def go_deps_repos():
    ...
    go_repository(
        ...
        sum = "h1:Y4V+ACf8/vOb1XOc251Qun7jMB75gCUNw6llvB9csXc=",
        version = "v1.3.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:OvGoHxIcOXFJLyn9IJQ5DzByZ3YVAWNBc394ObzDRb8=",
        version = "v0.3.8",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_ava_labs_firewood_go_ethhash_ffi",
        importpath = "github.com/ava-labs/firewood-go-ethhash/ffi",
        sum = "h1:Lk4yxNL3iZMRxKZlTKVCHp0Rg7i5QclRei0ZKCgtPac=",
        version = "v0.0.18",
    )
    go_repository(
        name = "com_github_ava_labs_libevm",
        importpath = "github.com/ava-labs/libevm",
        sum = "h1:9VRvqASGSAnQ9tKVRKGH8Q0Yq8efCwYTBWp0p2creho=",
        version = "v1.13.15-0.20251210210615-b8e76562a300",
    )
    go_repository(
        name = "com_github_ava_labs_simplex",
        importpath = "github.com/ava-labs/simplex",
        sum = "h1:S6oFasZsplNmw8B2S8cMJQMa62nT5ZKGzZRdCpd+5qQ=",
        version = "v0.0.0-20250919142550-9cdfff10fd19",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:dpAlnAwmT1yIBm3exhT1/8iUSD98RDJM5vqJVQDQLiU=",
        version = "v2.3.5",
    )
    go_repository(
        name = "com_github_btcsuite_btcd_btcutil",
        importpath = "github.com/btcsuite/btcd/btcutil",
        sum = "h1:xfbtw8lwpp0G6NwSHb+UE67ryTFHJAiNuipusjXSohQ=",
        version = "v1.1.3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_compose_spec_compose_go",
        importpath = "github.com/compose-spec/compose-go",
        sum = "h1:u/yfZHn4EaHGdidrZycWpxXgFffjYULlTbRfJ51ykjQ=",
        version = "v1.20.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:+FJNlnjJsZMG3g0/rmmP7GiKjQoUF5EXfEtBwtPtkzY=",
        version = "v0.35.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:/MJORKvJEwNVldtGVJC2p2cwCnsSoLn3hl3zxmZT7tk=",
        version = "v1.0.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:GbgQGNtTrEmddYDSAH9QLRyfAHY12md+8YFTqyMTC9k=",
        version = "v0.9.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_stephenbuttolph_canoto",
        importpath = "github.com/StephenButtolph/canoto",
        sum = "h1:lvsnYD4b96vD1knnmp1xCmZqfYpY/jSeRozGdOfdvGI=",
        version = "v0.17.3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_thepudds_fzgen",
        importpath = "github.com/thepudds/fzgen",
        sum = "h1:srUP/34BulQaEwPP/uHZkdjUcUjIzL7Jkf4CBVryiP8=",
        version = "v0.4.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:4qufH0hlUYs6AO6XmZC3GqfDPGSXHVXUFR6OND+iJX4=",
        version = "v0.0.0-20241215155358-4a5509556b9e",
    )
    go_repository(
