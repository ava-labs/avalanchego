...
var Tests = map[string]func(t *testing.T, db Database){
	...
	"TestOverwriteKeyValue":                TestOverwriteKeyValue,
	"TestEmptyKey":                         TestEmptyKey,
	"TestKeyEmptyValue":                    TestKeyEmptyValue,
	"TestSimpleKeyValueClosed":             TestSimpleKeyValueClosed,
	"TestNewBatchClosed":                   TestNewBatchClosed,
	"TestBatchPut":                         TestBatchPut,
	"TestBatchDelete":                      TestBatchDelete,
	"TestBatchReset":                       TestBatchReset,
	"TestBatchReuse":                       TestBatchReuse,
	"TestBatchRewrite":                     TestBatchRewrite,
	"TestBatchReplay":                      TestBatchReplay,
	"TestBatchReplayPropagateError":        TestBatchReplayPropagateError,
	"TestBatchInner":                       TestBatchInner,
	"TestBatchLargeSize":                   TestBatchLargeSize,
	"TestIteratorSnapshot":                 TestIteratorSnapshot,
	"TestIterator":                         TestIterator,
	"TestIteratorStart":                    TestIteratorStart,
	"TestIteratorPrefix":                   TestIteratorPrefix,
	"TestIteratorStartPrefix":              TestIteratorStartPrefix,
	"TestIteratorMemorySafety":             TestIteratorMemorySafety,
	"TestIteratorClosed":                   TestIteratorClosed,
	"TestIteratorError":                    TestIteratorError,
	"TestIteratorErrorAfterRelease":        TestIteratorErrorAfterRelease,
	"TestCompactNoPanic":                   TestCompactNoPanic,
	"TestMemorySafetyDatabase":             TestMemorySafetyDatabase,
	"TestMemorySafetyBatch":                TestMemorySafetyBatch,
	"TestAtomicClear":                      TestAtomicClear,
	"TestClear":                            TestClear,
	"TestAtomicClearPrefix":                TestAtomicClearPrefix,
	"TestClearPrefix":                      TestClearPrefix,
	"TestModifyValueAfterPut":              TestModifyValueAfterPut,
	"TestModifyValueAfterBatchPut":         TestModifyValueAfterBatchPut,
	"TestModifyValueAfterBatchPutReplay":   TestModifyValueAfterBatchPutReplay,
	"TestConcurrentBatches":                TestConcurrentBatches,
	"TestManySmallConcurrentKVPairBatches": TestManySmallConcurrentKVPairBatches,
	"TestPutGetEmpty":                      TestPutGetEmpty,
}
