...
| `--helicon-min-stake-duration` | `AVAGO_HELICON_MIN_STAKE_DURATION` | duration | `48h` | Minimum staking duration post Helicon. This can only be changed on a local network. This applies to both delegation and validation periods. |
