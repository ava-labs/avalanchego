...
| `--helicon-min-stake-duration` | `AVAGO_HELICON_MIN_STAKE_DURATION` | duration | `1h` | Minimum staking duration post Helicon. This can only be changed on a local network. This applies to only to validation periods. |
