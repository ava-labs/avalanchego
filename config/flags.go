...
func addNodeFlags(fs *pflag.FlagSet) {
	...
	fs.Int(SnowPreferenceQuorumSizeKey, snowball.DefaultParameters.AlphaPreference, "Threshold of nodes required to update this node's preference in a network poll")
	fs.Int(SnowConfidenceQuorumSizeKey, snowball.DefaultParameters.AlphaConfidence, "Threshold of nodes required to increase this node's confidence in a network poll")
