...
func addNodeFlags(fs *pflag.FlagSet) {
	...
	fs.Duration(NetworkValidatorTrackerResetFreqKey, constants.DefaultNetworkValidatorTrackerResetFreq, "Frequency to recalculate the bloom filter used to request new peers from other nodes")
