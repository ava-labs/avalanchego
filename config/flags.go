...
func addNodeFlags(fs *pflag.FlagSet) {
	...
	fs.StringSlice(NetworkLargeMessagePeerIDsKey, []string{}, fmt.Sprintf("Comma-separated list of peer node IDs allowed to send and receive messages up to %s (KiB)", NetworkLargeMessageSizeKey))
