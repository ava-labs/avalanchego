...
func addNodeFlags(fs *pflag.FlagSet) {
	...
	fs.Uint64(SystemTrackerWarningThresholdAvailableDiskSpaceKeyPercentage, 3, "Warning threshold for the percentage (between 0 and 100) of available disk space, under which the node will be considered unhealthy.")
