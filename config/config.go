...
func getDiskSpaceConfig(v *viper.Viper) (requiredAvailableDiskSpace uint64, warningThresholdAvailableDiskSpace uint64, warningThresholdAvailableDiskSpacePercentage uint64, err error) {
	...
	warningThresholdAvailableDiskSpacePercentage = v.GetUint64(SystemTrackerWarningThresholdAvailableDiskSpaceKeyPercentage)
	switch {
	case warningThresholdAvailableDiskSpacePercentage > 100 || warningThresholdAvailableDiskSpacePercentage == 0:
		return 0, 0, 0, fmt.Errorf("%q (%d) must be in (0, 100)", SystemTrackerWarningThresholdAvailableDiskSpaceKeyPercentage, warningThresholdAvailableDiskSpacePercentage)
