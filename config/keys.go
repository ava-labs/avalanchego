...
const (
	...
	InboundThrottlerAtLargeAllocSizeKey       = "inbound-throttler-at-large-alloc-size"
	InboundThrottlerVdrAllocSizeKey           = "inbound-throttler-validator-alloc-size"
	InboundThrottlerNodeMaxAtLargeBytesKey    = "inbound-throttler-node-max-at-large-bytes"
	OutboundThrottlerAtLargeAllocSizeKey      = "outbound-throttler-at-large-alloc-size"
	OutboundThrottlerVdrAllocSizeKey          = "outbound-throttler-validator-alloc-size"
	OutboundThrottlerNodeMaxAtLargeBytesKey   = "outbound-throttler-node-max-at-large-bytes"
