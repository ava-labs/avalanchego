...
const (
	...
	InboundThrottlingAtLargeAllocSizeKey      = "inbound-throttling-at-large-alloc-size"
	InboundThrottlingVdrAllocSizeKey          = "inbound-throttling-validator-alloc-size"
	InboundThrottlingNodeMaxAtLargeBytesKey   = "inbound-throttling-node-max-at-large-bytes"
	OutboundThrottlingAtLargeAllocSizeKey     = "outbound-throttling-at-large-alloc-size"
	OutboundThrottlingVdrAllocSizeKey         = "outbound-throttling-validator-alloc-size"
	OutboundThrottlingNodeMaxAtLargeBytesKey  = "outbound-throttling-node-max-at-large-bytes"
