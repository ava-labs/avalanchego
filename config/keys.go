...
const (
	...
	NetworkLargeMessageSizeKey                           = "network-large-message-size"
	NetworkLargeMessagePeerIDsKey                        = "network-large-message-peer-ids"
	NetworkLargeMessageInboundAtLargeAllocSizeKey        = "network-large-message-inbound-at-large-alloc-size"
	NetworkLargeMessageInboundValidatorAllocSizeKey      = "network-large-message-inbound-validator-alloc-size"
	NetworkLargeMessageInboundNodeMaxAtLargeBytesKey     = "network-large-message-inbound-node-max-at-large-bytes"
	NetworkLargeMessageInboundMaxProcessingMsgsKey       = "network-large-message-inbound-node-max-processing-msgs"
	NetworkLargeMessageInboundBandwidthRefillRateKey     = "network-large-message-inbound-bandwidth-refill-rate"
	NetworkLargeMessageInboundBandwidthMaxBurstSizeKey   = "network-large-message-inbound-bandwidth-max-burst-size"
	NetworkLargeMessageInboundCPUMaxRecheckDelayKey      = "network-large-message-inbound-cpu-max-recheck-delay"
	NetworkLargeMessageInboundDiskMaxRecheckDelayKey     = "network-large-message-inbound-disk-max-recheck-delay"
	NetworkLargeMessageOutboundAtLargeAllocSizeKey       = "network-large-message-outbound-at-large-alloc-size"
	NetworkLargeMessageOutboundValidatorAllocSizeKey     = "network-large-message-outbound-validator-alloc-size"
	NetworkLargeMessageOutboundNodeMaxAtLargeBytesKey    = "network-large-message-outbound-node-max-at-large-bytes"
